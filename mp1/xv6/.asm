...
void fib(void *arg) {
  ...
  36:	ca650513          	addi	a0,a0,-858 # cd8 <thread_start_threading+0x2c>
  ...
  7e:	968080e7          	jalr	-1688(ra) # 9e2 <thread_assign_task>
...
int main(int argc, char **argv) {
  ...
  cc:	c2050513          	addi	a0,a0,-992 # ce8 <thread_start_threading+0x3c>
  ...
  f8:	8a4080e7          	jalr	-1884(ra) # 998 <thread_add_runqueue>
        thread_start_threading();
  fc:	00001097          	auipc	ra,0x1
 100:	bb0080e7          	jalr	-1104(ra) # cac <thread_start_threading>
    }
    printf("\nexited\n");
 104:	00001517          	auipc	a0,0x1
 108:	bf450513          	addi	a0,a0,-1036 # cf8 <thread_start_threading+0x4c>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 688:	68490913          	addi	s2,s2,1668 # d08 <thread_start_threading+0x5c>
        while(*s != 0){
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 976:	c31c                	sw	a5,0(a4)
    ...
    t->top = NULL;
 978:	0a04b423          	sd	zero,168(s1)
    t->current_task = NULL;
 97c:	0a04b823          	sd	zero,176(s1)
    t->task_count = 0;
 980:	0a04ae23          	sw	zero,188(s1)
    t->first_self_assign = 0;
 984:	0a04ac23          	sw	zero,184(s1)
    return t;
}
 988:	8526                	mv	a0,s1
...
void thread_add_runqueue(struct thread *t){
 ...
 9a2:	3a27b783          	ld	a5,930(a5) # d40 <current_thread>
 9a6:	cb91                	beqz	a5,9ba <thread_add_runqueue+0x22>
    }
    else{
        // TODO
 ...
 9aa:	f348                	sd	a0,160(a4)
        t->previous = current_thread->previous;
 9ac:	6fd8                	ld	a4,152(a5)
 9ae:	ed58                	sd	a4,152(a0)

        t->next = current_thread;
 9b0:	f15c                	sd	a5,160(a0)
        current_thread->previous = t;
 9b2:	efc8                	sd	a0,152(a5)
    }
 ...
 9b8:	8082                	ret
        t->next = t;
 9ba:	f148                	sd	a0,160(a0)
        t->previous = t;
 9bc:	ed48                	sd	a0,152(a0)
        current_thread = t;
 9be:	00000797          	auipc	a5,0x0
 9c2:	38a7b123          	sd	a0,898(a5) # d40 <current_thread>
 9c6:	b7fd                	j	9b4 <thread_add_runqueue+0x1c>

00000000000009c8 <schedule>:
            thread_exit();
        }
    }
}
...
void schedule(void){
 ...
 9d2:	37278793          	addi	a5,a5,882 # d40 <current_thread>
 9d6:	6398                	ld	a4,0(a5)
 9d8:	7358                	ld	a4,160(a4)
 9da:	e398                	sd	a4,0(a5)
}
 9dc:	6422                	ld	s0,8(sp)
...
00000000000009e2 <thread_assign_task>:
        dispatch();
    }
}
...
void thread_assign_task(struct thread *t, void (*f)(void *), void *arg){
 ...
 9f8:	0a000513          	li	a0,160
 9fc:	00000097          	auipc	ra,0x0
 a00:	dce080e7          	jalr	-562(ra) # 7ca <malloc>
 a04:	84aa                	mv	s1,a0
    unsigned long new_stack;
    unsigned long new_stack_p;
    new_stack = (unsigned long) malloc(sizeof(unsigned long) * 0x100);
 a06:	6505                	lui	a0,0x1
 a08:	80050513          	addi	a0,a0,-2048 # 800 <malloc+0x36>
 a0c:	00000097          	auipc	ra,0x0
 a10:	dbe080e7          	jalr	-578(ra) # 7ca <malloc>
    new_stack_p = new_stack + (0x100 * 8 - 0x2 * 8);

    new_task->fp = f;
 a14:	0144b023          	sd	s4,0(s1)
    new_task->arg = arg;
 a18:	0134b423          	sd	s3,8(s1)
    new_task->buf_set = 0;
 a1c:	0804a823          	sw	zero,144(s1)
    t->task_count++;
 a20:	0bc92783          	lw	a5,188(s2)
 a24:	2785                	addiw	a5,a5,1
 a26:	0af92e23          	sw	a5,188(s2)
    new_task->ID = t->task_count;
 a2a:	08f4aa23          	sw	a5,148(s1)
    new_task->stack = (void*) new_stack;
 a2e:	e888                	sd	a0,16(s1)
    new_stack_p = new_stack + (0x100 * 8 - 0x2 * 8);
 a30:	7f050513          	addi	a0,a0,2032
    new_task->stack_p = (void*) new_stack_p;
 a34:	ec88                	sd	a0,24(s1)

    new_task->next = t->top;
 a36:	0a893783          	ld	a5,168(s2)
 a3a:	ecdc                	sd	a5,152(s1)
    t->top = new_task;
 a3c:	0a993423          	sd	s1,168(s2)

    if(t->current_task == NULL) {
 a40:	0b093783          	ld	a5,176(s2)
 a44:	cf99                	beqz	a5,a62 <thread_assign_task+0x80>
        t->current_task = new_task;
    }

    if(t == current_thread && t->task_count == 1) {
 a46:	00000797          	auipc	a5,0x0
 a4a:	2fa7b783          	ld	a5,762(a5) # d40 <current_thread>
 a4e:	01278d63          	beq	a5,s2,a68 <thread_assign_task+0x86>
 ...
 a52:	70a2                	ld	ra,40(sp)
 a54:	7402                	ld	s0,32(sp)
 a56:	64e2                	ld	s1,24(sp)
 a58:	6942                	ld	s2,16(sp)
 a5a:	69a2                	ld	s3,8(sp)
 a5c:	6a02                	ld	s4,0(sp)
 a5e:	6145                	addi	sp,sp,48
 a60:	8082                	ret
        t->current_task = new_task;
 a62:	0a993823          	sd	s1,176(s2)
 a66:	b7c5                	j	a46 <thread_assign_task+0x64>
    if(t == current_thread && t->task_count == 1) {
 a68:	0bc92703          	lw	a4,188(s2)
 a6c:	4785                	li	a5,1
 a6e:	fef712e3          	bne	a4,a5,a52 <thread_assign_task+0x70>
        t->first_self_assign = 1;
 a72:	0af92c23          	sw	a5,184(s2)
}
 a76:	bff1                	j	a52 <thread_assign_task+0x70>

0000000000000a78 <task_schedule>:
...
void task_schedule(struct thread *t) {
 ...
 a7e:	755c                	ld	a5,168(a0)
 a80:	f95c                	sd	a5,176(a0)
...
0000000000000a88 <thread_pop_task>:
...
void thread_pop_task(void){
 ...
 a96:	2ae53503          	ld	a0,686(a0) # d40 <current_thread>
 a9a:	7944                	ld	s1,176(a0)
    current_thread->top = current_thread->top->next;
 a9c:	755c                	ld	a5,168(a0)
 a9e:	6fdc                	ld	a5,152(a5)
 aa0:	f55c                	sd	a5,168(a0)
    task_schedule(current_thread);
 aa2:	00000097          	auipc	ra,0x0
 aa6:	fd6080e7          	jalr	-42(ra) # a78 <task_schedule>
    free(temp->stack);
 aaa:	6888                	ld	a0,16(s1)
 aac:	00000097          	auipc	ra,0x0
 ab0:	c96080e7          	jalr	-874(ra) # 742 <free>
    free(temp);
 ab4:	8526                	mv	a0,s1
 ab6:	00000097          	auipc	ra,0x0
 aba:	c8c080e7          	jalr	-884(ra) # 742 <free>
    dispatch();
 abe:	00000097          	auipc	ra,0x0
 ac2:	012080e7          	jalr	18(ra) # ad0 <dispatch>
...
void dispatch(void){ 
 ...
 adc:	2687b783          	ld	a5,616(a5) # d40 <current_thread>
 ae0:	7bc8                	ld	a0,176(a5)
 ae2:	c925                	beqz	a0,b52 <dispatch+0x82>
        if(current_thread->first_self_assign) current_thread->first_self_assign = 0;
 ae4:	0b87a703          	lw	a4,184(a5)
 ae8:	c319                	beqz	a4,aee <dispatch+0x1e>
 aea:	0a07ac23          	sw	zero,184(a5)
        if(current_thread->current_task->buf_set != 0) {
 aee:	09052783          	lw	a5,144(a0)
 af2:	cf81                	beqz	a5,b0a <dispatch+0x3a>
            longjmp(current_thread->current_task->env, 1); // restore the context of the current thread
 af4:	4585                	li	a1,1
 af6:	02050513          	addi	a0,a0,32
 afa:	00000097          	auipc	ra,0x0
 afe:	dec080e7          	jalr	-532(ra) # 8e6 <longjmp>
}
 b02:	60a2                	ld	ra,8(sp)
 b04:	6402                	ld	s0,0(sp)
 ...
 b0a:	02050513          	addi	a0,a0,32
 b0e:	00000097          	auipc	ra,0x0
 b12:	da0080e7          	jalr	-608(ra) # 8ae <setjmp>
 b16:	e50d                	bnez	a0,b40 <dispatch+0x70>
                current_thread->current_task->env->sp = ((unsigned long) current_thread->current_task->stack_p);
 b18:	00000797          	auipc	a5,0x0
 b1c:	2287b783          	ld	a5,552(a5) # d40 <current_thread>
 b20:	7bd8                	ld	a4,176(a5)
 b22:	6f14                	ld	a3,24(a4)
 b24:	e754                	sd	a3,136(a4)
                longjmp(current_thread->current_task->env, 1);
 b26:	7bc8                	ld	a0,176(a5)
 b28:	4585                	li	a1,1
 b2a:	02050513          	addi	a0,a0,32
 b2e:	00000097          	auipc	ra,0x0
 b32:	db8080e7          	jalr	-584(ra) # 8e6 <longjmp>
            thread_pop_task();
 b36:	00000097          	auipc	ra,0x0
 b3a:	f52080e7          	jalr	-174(ra) # a88 <thread_pop_task>
 b3e:	b7d1                	j	b02 <dispatch+0x32>
                current_thread->current_task->fp(current_thread->current_task->arg);
 b40:	00000797          	auipc	a5,0x0
 b44:	2007b783          	ld	a5,512(a5) # d40 <current_thread>
 b48:	7bdc                	ld	a5,176(a5)
 b4a:	6398                	ld	a4,0(a5)
 b4c:	6788                	ld	a0,8(a5)
 b4e:	9702                	jalr	a4
 b50:	b7dd                	j	b36 <dispatch+0x66>
        if(current_thread->buf_set != 0) {
 b52:	0907a703          	lw	a4,144(a5)
 b56:	cb09                	beqz	a4,b68 <dispatch+0x98>
            longjmp(current_thread->env, 1); // restore the context of the current thread
 b58:	4585                	li	a1,1
 b5a:	02078513          	addi	a0,a5,32
 b5e:	00000097          	auipc	ra,0x0
 b62:	d88080e7          	jalr	-632(ra) # 8e6 <longjmp>
 b66:	bf71                	j	b02 <dispatch+0x32>
            if(!setjmp(current_thread->env)){
 b68:	02078513          	addi	a0,a5,32
 b6c:	00000097          	auipc	ra,0x0
 b70:	d42080e7          	jalr	-702(ra) # 8ae <setjmp>
 b74:	e11d                	bnez	a0,b9a <dispatch+0xca>
                current_thread->env->sp = ((unsigned long) current_thread->stack_p);
 b76:	00000517          	auipc	a0,0x0
 b7a:	1ca53503          	ld	a0,458(a0) # d40 <current_thread>
 b7e:	6d1c                	ld	a5,24(a0)
 b80:	e55c                	sd	a5,136(a0)
                longjmp(current_thread->env, 1);
 b82:	4585                	li	a1,1
 b84:	02050513          	addi	a0,a0,32
 b88:	00000097          	auipc	ra,0x0
 b8c:	d5e080e7          	jalr	-674(ra) # 8e6 <longjmp>
            thread_exit();
 b90:	00000097          	auipc	ra,0x0
 b94:	094080e7          	jalr	148(ra) # c24 <thread_exit>
}
 b98:	b7ad                	j	b02 <dispatch+0x32>
                current_thread->fp(current_thread->arg);
 b9a:	00000797          	auipc	a5,0x0
 b9e:	1a67b783          	ld	a5,422(a5) # d40 <current_thread>
 ba2:	6398                	ld	a4,0(a5)
 ba4:	6788                	ld	a0,8(a5)
 ba6:	9702                	jalr	a4
 ba8:	b7e5                	j	b90 <dispatch+0xc0>

0000000000000baa <thread_yield>:
void thread_yield(void){
 ...
 bb8:	18c53503          	ld	a0,396(a0) # d40 <current_thread>
 bbc:	795c                	ld	a5,176(a0)
 bbe:	cb89                	beqz	a5,bd0 <thread_yield+0x26>
    && current_thread->first_self_assign == 0) { // called by task 
 bc0:	0b852703          	lw	a4,184(a0)
 bc4:	e711                	bnez	a4,bd0 <thread_yield+0x26>
        buf_set = &(current_thread->current_task->buf_set);
 bc6:	09078713          	addi	a4,a5,144
        env = &(current_thread->current_task->env);
 bca:	02078513          	addi	a0,a5,32
 bce:	a029                	j	bd8 <thread_yield+0x2e>
        buf_set = &(current_thread->buf_set);
 bd0:	09050713          	addi	a4,a0,144
        env = &(current_thread->env);
 bd4:	02050513          	addi	a0,a0,32
    if(*buf_set == 0) {
 bd8:	431c                	lw	a5,0(a4)
 bda:	e399                	bnez	a5,be0 <thread_yield+0x36>
        *buf_set = 1;
 bdc:	4785                	li	a5,1
 bde:	c31c                	sw	a5,0(a4)
    if(!setjmp(*env)){ // save the current context
 be0:	00000097          	auipc	ra,0x0
 be4:	cce080e7          	jalr	-818(ra) # 8ae <setjmp>
 be8:	c511                	beqz	a0,bf4 <thread_yield+0x4a>
}
 ...
 bf8:	14c48493          	addi	s1,s1,332 # d40 <current_thread>
 bfc:	6088                	ld	a0,0(s1)
 bfe:	00000097          	auipc	ra,0x0
 c02:	e7a080e7          	jalr	-390(ra) # a78 <task_schedule>
        task_schedule(current_thread->next);
 c06:	609c                	ld	a5,0(s1)
 c08:	73c8                	ld	a0,160(a5)
 c0a:	00000097          	auipc	ra,0x0
 c0e:	e6e080e7          	jalr	-402(ra) # a78 <task_schedule>
        schedule();
 c12:	00000097          	auipc	ra,0x0
 c16:	db6080e7          	jalr	-586(ra) # 9c8 <schedule>
        dispatch();
 c1a:	00000097          	auipc	ra,0x0
 c1e:	eb6080e7          	jalr	-330(ra) # ad0 <dispatch>
}
 c22:	b7e1                	j	bea <thread_yield+0x40>

0000000000000c24 <thread_exit>:
void thread_exit(void){
 ...
 c2e:	00000497          	auipc	s1,0x0
 c32:	1124b483          	ld	s1,274(s1) # d40 <current_thread>
 c36:	70dc                	ld	a5,160(s1)
 c38:	04f48363          	beq	s1,a5,c7e <thread_exit+0x5a>
        current_thread->previous->next = current_thread->next;
 c3c:	6cd8                	ld	a4,152(s1)
 c3e:	f35c                	sd	a5,160(a4)
        current_thread->next->previous = current_thread->previous;
 c40:	70dc                	ld	a5,160(s1)
 c42:	6cd8                	ld	a4,152(s1)
 c44:	efd8                	sd	a4,152(a5)
        task_schedule(temp->next);            
 c46:	70c8                	ld	a0,160(s1)
 c48:	00000097          	auipc	ra,0x0
 c4c:	e30080e7          	jalr	-464(ra) # a78 <task_schedule>
        schedule();
 c50:	00000097          	auipc	ra,0x0
 c54:	d78080e7          	jalr	-648(ra) # 9c8 <schedule>
        free(temp->stack);
 c58:	6888                	ld	a0,16(s1)
 c5a:	00000097          	auipc	ra,0x0
 c5e:	ae8080e7          	jalr	-1304(ra) # 742 <free>
        free(temp);
 c62:	8526                	mv	a0,s1
 c64:	00000097          	auipc	ra,0x0
 c68:	ade080e7          	jalr	-1314(ra) # 742 <free>
        dispatch();
 c6c:	00000097          	auipc	ra,0x0
 c70:	e64080e7          	jalr	-412(ra) # ad0 <dispatch>
}
 c74:	60e2                	ld	ra,24(sp)
 c76:	6442                	ld	s0,16(sp)
 c78:	64a2                	ld	s1,8(sp)
 c7a:	6105                	addi	sp,sp,32
 c7c:	8082                	ret
        free(current_thread->stack);
 c7e:	6888                	ld	a0,16(s1)
 c80:	00000097          	auipc	ra,0x0
 c84:	ac2080e7          	jalr	-1342(ra) # 742 <free>
        free(current_thread);
 c88:	00000517          	auipc	a0,0x0
 c8c:	0b853503          	ld	a0,184(a0) # d40 <current_thread>
 c90:	00000097          	auipc	ra,0x0
 c94:	ab2080e7          	jalr	-1358(ra) # 742 <free>
        longjmp(env_st, 1);
 c98:	4585                	li	a1,1
 c9a:	00000517          	auipc	a0,0x0
 c9e:	0be50513          	addi	a0,a0,190 # d58 <env_st>
 ca2:	00000097          	auipc	ra,0x0
 ca6:	c44080e7          	jalr	-956(ra) # 8e6 <longjmp>
}
 caa:	b7e9                	j	c74 <thread_exit+0x50>

0000000000000cac <thread_start_threading>:
void thread_start_threading(void){
 ...
 cb8:	0a450513          	addi	a0,a0,164 # d58 <env_st>
 cbc:	00000097          	auipc	ra,0x0
 cc0:	bf2080e7          	jalr	-1038(ra) # 8ae <setjmp>
 cc4:	e509                	bnez	a0,cce <thread_start_threading+0x22>
        dispatch();
 cc6:	00000097          	auipc	ra,0x0
 cca:	e0a080e7          	jalr	-502(ra) # ad0 <dispatch>
}
 cce:	60a2                	ld	ra,8(sp)
 cd0:	6402                	ld	s0,0(sp)
