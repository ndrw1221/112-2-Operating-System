...
printint(int fd, int xx, int base, int sgn)
{
 ...
 622:	9ea68693          	addi	a3,a3,-1558 # 1008 <digits>
...
printptr(int fd, uint64 x) {
 ...
 6fc:	91070713          	addi	a4,a4,-1776 # 1008 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 8bc:	71078793          	addi	a5,a5,1808 # fc8 <schedule_wrr+0x15e>
...
free(void *ap)
{
 ...
 a68:	5cc78793          	addi	a5,a5,1484 # 1030 <freep>
 a6c:	639c                	ld	a5,0(a5)
 ...
 b60:	4d478793          	addi	a5,a5,1236 # 1030 <freep>
...
malloc(uint nbytes)
{
 ...
 c14:	42078793          	addi	a5,a5,1056 # 1030 <freep>
 c18:	639c                	ld	a5,0(a5)
 ...
 c28:	3fc78793          	addi	a5,a5,1020 # 1020 <base>
 c2c:	fef43023          	sd	a5,-32(s0)
 c30:	00000797          	auipc	a5,0x0
 c34:	40078793          	addi	a5,a5,1024 # 1030 <freep>
 ...
 c4c:	3d878793          	addi	a5,a5,984 # 1020 <base>
 c50:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 c52:	00000797          	auipc	a5,0x0
 c56:	3ce78793          	addi	a5,a5,974 # 1020 <base>
 ...
 ce8:	34c78793          	addi	a5,a5,844 # 1030 <freep>
 cec:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
 ...
 e7a:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
 e7e:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
 e82:	00000517          	auipc	a0,0x0
 e86:	14e50513          	addi	a0,a0,334 # fd0 <schedule_wrr+0x166>
 e8a:	00000097          	auipc	ra,0x0
 e8e:	b76080e7          	jalr	-1162(ra) # a00 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
 e92:	649c                	ld	a5,8(s1)
 e94:	639c                	ld	a5,0(a5)
 e96:	faf43c23          	sd	a5,-72(s0)
 e9a:	fb843783          	ld	a5,-72(s0)
 e9e:	fd878793          	addi	a5,a5,-40
 ea2:	fcf43023          	sd	a5,-64(s0)
 ea6:	a049                	j	f28 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
 ea8:	fc043783          	ld	a5,-64(s0)
 eac:	5fdc                	lw	a5,60(a5)
 eae:	85be                	mv	a1,a5
 eb0:	00000517          	auipc	a0,0x0
 eb4:	13050513          	addi	a0,a0,304 # fe0 <schedule_wrr+0x176>
 eb8:	00000097          	auipc	ra,0x0
 ebc:	b48080e7          	jalr	-1208(ra) # a00 <printf>
 ...
 eca:	47fc                	lw	a5,76(a5)
 ecc:	40f707bb          	subw	a5,a4,a5
 ed0:	2781                	sext.w	a5,a5
 ed2:	85be                	mv	a1,a5
 ed4:	00000517          	auipc	a0,0x0
 ed8:	11c50513          	addi	a0,a0,284 # ff0 <schedule_wrr+0x186>
 edc:	00000097          	auipc	ra,0x0
 ee0:	b24080e7          	jalr	-1244(ra) # a00 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
 ee4:	fc843783          	ld	a5,-56(s0)
 ee8:	c38d                	beqz	a5,f0a <schedule_wrr+0xa0>
 eea:	fc043783          	ld	a5,-64(s0)
 eee:	4fb8                	lw	a4,88(a5)
 ef0:	fc043783          	ld	a5,-64(s0)
 ef4:	43fc                	lw	a5,68(a5)
 ef6:	00f71e63          	bne	a4,a5,f12 <schedule_wrr+0xa8>
 efa:	fc043783          	ld	a5,-64(s0)
 efe:	5fd8                	lw	a4,60(a5)
 f00:	fc843783          	ld	a5,-56(s0)
 f04:	5fdc                	lw	a5,60(a5)
 f06:	00f75663          	bge	a4,a5,f12 <schedule_wrr+0xa8>
            current_thread = th;
 f0a:	fc043783          	ld	a5,-64(s0)
 f0e:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
 f12:	fc043783          	ld	a5,-64(s0)
 f16:	779c                	ld	a5,40(a5)
 f18:	faf43423          	sd	a5,-88(s0)
 f1c:	fa843783          	ld	a5,-88(s0)
 f20:	fd878793          	addi	a5,a5,-40
 f24:	fcf43023          	sd	a5,-64(s0)
 f28:	fc043783          	ld	a5,-64(s0)
 f2c:	02878713          	addi	a4,a5,40
 f30:	649c                	ld	a5,8(s1)
 f32:	f6f71be3          	bne	a4,a5,ea8 <schedule_wrr+0x3e>
    }
 ...
 f3c:	47bc                	lw	a5,72(a5)
 f3e:	02f707bb          	mulw	a5,a4,a5
 f42:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
 f46:	fc843783          	ld	a5,-56(s0)
 f4a:	4fbc                	lw	a5,88(a5)
 f4c:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
 f50:	fc843783          	ld	a5,-56(s0)
 f54:	c795                	beqz	a5,f80 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
 f56:	fc843783          	ld	a5,-56(s0)
 f5a:	02878793          	addi	a5,a5,40
 f5e:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
 f62:	fb442603          	lw	a2,-76(s0)
 f66:	fb042783          	lw	a5,-80(s0)
 f6a:	0007869b          	sext.w	a3,a5
 f6e:	0006071b          	sext.w	a4,a2
 f72:	00d75363          	bge	a4,a3,f78 <schedule_wrr+0x10e>
 f76:	87b2                	mv	a5,a2
 f78:	2781                	sext.w	a5,a5
 f7a:	f8f42823          	sw	a5,-112(s0)
 f7e:	a039                	j	f8c <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
 f80:	649c                	ld	a5,8(s1)
 f82:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
 f86:	4785                	li	a5,1
 f88:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
 f8c:	f8843783          	ld	a5,-120(s0)
 f90:	f8f43c23          	sd	a5,-104(s0)
 f94:	f9043783          	ld	a5,-112(s0)
 f98:	faf43023          	sd	a5,-96(s0)
 f9c:	4701                	li	a4,0
 f9e:	f9843703          	ld	a4,-104(s0)
 fa2:	4781                	li	a5,0
 fa4:	fa043783          	ld	a5,-96(s0)
 fa8:	893a                	mv	s2,a4
 faa:	89be                	mv	s3,a5
 fac:	874a                	mv	a4,s2
 fae:	87ce                	mv	a5,s3
