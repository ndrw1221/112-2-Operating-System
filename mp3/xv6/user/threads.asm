...
static inline void list_del(struct list_head *entry)
{
    ...
    entry->next = LIST_POISON1;
      ...
      ca:	10070713          	addi	a4,a4,256 # 100100 <__global_pointer$+0xfdc48>
      ce:	e398                	sd	a4,0(a5)
    entry->prev = LIST_POISON2;
      d0:	fe843783          	ld	a5,-24(s0)
      d4:	00200737          	lui	a4,0x200
      d8:	20070713          	addi	a4,a4,512 # 200200 <__global_pointer$+0x1fdd48>
      dc:	e798                	sd	a4,8(a5)
}
      de:	0001                	nop
      e0:	60e2                	ld	ra,24(sp)
...
struct thread *thread_create(void (*f)(void *), void *arg, int is_real_time, int processing_time, int period, int n)
{
    ...
    t->ID = _id++;
     ...
     188:	b6c78793          	addi	a5,a5,-1172 # 1cf0 <_id.1229>
     18c:	439c                	lw	a5,0(a5)
     18e:	0017871b          	addiw	a4,a5,1
     192:	0007069b          	sext.w	a3,a4
     196:	00002717          	auipc	a4,0x2
     19a:	b5a70713          	addi	a4,a4,-1190 # 1cf0 <_id.1229>
     19e:	c314                	sw	a3,0(a4)
...
void thread_add_at(struct thread *t, int arrival_time)
{
    ...
    list_add_tail(&new_entry->thread_list, &release_queue);
     ...
     2a6:	a2658593          	addi	a1,a1,-1498 # 1cc8 <release_queue>
     2aa:	853e                	mv	a0,a5
...
void __release()
{
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list)
     ...
     2ca:	a0278793          	addi	a5,a5,-1534 # 1cc8 <release_queue>
     2ce:	639c                	ld	a5,0(a5)
     ...
     2f2:	a851                	j	386 <__release+0xc8>
    {
     ...
     2fe:	a0678793          	addi	a5,a5,-1530 # 1d00 <threading_system_time>
     302:	439c                	lw	a5,0(a5)
     ...
     340:	97c58593          	addi	a1,a1,-1668 # 1cb8 <run_queue>
     344:	853e                	mv	a0,a5
    ...
    list_for_each_entry_safe(cur, nxt, &release_queue, thread_list)
     ...
     392:	93a78793          	addi	a5,a5,-1734 # 1cc8 <release_queue>
...
void __thread_exit(struct thread *to_remove)
{
    ...
    current = to_remove->thread_list.prev;
     ...
     3bc:	94078793          	addi	a5,a5,-1728 # 1cf8 <current>
     3c0:	e398                	sd	a4,0(a5)
    ...
    thrdresume(main_thrd_id);
     ...
     404:	8ec78793          	addi	a5,a5,-1812 # 1cec <main_thrd_id>
     408:	439c                	lw	a5,0(a5)
     40a:	853e                	mv	a0,a5
...
void thread_exit(void)
{
    ...
    if (current == &run_queue)
     ...
     42a:	8d278793          	addi	a5,a5,-1838 # 1cf8 <current>
     42e:	6398                	ld	a4,0(a5)
     430:	00002797          	auipc	a5,0x2
     434:	88878793          	addi	a5,a5,-1912 # 1cb8 <run_queue>
     438:	02f71063          	bne	a4,a5,458 <thread_exit+0x3a>
    {
        fprintf(2, "[FATAL] thread_exit is called on a nonexistent thread\n");
     43c:	00001597          	auipc	a1,0x1
     440:	6fc58593          	addi	a1,a1,1788 # 1b38 <schedule_wrr+0x15a>
     444:	4509                	li	a0,2
    ...
    struct thread *to_remove = list_entry(current, struct thread, thread_list);
     ...
     45c:	8a078793          	addi	a5,a5,-1888 # 1cf8 <current>
     460:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += consume_ticks;
     ...
     48e:	87678793          	addi	a5,a5,-1930 # 1d00 <threading_system_time>
     492:	439c                	lw	a5,0(a5)
     494:	fdc42703          	lw	a4,-36(s0)
     498:	9fb9                	addw	a5,a5,a4
     49a:	0007871b          	sext.w	a4,a5
     49e:	00002797          	auipc	a5,0x2
     4a2:	86278793          	addi	a5,a5,-1950 # 1d00 <threading_system_time>
     4a6:	c398                	sw	a4,0(a5)
...
void __finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     4d2:	82a78793          	addi	a5,a5,-2006 # 1cf8 <current>
     4d6:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish at %d\n",
     ...
     504:	80078793          	addi	a5,a5,-2048 # 1d00 <threading_system_time>
     508:	4390                	lw	a2,0(a5)
     ...
     518:	65c50513          	addi	a0,a0,1628 # 1b70 <schedule_wrr+0x192>
     ...
     52a:	04f05563          	blez	a5,574 <__finish_current+0xae>
    {
     ...
     532:	7ca78793          	addi	a5,a5,1994 # 1cf8 <current>
     536:	639c                	ld	a5,0(a5)
     538:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     53c:	00001797          	auipc	a5,0x1
     540:	7bc78793          	addi	a5,a5,1980 # 1cf8 <current>
     544:	639c                	ld	a5,0(a5)
     546:	6798                	ld	a4,8(a5)
     548:	00001797          	auipc	a5,0x1
     54c:	7b078793          	addi	a5,a5,1968 # 1cf8 <current>
     550:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void __rt_finish_current()
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     596:	76678793          	addi	a5,a5,1894 # 1cf8 <current>
     59a:	639c                	ld	a5,0(a5)
    ...
    printf("thread#%d finish one cycle at %d: %d cycles left\n",
     ...
     5c4:	00001797          	auipc	a5,0x1
     5c8:	73c78793          	addi	a5,a5,1852 # 1d00 <threading_system_time>
     5cc:	4390                	lw	a2,0(a5)
     ...
     5dc:	5b050513          	addi	a0,a0,1456 # 1b88 <schedule_wrr+0x1aa>
     ...
     5ee:	04f05563          	blez	a5,638 <__rt_finish_current+0xae>
    {
     ...
     5f6:	70678793          	addi	a5,a5,1798 # 1cf8 <current>
     5fa:	639c                	ld	a5,0(a5)
     5fc:	fcf43c23          	sd	a5,-40(s0)
        current = current->prev;
     600:	00001797          	auipc	a5,0x1
     604:	6f878793          	addi	a5,a5,1784 # 1cf8 <current>
     608:	639c                	ld	a5,0(a5)
     60a:	6798                	ld	a4,8(a5)
     60c:	00001797          	auipc	a5,0x1
     610:	6ec78793          	addi	a5,a5,1772 # 1cf8 <current>
     614:	e398                	sd	a4,0(a5)
        list_del(to_remove);
...
void switch_handler(void *arg)
{
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     666:	69678793          	addi	a5,a5,1686 # 1cf8 <current>
     66a:	639c                	ld	a5,0(a5)
    ...
    threading_system_time += elapsed_time;
     ...
     688:	67c78793          	addi	a5,a5,1660 # 1d00 <threading_system_time>
     68c:	439c                	lw	a5,0(a5)
     ...
     69c:	66878793          	addi	a5,a5,1640 # 1d00 <threading_system_time>
     6a0:	c398                	sw	a4,0(a5)
    __release();
    ...
    if (current_thread->is_real_time)
     ...
     6dc:	62878793          	addi	a5,a5,1576 # 1d00 <threading_system_time>
     6e0:	439c                	lw	a5,0(a5)
     ...
     6f0:	61478793          	addi	a5,a5,1556 # 1d00 <threading_system_time>
     6f4:	439c                	lw	a5,0(a5)
        if (threading_system_time > current_thread->current_deadline ||
     ...
     70e:	5f678793          	addi	a5,a5,1526 # 1d00 <threading_system_time>
     712:	439c                	lw	a5,0(a5)
     714:	863e                	mv	a2,a5
     716:	85ba                	mv	a1,a4
     718:	00001517          	auipc	a0,0x1
     71c:	4a850513          	addi	a0,a0,1192 # 1bc0 <schedule_wrr+0x1e2>
    ...
    else
    {
     ...
     75c:	5a078793          	addi	a5,a5,1440 # 1cf8 <current>
     760:	639c                	ld	a5,0(a5)
     762:	fcf43823          	sd	a5,-48(s0)
        current = current->prev;
     766:	00001797          	auipc	a5,0x1
     76a:	59278793          	addi	a5,a5,1426 # 1cf8 <current>
     76e:	639c                	ld	a5,0(a5)
     770:	6798                	ld	a4,8(a5)
     772:	00001797          	auipc	a5,0x1
     776:	58678793          	addi	a5,a5,1414 # 1cf8 <current>
     77a:	e398                	sd	a4,0(a5)
        list_del(to_remove);
     ...
     788:	00001597          	auipc	a1,0x1
     78c:	53058593          	addi	a1,a1,1328 # 1cb8 <run_queue>
    ...
    thrdresume(main_thrd_id);
     ...
     7b8:	53878793          	addi	a5,a5,1336 # 1cec <main_thrd_id>
     7bc:	439c                	lw	a5,0(a5)
     7be:	853e                	mv	a0,a5
...
void __dispatch()
{
    ...
    if (current == &run_queue)
     ...
     7de:	51e78793          	addi	a5,a5,1310 # 1cf8 <current>
     7e2:	6398                	ld	a4,0(a5)
     7e4:	00001797          	auipc	a5,0x1
     7e8:	4d478793          	addi	a5,a5,1236 # 1cb8 <run_queue>
    ...
    struct thread *current_thread = list_entry(current, struct thread, thread_list);
     ...
     7f4:	50878793          	addi	a5,a5,1288 # 1cf8 <current>
     7f8:	639c                	ld	a5,0(a5)
    ...
    if (current_thread->is_real_time && allocated_time == 0)
     ...
     816:	4f678793          	addi	a5,a5,1270 # 1d08 <allocated_time>
     81a:	639c                	ld	a5,0(a5)
    ...
    { // miss deadline, abort
     ...
     832:	39250513          	addi	a0,a0,914 # 1bc0 <schedule_wrr+0x1e2>
    ...
    printf("dispatch thread#%d at %d: allocated_time=%d\n", current_thread->ID, threading_system_time, allocated_time);
     ...
     852:	4b278793          	addi	a5,a5,1202 # 1d00 <threading_system_time>
     856:	4390                	lw	a2,0(a5)
     858:	00001797          	auipc	a5,0x1
     85c:	4b078793          	addi	a5,a5,1200 # 1d08 <allocated_time>
     860:	639c                	ld	a5,0(a5)
     862:	86be                	mv	a3,a5
     864:	85ba                	mv	a1,a4
     866:	00001517          	auipc	a0,0x1
     86a:	38250513          	addi	a0,a0,898 # 1be8 <schedule_wrr+0x20a>
    ...
    else
    {
     ...
     920:	2fc58593          	addi	a1,a1,764 # 1c18 <schedule_wrr+0x23a>
     924:	4509                	li	a0,2
...
void __schedule()
{
    ...
    struct threads_sched_args args = {
     ...
     96e:	39678793          	addi	a5,a5,918 # 1d00 <threading_system_time>
     972:	439c                	lw	a5,0(a5)
     974:	fcf42c23          	sw	a5,-40(s0)
     978:	4789                	li	a5,2
     97a:	fcf42e23          	sw	a5,-36(s0)
     97e:	00001797          	auipc	a5,0x1
     982:	33a78793          	addi	a5,a5,826 # 1cb8 <run_queue>
     986:	fef43023          	sd	a5,-32(s0)
     98a:	00001797          	auipc	a5,0x1
     98e:	33e78793          	addi	a5,a5,830 # 1cc8 <release_queue>
    ...
    r = schedule_wrr(args);
     ...
     9b8:	02a080e7          	jalr	42(ra) # 19de <schedule_wrr>
     9bc:	872a                	mv	a4,a0
     9be:	87ae                	mv	a5,a1
    ...
    current = r.scheduled_thread_list_member;
     ...
     9d0:	32c78793          	addi	a5,a5,812 # 1cf8 <current>
     9d4:	e398                	sd	a4,0(a5)
    allocated_time = r.allocated_time;
     9d6:	fd042783          	lw	a5,-48(s0)
     9da:	873e                	mv	a4,a5
     9dc:	00001797          	auipc	a5,0x1
     9e0:	32c78793          	addi	a5,a5,812 # 1d08 <allocated_time>
     9e4:	e398                	sd	a4,0(a5)
}
     9e6:	0001                	nop
...
void back_to_main_handler(void *arg)
{
    ...
    sleeping = 0;
     ...
     a00:	30878793          	addi	a5,a5,776 # 1d04 <sleeping>
    ...
    threading_system_time += (uint64)arg;
     ...
     a14:	2f078793          	addi	a5,a5,752 # 1d00 <threading_system_time>
     a18:	439c                	lw	a5,0(a5)
     ...
     a28:	2dc78793          	addi	a5,a5,732 # 1d00 <threading_system_time>
     a2c:	c398                	sw	a4,0(a5)
    thrdresume(main_thrd_id);
     a2e:	00001797          	auipc	a5,0x1
     a32:	2be78793          	addi	a5,a5,702 # 1cec <main_thrd_id>
     a36:	439c                	lw	a5,0(a5)
     a38:	853e                	mv	a0,a5
...
void thread_start_threading()
{
    ...
    threading_system_time = 0;
     ...
     a58:	2ac78793          	addi	a5,a5,684 # 1d00 <threading_system_time>
     a5c:	0007a023          	sw	zero,0(a5)
    current = &run_queue;
     a60:	00001797          	auipc	a5,0x1
     a64:	29878793          	addi	a5,a5,664 # 1cf8 <current>
     a68:	00001717          	auipc	a4,0x1
     a6c:	25070713          	addi	a4,a4,592 # 1cb8 <run_queue>
     a70:	e398                	sd	a4,0(a5)
    ...
    thrdstop(1000, &main_thrd_id, back_to_main_handler, (void *)0);
     ...
     a80:	27058593          	addi	a1,a1,624 # 1cec <main_thrd_id>
    ...
    cancelthrdstop(main_thrd_id, 0);
     ...
     a94:	25c78793          	addi	a5,a5,604 # 1cec <main_thrd_id>
     a98:	439c                	lw	a5,0(a5)
     a9a:	4581                	li	a1,0
     a9c:	853e                	mv	a0,a5
     ...
     aa6:	a0c9                	j	b68 <thread_start_threading+0x11c>
    {
     ...
     abc:	23478793          	addi	a5,a5,564 # 1cec <main_thrd_id>
     ac0:	439c                	lw	a5,0(a5)
     ac2:	4581                	li	a1,0
     ac4:	853e                	mv	a0,a5
     ...
     ada:	1e250513          	addi	a0,a0,482 # 1cb8 <run_queue>
     ...
     aee:	1de50513          	addi	a0,a0,478 # 1cc8 <release_queue>
     ...
     b60:	1a878793          	addi	a5,a5,424 # 1d04 <sleeping>
     b64:	439c                	lw	a5,0(a5)
     b66:	fbfd                	bnez	a5,b5c <thread_start_threading+0x110>
    while (!list_empty(&run_queue) || !list_empty(&release_queue))
     b68:	00001517          	auipc	a0,0x1
     b6c:	15050513          	addi	a0,a0,336 # 1cb8 <run_queue>
     ...
     b80:	14c50513          	addi	a0,a0,332 # 1cc8 <release_queue>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1196:	b4668693          	addi	a3,a3,-1210 # 1cd8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1270:	a6c70713          	addi	a4,a4,-1428 # 1cd8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1430:	84c78793          	addi	a5,a5,-1972 # 1c78 <schedule_wrr+0x29a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15d8:	00000797          	auipc	a5,0x0
    15dc:	74878793          	addi	a5,a5,1864 # 1d20 <freep>
  ...
  freep = p;
    16d0:	00000797          	auipc	a5,0x0
    16d4:	65078793          	addi	a5,a5,1616 # 1d20 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    1752:	00000797          	auipc	a5,0x0
    1756:	5ce78793          	addi	a5,a5,1486 # 1d20 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1784:	00000797          	auipc	a5,0x0
    1788:	59c78793          	addi	a5,a5,1436 # 1d20 <freep>
    ...
    179c:	57878793          	addi	a5,a5,1400 # 1d10 <base>
    17a0:	fef43023          	sd	a5,-32(s0)
    17a4:	00000797          	auipc	a5,0x0
    17a8:	57c78793          	addi	a5,a5,1404 # 1d20 <freep>
    17ac:	fe043703          	ld	a4,-32(s0)
    17b0:	e398                	sd	a4,0(a5)
    17b2:	00000797          	auipc	a5,0x0
    17b6:	56e78793          	addi	a5,a5,1390 # 1d20 <freep>
    17ba:	6398                	ld	a4,0(a5)
    17bc:	00000797          	auipc	a5,0x0
    17c0:	55478793          	addi	a5,a5,1364 # 1d10 <base>
    17c4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
    17c6:	00000797          	auipc	a5,0x0
    17ca:	54a78793          	addi	a5,a5,1354 # 1d10 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1840:	c798                	sw	a4,8(a5)
      ...
      freep = prevp;
    1842:	00000797          	auipc	a5,0x0
    1846:	4de78793          	addi	a5,a5,1246 # 1d20 <freep>
    ...
    185c:	4c878793          	addi	a5,a5,1224 # 1d20 <freep>
...
{
    19de:	7119                	addi	sp,sp,-128
    19e0:	fc86                	sd	ra,120(sp)
    19e2:	f8a2                	sd	s0,112(sp)
    19e4:	f4a6                	sd	s1,104(sp)
    19e6:	f0ca                	sd	s2,96(sp)
    19e8:	ecce                	sd	s3,88(sp)
    19ea:	0100                	addi	s0,sp,128
    19ec:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    19ee:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    19f2:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    19f6:	00000517          	auipc	a0,0x0
    19fa:	28a50513          	addi	a0,a0,650 # 1c80 <schedule_wrr+0x2a2>
    19fe:	00000097          	auipc	ra,0x0
    1a02:	b76080e7          	jalr	-1162(ra) # 1574 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    1a06:	649c                	ld	a5,8(s1)
    1a08:	639c                	ld	a5,0(a5)
    1a0a:	faf43c23          	sd	a5,-72(s0)
    1a0e:	fb843783          	ld	a5,-72(s0)
    1a12:	fd878793          	addi	a5,a5,-40
    1a16:	fcf43023          	sd	a5,-64(s0)
    1a1a:	a049                	j	1a9c <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    1a1c:	fc043783          	ld	a5,-64(s0)
    1a20:	5fdc                	lw	a5,60(a5)
    1a22:	85be                	mv	a1,a5
    1a24:	00000517          	auipc	a0,0x0
    1a28:	26c50513          	addi	a0,a0,620 # 1c90 <schedule_wrr+0x2b2>
    1a2c:	00000097          	auipc	ra,0x0
    1a30:	b48080e7          	jalr	-1208(ra) # 1574 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    1a34:	fc043783          	ld	a5,-64(s0)
    1a38:	4ff8                	lw	a4,92(a5)
    1a3a:	fc043783          	ld	a5,-64(s0)
    1a3e:	47fc                	lw	a5,76(a5)
    1a40:	40f707bb          	subw	a5,a4,a5
    1a44:	2781                	sext.w	a5,a5
    1a46:	85be                	mv	a1,a5
    1a48:	00000517          	auipc	a0,0x0
    1a4c:	25850513          	addi	a0,a0,600 # 1ca0 <schedule_wrr+0x2c2>
    1a50:	00000097          	auipc	ra,0x0
    1a54:	b24080e7          	jalr	-1244(ra) # 1574 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    1a58:	fc843783          	ld	a5,-56(s0)
    1a5c:	c38d                	beqz	a5,1a7e <schedule_wrr+0xa0>
    1a5e:	fc043783          	ld	a5,-64(s0)
    1a62:	4fb8                	lw	a4,88(a5)
    1a64:	fc043783          	ld	a5,-64(s0)
    1a68:	43fc                	lw	a5,68(a5)
    1a6a:	00f71e63          	bne	a4,a5,1a86 <schedule_wrr+0xa8>
    1a6e:	fc043783          	ld	a5,-64(s0)
    1a72:	5fd8                	lw	a4,60(a5)
    1a74:	fc843783          	ld	a5,-56(s0)
    1a78:	5fdc                	lw	a5,60(a5)
    1a7a:	00f75663          	bge	a4,a5,1a86 <schedule_wrr+0xa8>
            current_thread = th;
    1a7e:	fc043783          	ld	a5,-64(s0)
    1a82:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    1a86:	fc043783          	ld	a5,-64(s0)
    1a8a:	779c                	ld	a5,40(a5)
    1a8c:	faf43423          	sd	a5,-88(s0)
    1a90:	fa843783          	ld	a5,-88(s0)
    1a94:	fd878793          	addi	a5,a5,-40
    1a98:	fcf43023          	sd	a5,-64(s0)
    1a9c:	fc043783          	ld	a5,-64(s0)
    1aa0:	02878713          	addi	a4,a5,40
    1aa4:	649c                	ld	a5,8(s1)
    1aa6:	f6f71be3          	bne	a4,a5,1a1c <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    1aaa:	40d8                	lw	a4,4(s1)
    1aac:	fc843783          	ld	a5,-56(s0)
    1ab0:	47bc                	lw	a5,72(a5)
    1ab2:	02f707bb          	mulw	a5,a4,a5
    1ab6:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    1aba:	fc843783          	ld	a5,-56(s0)
    1abe:	4fbc                	lw	a5,88(a5)
    1ac0:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    1ac4:	fc843783          	ld	a5,-56(s0)
    1ac8:	c795                	beqz	a5,1af4 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    1aca:	fc843783          	ld	a5,-56(s0)
    1ace:	02878793          	addi	a5,a5,40
    1ad2:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    1ad6:	fb442603          	lw	a2,-76(s0)
    1ada:	fb042783          	lw	a5,-80(s0)
    1ade:	0007869b          	sext.w	a3,a5
    1ae2:	0006071b          	sext.w	a4,a2
    1ae6:	00d75363          	bge	a4,a3,1aec <schedule_wrr+0x10e>
    1aea:	87b2                	mv	a5,a2
    1aec:	2781                	sext.w	a5,a5
    1aee:	f8f42823          	sw	a5,-112(s0)
    1af2:	a039                	j	1b00 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    1af4:	649c                	ld	a5,8(s1)
    1af6:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    1afa:	4785                	li	a5,1
    1afc:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    1b00:	f8843783          	ld	a5,-120(s0)
    1b04:	f8f43c23          	sd	a5,-104(s0)
    1b08:	f9043783          	ld	a5,-112(s0)
    1b0c:	faf43023          	sd	a5,-96(s0)
    1b10:	4701                	li	a4,0
    1b12:	f9843703          	ld	a4,-104(s0)
    1b16:	4781                	li	a5,0
    1b18:	fa043783          	ld	a5,-96(s0)
    1b1c:	893a                	mv	s2,a4
    1b1e:	89be                	mv	s3,a5
    1b20:	874a                	mv	a4,s2
    1b22:	87ce                	mv	a5,s3
    ...
    1b24:	853a                	mv	a0,a4
    1b26:	85be                	mv	a1,a5
    1b28:	70e6                	ld	ra,120(sp)
    1b2a:	7446                	ld	s0,112(sp)
    1b2c:	74a6                	ld	s1,104(sp)
    1b2e:	7906                	ld	s2,96(sp)
    1b30:	69e6                	ld	s3,88(sp)
    1b32:	6109                	addi	sp,sp,128
    1b34:	8082                	ret
