...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      32:	efa78793          	addi	a5,a5,-262 # 1f28 <schedule_wrr+0x18c>
      36:	97ba                	add	a5,a5,a4
      38:	439c                	lw	a5,0(a5)
      3a:	0007871b          	sext.w	a4,a5
      3e:	00002797          	auipc	a5,0x2
      42:	eea78793          	addi	a5,a5,-278 # 1f28 <schedule_wrr+0x18c>
      46:	97ba                	add	a5,a5,a4
      48:	8782                	jr	a5
  default:
    panic("runcmd");
      4a:	00002517          	auipc	a0,0x2
      4e:	eae50513          	addi	a0,a0,-338 # 1ef8 <schedule_wrr+0x15c>
  ...
  case EXEC:
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      98:	e6c58593          	addi	a1,a1,-404 # 1f00 <schedule_wrr+0x164>
      9c:	4509                	li	a0,2
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
      ...
      ea:	e2a58593          	addi	a1,a1,-470 # 1f10 <schedule_wrr+0x174>
      ee:	4509                	li	a0,2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     174:	db050513          	addi	a0,a0,-592 # 1f20 <schedule_wrr+0x184>
...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
     ...
     298:	cac58593          	addi	a1,a1,-852 # 1f40 <schedule_wrr+0x1a4>
     29c:	4509                	li	a0,2
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     314:	c3850513          	addi	a0,a0,-968 # 1f48 <schedule_wrr+0x1ac>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     378:	d2c50513          	addi	a0,a0,-724 # 20a0 <buf.1144>
     ...
     390:	d1470713          	addi	a4,a4,-748 # 20a0 <buf.1144>
     ...
     3a2:	d0578793          	addi	a5,a5,-763 # 20a3 <buf.1144+0x3>
     3a6:	853e                	mv	a0,a5
     ...
     3ba:	ced78793          	addi	a5,a5,-787 # 20a3 <buf.1144+0x3>
     3be:	863e                	mv	a2,a5
     3c0:	00002597          	auipc	a1,0x2
     3c4:	b9058593          	addi	a1,a1,-1136 # 1f50 <schedule_wrr+0x1b4>
     3c8:	4509                	li	a0,2
    ...
    if(fork1() == 0)
     ...
     3e4:	cc050513          	addi	a0,a0,-832 # 20a0 <buf.1144>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     40e:	c9650513          	addi	a0,a0,-874 # 20a0 <buf.1144>
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
     ...
     43e:	b2658593          	addi	a1,a1,-1242 # 1f60 <schedule_wrr+0x1c4>
     442:	4509                	li	a0,2
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     47e:	aee50513          	addi	a0,a0,-1298 # 1f68 <schedule_wrr+0x1cc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     6a4:	9f050513          	addi	a0,a0,-1552 # 2090 <whitespace>
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     7a0:	8f450513          	addi	a0,a0,-1804 # 2090 <whitespace>
     ...
     7be:	8de50513          	addi	a0,a0,-1826 # 2098 <symbols>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     810:	88450513          	addi	a0,a0,-1916 # 2090 <whitespace>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     87c:	81850513          	addi	a0,a0,-2024 # 2090 <whitespace>
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     916:	65e60613          	addi	a2,a2,1630 # 1f70 <schedule_wrr+0x1d4>
  ...
  if(s != es){
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     93e:	63e58593          	addi	a1,a1,1598 # 1f78 <schedule_wrr+0x1dc>
     942:	4509                	li	a0,2
     944:	00001097          	auipc	ra,0x1
     948:	f96080e7          	jalr	-106(ra) # 18da <fprintf>
    panic("syntax");
     94c:	00001517          	auipc	a0,0x1
     950:	63c50513          	addi	a0,a0,1596 # 1f88 <schedule_wrr+0x1ec>
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     9c6:	5ce60613          	addi	a2,a2,1486 # 1f90 <schedule_wrr+0x1f4>
  ...
  if(peek(ps, es, ";")){
     ...
     9e2:	5ba60613          	addi	a2,a2,1466 # 1f98 <schedule_wrr+0x1fc>
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     ...
     a68:	53c60613          	addi	a2,a2,1340 # 1fa0 <schedule_wrr+0x204>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     b22:	48a50513          	addi	a0,a0,1162 # 1fa8 <schedule_wrr+0x20c>
  ...
  while(peek(ps, es, "<>")){
     ...
     bd6:	3f660613          	addi	a2,a2,1014 # 1fc8 <schedule_wrr+0x22c>
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     ...
     c12:	3c260613          	addi	a2,a2,962 # 1fd0 <schedule_wrr+0x234>
    ...
    panic("parseblock");
     ...
     c2e:	3ae50513          	addi	a0,a0,942 # 1fd8 <schedule_wrr+0x23c>
  ...
  if(!peek(ps, es, ")"))
     ...
     c66:	38660613          	addi	a2,a2,902 # 1fe8 <schedule_wrr+0x24c>
    ...
    panic("syntax - missing )");
     ...
     c82:	37250513          	addi	a0,a0,882 # 1ff0 <schedule_wrr+0x254>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     cdc:	2f860613          	addi	a2,a2,760 # 1fd0 <schedule_wrr+0x234>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     d78:	21450513          	addi	a0,a0,532 # 1f88 <schedule_wrr+0x1ec>
    ...
    if(argc >= MAXARGS)
     ...
     dc6:	24650513          	addi	a0,a0,582 # 2008 <schedule_wrr+0x26c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     dee:	22e60613          	addi	a2,a2,558 # 2018 <schedule_wrr+0x27c>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     e66:	1be78793          	addi	a5,a5,446 # 2020 <schedule_wrr+0x284>
     e6a:	97ba                	add	a5,a5,a4
     e6c:	439c                	lw	a5,0(a5)
     e6e:	0007871b          	sext.w	a4,a5
     e72:	00001797          	auipc	a5,0x1
     e76:	1ae78793          	addi	a5,a5,430 # 2020 <schedule_wrr+0x284>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1554:	b2868693          	addi	a3,a3,-1240 # 2078 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    162e:	a4e70713          	addi	a4,a4,-1458 # 2078 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    17ee:	84e78793          	addi	a5,a5,-1970 # 2038 <schedule_wrr+0x29c>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    199a:	78278793          	addi	a5,a5,1922 # 2118 <freep>
  ...
  freep = p;
    ...
    1a92:	68a78793          	addi	a5,a5,1674 # 2118 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1b14:	60878793          	addi	a5,a5,1544 # 2118 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1b46:	5d678793          	addi	a5,a5,1494 # 2118 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1c04:	51878793          	addi	a5,a5,1304 # 2118 <freep>
    ...
    1c1a:	50278793          	addi	a5,a5,1282 # 2118 <freep>
...
0000000000001d9c <schedule_wrr>:

/* MP3 Part 1 - Non-Real-Time Scheduling */
/* Weighted-Round-Robin Scheduling */
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    1d9c:	7119                	addi	sp,sp,-128
    1d9e:	fc86                	sd	ra,120(sp)
    1da0:	f8a2                	sd	s0,112(sp)
    1da2:	f4a6                	sd	s1,104(sp)
    1da4:	f0ca                	sd	s2,96(sp)
    1da6:	ecce                	sd	s3,88(sp)
    1da8:	0100                	addi	s0,sp,128
    1daa:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    1dac:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1db0:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    1db4:	00000517          	auipc	a0,0x0
    1db8:	28c50513          	addi	a0,a0,652 # 2040 <schedule_wrr+0x2a4>
    1dbc:	00000097          	auipc	ra,0x0
    1dc0:	b76080e7          	jalr	-1162(ra) # 1932 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    1dc4:	649c                	ld	a5,8(s1)
    1dc6:	639c                	ld	a5,0(a5)
    1dc8:	faf43c23          	sd	a5,-72(s0)
    1dcc:	fb843783          	ld	a5,-72(s0)
    1dd0:	fd878793          	addi	a5,a5,-40
    1dd4:	fcf43023          	sd	a5,-64(s0)
    1dd8:	a049                	j	1e5a <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    1dda:	fc043783          	ld	a5,-64(s0)
    1dde:	5fdc                	lw	a5,60(a5)
    1de0:	85be                	mv	a1,a5
    1de2:	00000517          	auipc	a0,0x0
    1de6:	26e50513          	addi	a0,a0,622 # 2050 <schedule_wrr+0x2b4>
    1dea:	00000097          	auipc	ra,0x0
    1dee:	b48080e7          	jalr	-1208(ra) # 1932 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    1df2:	fc043783          	ld	a5,-64(s0)
    1df6:	4ff8                	lw	a4,92(a5)
    1df8:	fc043783          	ld	a5,-64(s0)
    1dfc:	47fc                	lw	a5,76(a5)
    1dfe:	40f707bb          	subw	a5,a4,a5
    1e02:	2781                	sext.w	a5,a5
    1e04:	85be                	mv	a1,a5
    1e06:	00000517          	auipc	a0,0x0
    1e0a:	25a50513          	addi	a0,a0,602 # 2060 <schedule_wrr+0x2c4>
    1e0e:	00000097          	auipc	ra,0x0
    1e12:	b24080e7          	jalr	-1244(ra) # 1932 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    1e16:	fc843783          	ld	a5,-56(s0)
    1e1a:	c38d                	beqz	a5,1e3c <schedule_wrr+0xa0>
    1e1c:	fc043783          	ld	a5,-64(s0)
    1e20:	4fb8                	lw	a4,88(a5)
    1e22:	fc043783          	ld	a5,-64(s0)
    1e26:	43fc                	lw	a5,68(a5)
    1e28:	00f71e63          	bne	a4,a5,1e44 <schedule_wrr+0xa8>
    1e2c:	fc043783          	ld	a5,-64(s0)
    1e30:	5fd8                	lw	a4,60(a5)
    1e32:	fc843783          	ld	a5,-56(s0)
    1e36:	5fdc                	lw	a5,60(a5)
    1e38:	00f75663          	bge	a4,a5,1e44 <schedule_wrr+0xa8>
            current_thread = th;
    1e3c:	fc043783          	ld	a5,-64(s0)
    1e40:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    1e44:	fc043783          	ld	a5,-64(s0)
    1e48:	779c                	ld	a5,40(a5)
    1e4a:	faf43423          	sd	a5,-88(s0)
    1e4e:	fa843783          	ld	a5,-88(s0)
    1e52:	fd878793          	addi	a5,a5,-40
    1e56:	fcf43023          	sd	a5,-64(s0)
    1e5a:	fc043783          	ld	a5,-64(s0)
    1e5e:	02878713          	addi	a4,a5,40
    1e62:	649c                	ld	a5,8(s1)
    1e64:	f6f71be3          	bne	a4,a5,1dda <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    1e68:	40d8                	lw	a4,4(s1)
    1e6a:	fc843783          	ld	a5,-56(s0)
    1e6e:	47bc                	lw	a5,72(a5)
    1e70:	02f707bb          	mulw	a5,a4,a5
    1e74:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    1e78:	fc843783          	ld	a5,-56(s0)
    1e7c:	4fbc                	lw	a5,88(a5)
    1e7e:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    1e82:	fc843783          	ld	a5,-56(s0)
    1e86:	c795                	beqz	a5,1eb2 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    1e88:	fc843783          	ld	a5,-56(s0)
    1e8c:	02878793          	addi	a5,a5,40
    1e90:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    1e94:	fb442603          	lw	a2,-76(s0)
    1e98:	fb042783          	lw	a5,-80(s0)
    1e9c:	0007869b          	sext.w	a3,a5
    1ea0:	0006071b          	sext.w	a4,a2
    1ea4:	00d75363          	bge	a4,a3,1eaa <schedule_wrr+0x10e>
    1ea8:	87b2                	mv	a5,a2
    1eaa:	2781                	sext.w	a5,a5
    1eac:	f8f42823          	sw	a5,-112(s0)
    1eb0:	a039                	j	1ebe <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    1eb2:	649c                	ld	a5,8(s1)
    1eb4:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    1eb8:	4785                	li	a5,1
    1eba:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    1ebe:	f8843783          	ld	a5,-120(s0)
    1ec2:	f8f43c23          	sd	a5,-104(s0)
    1ec6:	f9043783          	ld	a5,-112(s0)
    1eca:	faf43023          	sd	a5,-96(s0)
    1ece:	4701                	li	a4,0
    1ed0:	f9843703          	ld	a4,-104(s0)
    1ed4:	4781                	li	a5,0
    ...
    1ee2:	853a                	mv	a0,a4
    1ee4:	85be                	mv	a1,a5
    1ee6:	70e6                	ld	ra,120(sp)
    1ee8:	7446                	ld	s0,112(sp)
    1eea:	74a6                	ld	s1,104(sp)
    1eec:	7906                	ld	s2,96(sp)
    1eee:	69e6                	ld	s3,88(sp)
    1ef0:	6109                	addi	sp,sp,128
    1ef2:	8082                	ret
