...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
      ...
      9a:	35a50513          	addi	a0,a0,858 # 13f0 <buf.1118>
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
      ...
      c0:	33478793          	addi	a5,a5,820 # 13f0 <buf.1118>
  ...
  return buf;
      ...
      f4:	30078793          	addi	a5,a5,768 # 13f0 <buf.1118>
}
      f8:	853e                	mv	a0,a5
      fa:	70e2                	ld	ra,56(sp)
      fc:	7442                	ld	s0,48(sp)
...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    fprintf(2, "ls: cannot open %s\n", path);
     ...
     13c:	1f058593          	addi	a1,a1,496 # 1328 <schedule_wrr+0x158>
     140:	4509                	li	a0,2
  ...
  if(fstat(fd, &st) < 0){
    ...
    fprintf(2, "ls: cannot stat %s\n", path);
     ...
     16e:	1d658593          	addi	a1,a1,470 # 1340 <schedule_wrr+0x170>
     172:	4509                	li	a0,2
  ...
  case T_FILE:
    printf("%s %d %d %l\n", fmtname(path), st.type, st.ino, st.size);
     ...
     1c4:	19850513          	addi	a0,a0,408 # 1358 <schedule_wrr+0x188>
  ...
  case T_DIR:
    if(strlen(path) + 1 + DIRSIZ + 1 > sizeof buf){
     ...
     1f4:	17850513          	addi	a0,a0,376 # 1368 <schedule_wrr+0x198>
    ...
    *p++ = '/';
    ...
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
     ...
     296:	0ae50513          	addi	a0,a0,174 # 1340 <schedule_wrr+0x170>
     ...
     2c8:	0bc50513          	addi	a0,a0,188 # 1380 <schedule_wrr+0x1b0>
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
     ...
     336:	05e50513          	addi	a0,a0,94 # 1390 <schedule_wrr+0x1c0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     988:	a5468693          	addi	a3,a3,-1452 # 13d8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     a62:	97a70713          	addi	a4,a4,-1670 # 13d8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     c22:	77a78793          	addi	a5,a5,1914 # 1398 <schedule_wrr+0x1c8>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     dce:	64678793          	addi	a5,a5,1606 # 1410 <freep>
     dd2:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     ec6:	54e78793          	addi	a5,a5,1358 # 1410 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     f48:	4cc78793          	addi	a5,a5,1228 # 1410 <freep>
     f4c:	639c                	ld	a5,0(a5)
}
     f4e:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     f7a:	49a78793          	addi	a5,a5,1178 # 1410 <freep>
     f7e:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     f8e:	47678793          	addi	a5,a5,1142 # 1400 <base>
     f92:	fef43023          	sd	a5,-32(s0)
     f96:	00000797          	auipc	a5,0x0
     f9a:	47a78793          	addi	a5,a5,1146 # 1410 <freep>
     f9e:	fe043703          	ld	a4,-32(s0)
     fa2:	e398                	sd	a4,0(a5)
     fa4:	00000797          	auipc	a5,0x0
     fa8:	46c78793          	addi	a5,a5,1132 # 1410 <freep>
     fac:	6398                	ld	a4,0(a5)
     fae:	00000797          	auipc	a5,0x0
     fb2:	45278793          	addi	a5,a5,1106 # 1400 <base>
     fb6:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     fb8:	00000797          	auipc	a5,0x0
     fbc:	44878793          	addi	a5,a5,1096 # 1400 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1038:	3dc78793          	addi	a5,a5,988 # 1410 <freep>
    ...
    104e:	3c678793          	addi	a5,a5,966 # 1410 <freep>
...
{
    11d0:	7119                	addi	sp,sp,-128
    11d2:	fc86                	sd	ra,120(sp)
    11d4:	f8a2                	sd	s0,112(sp)
    11d6:	f4a6                	sd	s1,104(sp)
    11d8:	f0ca                	sd	s2,96(sp)
    11da:	ecce                	sd	s3,88(sp)
    11dc:	0100                	addi	s0,sp,128
    11de:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    11e0:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    11e4:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    11e8:	00000517          	auipc	a0,0x0
    11ec:	1b850513          	addi	a0,a0,440 # 13a0 <schedule_wrr+0x1d0>
    11f0:	00000097          	auipc	ra,0x0
    11f4:	b76080e7          	jalr	-1162(ra) # d66 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    11f8:	649c                	ld	a5,8(s1)
    11fa:	639c                	ld	a5,0(a5)
    11fc:	faf43c23          	sd	a5,-72(s0)
    1200:	fb843783          	ld	a5,-72(s0)
    1204:	fd878793          	addi	a5,a5,-40
    1208:	fcf43023          	sd	a5,-64(s0)
    120c:	a049                	j	128e <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    120e:	fc043783          	ld	a5,-64(s0)
    1212:	5fdc                	lw	a5,60(a5)
    1214:	85be                	mv	a1,a5
    1216:	00000517          	auipc	a0,0x0
    121a:	19a50513          	addi	a0,a0,410 # 13b0 <schedule_wrr+0x1e0>
    121e:	00000097          	auipc	ra,0x0
    1222:	b48080e7          	jalr	-1208(ra) # d66 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    1226:	fc043783          	ld	a5,-64(s0)
    122a:	4ff8                	lw	a4,92(a5)
    122c:	fc043783          	ld	a5,-64(s0)
    1230:	47fc                	lw	a5,76(a5)
    1232:	40f707bb          	subw	a5,a4,a5
    1236:	2781                	sext.w	a5,a5
    1238:	85be                	mv	a1,a5
    123a:	00000517          	auipc	a0,0x0
    123e:	18650513          	addi	a0,a0,390 # 13c0 <schedule_wrr+0x1f0>
    1242:	00000097          	auipc	ra,0x0
    1246:	b24080e7          	jalr	-1244(ra) # d66 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    124a:	fc843783          	ld	a5,-56(s0)
    124e:	c38d                	beqz	a5,1270 <schedule_wrr+0xa0>
    1250:	fc043783          	ld	a5,-64(s0)
    1254:	4fb8                	lw	a4,88(a5)
    1256:	fc043783          	ld	a5,-64(s0)
    125a:	43fc                	lw	a5,68(a5)
    125c:	00f71e63          	bne	a4,a5,1278 <schedule_wrr+0xa8>
    1260:	fc043783          	ld	a5,-64(s0)
    1264:	5fd8                	lw	a4,60(a5)
    1266:	fc843783          	ld	a5,-56(s0)
    126a:	5fdc                	lw	a5,60(a5)
    126c:	00f75663          	bge	a4,a5,1278 <schedule_wrr+0xa8>
            current_thread = th;
    ...
    1298:	f6f71be3          	bne	a4,a5,120e <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    129c:	40d8                	lw	a4,4(s1)
    129e:	fc843783          	ld	a5,-56(s0)
    12a2:	47bc                	lw	a5,72(a5)
    12a4:	02f707bb          	mulw	a5,a4,a5
    12a8:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    12ac:	fc843783          	ld	a5,-56(s0)
    12b0:	4fbc                	lw	a5,88(a5)
    12b2:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    12b6:	fc843783          	ld	a5,-56(s0)
    12ba:	c795                	beqz	a5,12e6 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    12bc:	fc843783          	ld	a5,-56(s0)
    12c0:	02878793          	addi	a5,a5,40
    12c4:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    12c8:	fb442603          	lw	a2,-76(s0)
    12cc:	fb042783          	lw	a5,-80(s0)
    12d0:	0007869b          	sext.w	a3,a5
    12d4:	0006071b          	sext.w	a4,a2
    12d8:	00d75363          	bge	a4,a3,12de <schedule_wrr+0x10e>
    12dc:	87b2                	mv	a5,a2
    12de:	2781                	sext.w	a5,a5
    12e0:	f8f42823          	sw	a5,-112(s0)
    12e4:	a039                	j	12f2 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    12e6:	649c                	ld	a5,8(s1)
    12e8:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    12ec:	4785                	li	a5,1
    12ee:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    12f2:	f8843783          	ld	a5,-120(s0)
    12f6:	f8f43c23          	sd	a5,-104(s0)
    12fa:	f9043783          	ld	a5,-112(s0)
    12fe:	faf43023          	sd	a5,-96(s0)
    1302:	4701                	li	a4,0
    1304:	f9843703          	ld	a4,-104(s0)
    1308:	4781                	li	a5,0
    130a:	fa043783          	ld	a5,-96(s0)
    130e:	893a                	mv	s2,a4
    1310:	89be                	mv	s3,a5
    1312:	874a                	mv	a4,s2
    1314:	87ce                	mv	a5,s3
    ...
    1316:	853a                	mv	a0,a4
    1318:	85be                	mv	a1,a5
    131a:	70e6                	ld	ra,120(sp)
    131c:	7446                	ld	s0,112(sp)
    131e:	74a6                	ld	s1,104(sp)
    1320:	7906                	ld	s2,96(sp)
    1322:	69e6                	ld	s3,88(sp)
