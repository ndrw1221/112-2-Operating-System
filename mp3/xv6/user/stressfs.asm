...
main(int argc, char *argv[])
{
  ...
  char path[] = "stressfs0";
      ...
      1c:	14078793          	addi	a5,a5,320 # 1158 <schedule_wrr+0x18e>
      20:	6398                	ld	a4,0(a5)
  ...
  printf("stressfs starting\n");
      ...
      32:	0fa50513          	addi	a0,a0,250 # 1128 <schedule_wrr+0x15e>
  ...
  printf("write %d\n", i);
      ...
      8e:	0b650513          	addi	a0,a0,182 # 1140 <schedule_wrr+0x176>
...
//    printf(fd, "%d\n", i);
  ...
  printf("read\n");
     ...
     110:	04450513          	addi	a0,a0,68 # 1150 <schedule_wrr+0x186>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     782:	a2a68693          	addi	a3,a3,-1494 # 11a8 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     85c:	95070713          	addi	a4,a4,-1712 # 11a8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     a1c:	75078793          	addi	a5,a5,1872 # 1168 <schedule_wrr+0x19e>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     bc8:	60c78793          	addi	a5,a5,1548 # 11d0 <freep>
     bcc:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     cc0:	51478793          	addi	a5,a5,1300 # 11d0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     d42:	49278793          	addi	a5,a5,1170 # 11d0 <freep>
     d46:	639c                	ld	a5,0(a5)
}
     d48:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d74:	46078793          	addi	a5,a5,1120 # 11d0 <freep>
     d78:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d88:	43c78793          	addi	a5,a5,1084 # 11c0 <base>
     d8c:	fef43023          	sd	a5,-32(s0)
     d90:	00000797          	auipc	a5,0x0
     d94:	44078793          	addi	a5,a5,1088 # 11d0 <freep>
     d98:	fe043703          	ld	a4,-32(s0)
     d9c:	e398                	sd	a4,0(a5)
     d9e:	00000797          	auipc	a5,0x0
     da2:	43278793          	addi	a5,a5,1074 # 11d0 <freep>
     da6:	6398                	ld	a4,0(a5)
     da8:	00000797          	auipc	a5,0x0
     dac:	41878793          	addi	a5,a5,1048 # 11c0 <base>
     db0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     db2:	00000797          	auipc	a5,0x0
     db6:	40e78793          	addi	a5,a5,1038 # 11c0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     e32:	3a278793          	addi	a5,a5,930 # 11d0 <freep>
    ...
    if(p == freep)
     ...
     e48:	38c78793          	addi	a5,a5,908 # 11d0 <freep>
     e4c:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    struct thread *current_thread = NULL;
     fda:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
     fde:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
     fe2:	00000517          	auipc	a0,0x0
     fe6:	18e50513          	addi	a0,a0,398 # 1170 <schedule_wrr+0x1a6>
     fea:	00000097          	auipc	ra,0x0
     fee:	b76080e7          	jalr	-1162(ra) # b60 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
     ff2:	649c                	ld	a5,8(s1)
     ff4:	639c                	ld	a5,0(a5)
     ff6:	faf43c23          	sd	a5,-72(s0)
     ffa:	fb843783          	ld	a5,-72(s0)
     ffe:	fd878793          	addi	a5,a5,-40
    1002:	fcf43023          	sd	a5,-64(s0)
    1006:	a049                	j	1088 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    1008:	fc043783          	ld	a5,-64(s0)
    100c:	5fdc                	lw	a5,60(a5)
    100e:	85be                	mv	a1,a5
    1010:	00000517          	auipc	a0,0x0
    1014:	17050513          	addi	a0,a0,368 # 1180 <schedule_wrr+0x1b6>
    1018:	00000097          	auipc	ra,0x0
    101c:	b48080e7          	jalr	-1208(ra) # b60 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    1020:	fc043783          	ld	a5,-64(s0)
    1024:	4ff8                	lw	a4,92(a5)
    1026:	fc043783          	ld	a5,-64(s0)
    102a:	47fc                	lw	a5,76(a5)
    102c:	40f707bb          	subw	a5,a4,a5
    1030:	2781                	sext.w	a5,a5
    1032:	85be                	mv	a1,a5
    1034:	00000517          	auipc	a0,0x0
    1038:	15c50513          	addi	a0,a0,348 # 1190 <schedule_wrr+0x1c6>
    103c:	00000097          	auipc	ra,0x0
    1040:	b24080e7          	jalr	-1244(ra) # b60 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    1044:	fc843783          	ld	a5,-56(s0)
    1048:	c38d                	beqz	a5,106a <schedule_wrr+0xa0>
    104a:	fc043783          	ld	a5,-64(s0)
    104e:	4fb8                	lw	a4,88(a5)
    1050:	fc043783          	ld	a5,-64(s0)
    1054:	43fc                	lw	a5,68(a5)
    1056:	00f71e63          	bne	a4,a5,1072 <schedule_wrr+0xa8>
    105a:	fc043783          	ld	a5,-64(s0)
    105e:	5fd8                	lw	a4,60(a5)
    1060:	fc843783          	ld	a5,-56(s0)
    1064:	5fdc                	lw	a5,60(a5)
    1066:	00f75663          	bge	a4,a5,1072 <schedule_wrr+0xa8>
            current_thread = th;
    106a:	fc043783          	ld	a5,-64(s0)
    106e:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    1072:	fc043783          	ld	a5,-64(s0)
    1076:	779c                	ld	a5,40(a5)
    1078:	faf43423          	sd	a5,-88(s0)
    107c:	fa843783          	ld	a5,-88(s0)
    1080:	fd878793          	addi	a5,a5,-40
    1084:	fcf43023          	sd	a5,-64(s0)
    1088:	fc043783          	ld	a5,-64(s0)
    108c:	02878713          	addi	a4,a5,40
    1090:	649c                	ld	a5,8(s1)
    1092:	f6f71be3          	bne	a4,a5,1008 <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    1096:	40d8                	lw	a4,4(s1)
    1098:	fc843783          	ld	a5,-56(s0)
    109c:	47bc                	lw	a5,72(a5)
    109e:	02f707bb          	mulw	a5,a4,a5
    10a2:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    10a6:	fc843783          	ld	a5,-56(s0)
    10aa:	4fbc                	lw	a5,88(a5)
    10ac:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    10b0:	fc843783          	ld	a5,-56(s0)
    10b4:	c795                	beqz	a5,10e0 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    10b6:	fc843783          	ld	a5,-56(s0)
    10ba:	02878793          	addi	a5,a5,40
    10be:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    10c2:	fb442603          	lw	a2,-76(s0)
    10c6:	fb042783          	lw	a5,-80(s0)
    10ca:	0007869b          	sext.w	a3,a5
    10ce:	0006071b          	sext.w	a4,a2
    10d2:	00d75363          	bge	a4,a3,10d8 <schedule_wrr+0x10e>
    10d6:	87b2                	mv	a5,a2
    10d8:	2781                	sext.w	a5,a5
    10da:	f8f42823          	sw	a5,-112(s0)
    10de:	a039                	j	10ec <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    10e0:	649c                	ld	a5,8(s1)
    10e2:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    10e6:	4785                	li	a5,1
    10e8:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    10ec:	f8843783          	ld	a5,-120(s0)
    10f0:	f8f43c23          	sd	a5,-104(s0)
    10f4:	f9043783          	ld	a5,-112(s0)
    10f8:	faf43023          	sd	a5,-96(s0)
    10fc:	4701                	li	a4,0
    10fe:	f9843703          	ld	a4,-104(s0)
    1102:	4781                	li	a5,0
