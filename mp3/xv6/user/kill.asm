...
main(int argc, char **argv)
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "usage: kill pid...\n");
      ...
      24:	00858593          	addi	a1,a1,8 # 1028 <schedule_wrr+0x15c>
      28:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     684:	a0068693          	addi	a3,a3,-1536 # 1080 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     75e:	92670713          	addi	a4,a4,-1754 # 1080 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     91e:	72678793          	addi	a5,a5,1830 # 1040 <schedule_wrr+0x174>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     aca:	5e278793          	addi	a5,a5,1506 # 10a8 <freep>
     ace:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bc2:	4ea78793          	addi	a5,a5,1258 # 10a8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c44:	46878793          	addi	a5,a5,1128 # 10a8 <freep>
     c48:	639c                	ld	a5,0(a5)
}
     c4a:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c76:	43678793          	addi	a5,a5,1078 # 10a8 <freep>
     c7a:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c8a:	41278793          	addi	a5,a5,1042 # 1098 <base>
     c8e:	fef43023          	sd	a5,-32(s0)
     c92:	00000797          	auipc	a5,0x0
     c96:	41678793          	addi	a5,a5,1046 # 10a8 <freep>
     c9a:	fe043703          	ld	a4,-32(s0)
     c9e:	e398                	sd	a4,0(a5)
     ca0:	00000797          	auipc	a5,0x0
     ca4:	40878793          	addi	a5,a5,1032 # 10a8 <freep>
     ca8:	6398                	ld	a4,0(a5)
     caa:	00000797          	auipc	a5,0x0
     cae:	3ee78793          	addi	a5,a5,1006 # 1098 <base>
     cb2:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cb4:	00000797          	auipc	a5,0x0
     cb8:	3e478793          	addi	a5,a5,996 # 1098 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d34:	37878793          	addi	a5,a5,888 # 10a8 <freep>
    ...
    if(p == freep)
     ...
     d4a:	36278793          	addi	a5,a5,866 # 10a8 <freep>
     d4e:	639c                	ld	a5,0(a5)
...
{
     ecc:	7119                	addi	sp,sp,-128
     ece:	fc86                	sd	ra,120(sp)
     ed0:	f8a2                	sd	s0,112(sp)
     ed2:	f4a6                	sd	s1,104(sp)
     ed4:	f0ca                	sd	s2,96(sp)
     ed6:	ecce                	sd	s3,88(sp)
     ed8:	0100                	addi	s0,sp,128
     eda:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
     edc:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
     ee0:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
     ee4:	00000517          	auipc	a0,0x0
     ee8:	16450513          	addi	a0,a0,356 # 1048 <schedule_wrr+0x17c>
     eec:	00000097          	auipc	ra,0x0
     ef0:	b76080e7          	jalr	-1162(ra) # a62 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
     ef4:	649c                	ld	a5,8(s1)
     ef6:	639c                	ld	a5,0(a5)
     ef8:	faf43c23          	sd	a5,-72(s0)
     efc:	fb843783          	ld	a5,-72(s0)
     f00:	fd878793          	addi	a5,a5,-40
     f04:	fcf43023          	sd	a5,-64(s0)
     f08:	a049                	j	f8a <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
     f0a:	fc043783          	ld	a5,-64(s0)
     f0e:	5fdc                	lw	a5,60(a5)
     f10:	85be                	mv	a1,a5
     f12:	00000517          	auipc	a0,0x0
     f16:	14650513          	addi	a0,a0,326 # 1058 <schedule_wrr+0x18c>
     f1a:	00000097          	auipc	ra,0x0
     f1e:	b48080e7          	jalr	-1208(ra) # a62 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
     f22:	fc043783          	ld	a5,-64(s0)
     f26:	4ff8                	lw	a4,92(a5)
     f28:	fc043783          	ld	a5,-64(s0)
     f2c:	47fc                	lw	a5,76(a5)
     f2e:	40f707bb          	subw	a5,a4,a5
     f32:	2781                	sext.w	a5,a5
     f34:	85be                	mv	a1,a5
     f36:	00000517          	auipc	a0,0x0
     f3a:	13250513          	addi	a0,a0,306 # 1068 <schedule_wrr+0x19c>
     f3e:	00000097          	auipc	ra,0x0
     f42:	b24080e7          	jalr	-1244(ra) # a62 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
     f46:	fc843783          	ld	a5,-56(s0)
     f4a:	c38d                	beqz	a5,f6c <schedule_wrr+0xa0>
     f4c:	fc043783          	ld	a5,-64(s0)
     f50:	4fb8                	lw	a4,88(a5)
     f52:	fc043783          	ld	a5,-64(s0)
     f56:	43fc                	lw	a5,68(a5)
     f58:	00f71e63          	bne	a4,a5,f74 <schedule_wrr+0xa8>
     f5c:	fc043783          	ld	a5,-64(s0)
     f60:	5fd8                	lw	a4,60(a5)
     f62:	fc843783          	ld	a5,-56(s0)
     f66:	5fdc                	lw	a5,60(a5)
     f68:	00f75663          	bge	a4,a5,f74 <schedule_wrr+0xa8>
            current_thread = th;
     f6c:	fc043783          	ld	a5,-64(s0)
     f70:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
     f74:	fc043783          	ld	a5,-64(s0)
     f78:	779c                	ld	a5,40(a5)
     f7a:	faf43423          	sd	a5,-88(s0)
     f7e:	fa843783          	ld	a5,-88(s0)
     f82:	fd878793          	addi	a5,a5,-40
     f86:	fcf43023          	sd	a5,-64(s0)
     f8a:	fc043783          	ld	a5,-64(s0)
     f8e:	02878713          	addi	a4,a5,40
     f92:	649c                	ld	a5,8(s1)
     f94:	f6f71be3          	bne	a4,a5,f0a <schedule_wrr+0x3e>
    }
    ...
    int weighted_time = args.time_quantum * current_thread->weight;
     ...
     f9e:	47bc                	lw	a5,72(a5)
     fa0:	02f707bb          	mulw	a5,a4,a5
     fa4:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
     fa8:	fc843783          	ld	a5,-56(s0)
     fac:	4fbc                	lw	a5,88(a5)
     fae:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
     fb2:	fc843783          	ld	a5,-56(s0)
     fb6:	c795                	beqz	a5,fe2 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
     fb8:	fc843783          	ld	a5,-56(s0)
     fbc:	02878793          	addi	a5,a5,40
     fc0:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
     fc4:	fb442603          	lw	a2,-76(s0)
     fc8:	fb042783          	lw	a5,-80(s0)
     fcc:	0007869b          	sext.w	a3,a5
     fd0:	0006071b          	sext.w	a4,a2
     fd4:	00d75363          	bge	a4,a3,fda <schedule_wrr+0x10e>
     fd8:	87b2                	mv	a5,a2
     fda:	2781                	sext.w	a5,a5
     fdc:	f8f42823          	sw	a5,-112(s0)
     fe0:	a039                	j	fee <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
     fe2:	649c                	ld	a5,8(s1)
     fe4:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
     fe8:	4785                	li	a5,1
     fea:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
     fee:	f8843783          	ld	a5,-120(s0)
     ff2:	f8f43c23          	sd	a5,-104(s0)
     ff6:	f9043783          	ld	a5,-112(s0)
     ffa:	faf43023          	sd	a5,-96(s0)
     ffe:	4701                	li	a4,0
    1000:	f9843703          	ld	a4,-104(s0)
    1004:	4781                	li	a5,0
    1006:	fa043783          	ld	a5,-96(s0)
    100a:	893a                	mv	s2,a4
    100c:	89be                	mv	s3,a5
    100e:	874a                	mv	a4,s2
    1010:	87ce                	mv	a5,s3
    ...
    1012:	853a                	mv	a0,a4
    1014:	85be                	mv	a1,a5
    1016:	70e6                	ld	ra,120(sp)
    1018:	7446                	ld	s0,112(sp)
    101a:	74a6                	ld	s1,104(sp)
    101c:	7906                	ld	s2,96(sp)
    101e:	69e6                	ld	s3,88(sp)
