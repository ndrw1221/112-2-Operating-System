...
wc(int fd, char *name)
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    for(i=0; i<n; i++){
      ...
      40:	22470713          	addi	a4,a4,548 # 1260 <buf>
      ...
      64:	20070713          	addi	a4,a4,512 # 1260 <buf>
      68:	fec42783          	lw	a5,-20(s0)
      6c:	97ba                	add	a5,a5,a4
      6e:	0007c783          	lbu	a5,0(a5)
      72:	85be                	mv	a1,a5
      74:	00001517          	auipc	a0,0x1
      78:	14c50513          	addi	a0,a0,332 # 11c0 <schedule_wrr+0x15e>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
      ...
      cc:	19858593          	addi	a1,a1,408 # 1260 <buf>
      d0:	853e                	mv	a0,a5
  ...
  if(n < 0){
    ...
    printf("wc: read error\n");
      ...
      f8:	0d450513          	addi	a0,a0,212 # 11c8 <schedule_wrr+0x166>
  ...
  printf("%d %d %d %s\n", l, w, c, name);
     ...
     124:	0b850513          	addi	a0,a0,184 # 11d8 <schedule_wrr+0x176>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    wc(0, "");
     ...
     15e:	08e58593          	addi	a1,a1,142 # 11e8 <schedule_wrr+0x186>
     162:	4501                	li	a0,0
  ...
  for(i = 1; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1bc:	03850513          	addi	a0,a0,56 # 11f0 <schedule_wrr+0x18e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     81a:	a3268693          	addi	a3,a3,-1486 # 1248 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     8f4:	95870713          	addi	a4,a4,-1704 # 1248 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ab4:	75878793          	addi	a5,a5,1880 # 1208 <schedule_wrr+0x1a6>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     c60:	81478793          	addi	a5,a5,-2028 # 1470 <freep>
     c64:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     d58:	71c78793          	addi	a5,a5,1820 # 1470 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     dda:	69a78793          	addi	a5,a5,1690 # 1470 <freep>
     dde:	639c                	ld	a5,0(a5)
}
     de0:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     e0c:	66878793          	addi	a5,a5,1640 # 1470 <freep>
     e10:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     e20:	64478793          	addi	a5,a5,1604 # 1460 <base>
     e24:	fef43023          	sd	a5,-32(s0)
     e28:	00000797          	auipc	a5,0x0
     e2c:	64878793          	addi	a5,a5,1608 # 1470 <freep>
     e30:	fe043703          	ld	a4,-32(s0)
     e34:	e398                	sd	a4,0(a5)
     e36:	00000797          	auipc	a5,0x0
     e3a:	63a78793          	addi	a5,a5,1594 # 1470 <freep>
     e3e:	6398                	ld	a4,0(a5)
     e40:	00000797          	auipc	a5,0x0
     e44:	62078793          	addi	a5,a5,1568 # 1460 <base>
     e48:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     e4a:	00000797          	auipc	a5,0x0
     e4e:	61678793          	addi	a5,a5,1558 # 1460 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     eca:	5aa78793          	addi	a5,a5,1450 # 1470 <freep>
    ...
    if(p == freep)
     ...
     ee0:	59478793          	addi	a5,a5,1428 # 1470 <freep>
     ee4:	639c                	ld	a5,0(a5)
...
{
    1062:	7119                	addi	sp,sp,-128
    1064:	fc86                	sd	ra,120(sp)
    1066:	f8a2                	sd	s0,112(sp)
    1068:	f4a6                	sd	s1,104(sp)
    106a:	f0ca                	sd	s2,96(sp)
    106c:	ecce                	sd	s3,88(sp)
    106e:	0100                	addi	s0,sp,128
    1070:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    1072:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1076:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    107a:	00000517          	auipc	a0,0x0
    107e:	19650513          	addi	a0,a0,406 # 1210 <schedule_wrr+0x1ae>
    1082:	00000097          	auipc	ra,0x0
    1086:	b76080e7          	jalr	-1162(ra) # bf8 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    108a:	649c                	ld	a5,8(s1)
    108c:	639c                	ld	a5,0(a5)
    108e:	faf43c23          	sd	a5,-72(s0)
    1092:	fb843783          	ld	a5,-72(s0)
    1096:	fd878793          	addi	a5,a5,-40
    109a:	fcf43023          	sd	a5,-64(s0)
    109e:	a049                	j	1120 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    10a0:	fc043783          	ld	a5,-64(s0)
    10a4:	5fdc                	lw	a5,60(a5)
    10a6:	85be                	mv	a1,a5
    10a8:	00000517          	auipc	a0,0x0
    10ac:	17850513          	addi	a0,a0,376 # 1220 <schedule_wrr+0x1be>
    10b0:	00000097          	auipc	ra,0x0
    10b4:	b48080e7          	jalr	-1208(ra) # bf8 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    10b8:	fc043783          	ld	a5,-64(s0)
    10bc:	4ff8                	lw	a4,92(a5)
    10be:	fc043783          	ld	a5,-64(s0)
    10c2:	47fc                	lw	a5,76(a5)
    10c4:	40f707bb          	subw	a5,a4,a5
    10c8:	2781                	sext.w	a5,a5
    10ca:	85be                	mv	a1,a5
    10cc:	00000517          	auipc	a0,0x0
    10d0:	16450513          	addi	a0,a0,356 # 1230 <schedule_wrr+0x1ce>
    10d4:	00000097          	auipc	ra,0x0
    10d8:	b24080e7          	jalr	-1244(ra) # bf8 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    10dc:	fc843783          	ld	a5,-56(s0)
    10e0:	c38d                	beqz	a5,1102 <schedule_wrr+0xa0>
    10e2:	fc043783          	ld	a5,-64(s0)
    10e6:	4fb8                	lw	a4,88(a5)
    10e8:	fc043783          	ld	a5,-64(s0)
    10ec:	43fc                	lw	a5,68(a5)
    10ee:	00f71e63          	bne	a4,a5,110a <schedule_wrr+0xa8>
    10f2:	fc043783          	ld	a5,-64(s0)
    10f6:	5fd8                	lw	a4,60(a5)
    10f8:	fc843783          	ld	a5,-56(s0)
    10fc:	5fdc                	lw	a5,60(a5)
    10fe:	00f75663          	bge	a4,a5,110a <schedule_wrr+0xa8>
            current_thread = th;
    1102:	fc043783          	ld	a5,-64(s0)
    1106:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    110a:	fc043783          	ld	a5,-64(s0)
    110e:	779c                	ld	a5,40(a5)
    1110:	faf43423          	sd	a5,-88(s0)
    1114:	fa843783          	ld	a5,-88(s0)
    1118:	fd878793          	addi	a5,a5,-40
    111c:	fcf43023          	sd	a5,-64(s0)
    1120:	fc043783          	ld	a5,-64(s0)
    1124:	02878713          	addi	a4,a5,40
    1128:	649c                	ld	a5,8(s1)
    112a:	f6f71be3          	bne	a4,a5,10a0 <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    112e:	40d8                	lw	a4,4(s1)
    1130:	fc843783          	ld	a5,-56(s0)
    1134:	47bc                	lw	a5,72(a5)
    1136:	02f707bb          	mulw	a5,a4,a5
    113a:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    113e:	fc843783          	ld	a5,-56(s0)
    1142:	4fbc                	lw	a5,88(a5)
    1144:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    1148:	fc843783          	ld	a5,-56(s0)
    114c:	c795                	beqz	a5,1178 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    114e:	fc843783          	ld	a5,-56(s0)
    1152:	02878793          	addi	a5,a5,40
    1156:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    115a:	fb442603          	lw	a2,-76(s0)
    115e:	fb042783          	lw	a5,-80(s0)
    1162:	0007869b          	sext.w	a3,a5
    1166:	0006071b          	sext.w	a4,a2
    116a:	00d75363          	bge	a4,a3,1170 <schedule_wrr+0x10e>
    116e:	87b2                	mv	a5,a2
    1170:	2781                	sext.w	a5,a5
    1172:	f8f42823          	sw	a5,-112(s0)
    1176:	a039                	j	1184 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    1178:	649c                	ld	a5,8(s1)
    117a:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    117e:	4785                	li	a5,1
    1180:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    1184:	f8843783          	ld	a5,-120(s0)
    1188:	f8f43c23          	sd	a5,-104(s0)
    118c:	f9043783          	ld	a5,-112(s0)
    1190:	faf43023          	sd	a5,-96(s0)
    1194:	4701                	li	a4,0
    1196:	f9843703          	ld	a4,-104(s0)
    119a:	4781                	li	a5,0
    ...
    11a8:	853a                	mv	a0,a4
    11aa:	85be                	mv	a1,a5
    11ac:	70e6                	ld	ra,120(sp)
    11ae:	7446                	ld	s0,112(sp)
    11b0:	74a6                	ld	s1,104(sp)
    11b2:	7906                	ld	s2,96(sp)
    11b4:	69e6                	ld	s3,88(sp)
