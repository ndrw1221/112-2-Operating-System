...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66e:	96e68693          	addi	a3,a3,-1682 # fd8 <digits>
...
printptr(int fd, uint64 x) {
 ...
 748:	89470713          	addi	a4,a4,-1900 # fd8 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 908:	69478793          	addi	a5,a5,1684 # f98 <schedule_wrr+0x158>
...
free(void *ap)
{
 ...
 ab4:	55078793          	addi	a5,a5,1360 # 1000 <freep>
 ab8:	639c                	ld	a5,0(a5)
 ...
 bac:	45878793          	addi	a5,a5,1112 # 1000 <freep>
...
morecore(uint nu)
{
 ...
 c2e:	3d678793          	addi	a5,a5,982 # 1000 <freep>
 c32:	639c                	ld	a5,0(a5)
}
 c34:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
 ...
 c60:	3a478793          	addi	a5,a5,932 # 1000 <freep>
 c64:	639c                	ld	a5,0(a5)
 ...
 c74:	38078793          	addi	a5,a5,896 # ff0 <base>
 c78:	fef43023          	sd	a5,-32(s0)
 c7c:	00000797          	auipc	a5,0x0
 c80:	38478793          	addi	a5,a5,900 # 1000 <freep>
 c84:	fe043703          	ld	a4,-32(s0)
 c88:	e398                	sd	a4,0(a5)
 c8a:	00000797          	auipc	a5,0x0
 c8e:	37678793          	addi	a5,a5,886 # 1000 <freep>
 c92:	6398                	ld	a4,0(a5)
 c94:	00000797          	auipc	a5,0x0
 c98:	35c78793          	addi	a5,a5,860 # ff0 <base>
 c9c:	e398                	sd	a4,0(a5)
    base.s.size = 0;
 c9e:	00000797          	auipc	a5,0x0
 ca2:	35278793          	addi	a5,a5,850 # ff0 <base>
 ...
 d1e:	2e678793          	addi	a5,a5,742 # 1000 <freep>
 ...
 d34:	2d078793          	addi	a5,a5,720 # 1000 <freep>
 d38:	639c                	ld	a5,0(a5)
...
{
 e40:	7119                	addi	sp,sp,-128
 e42:	fc86                	sd	ra,120(sp)
 e44:	f8a2                	sd	s0,112(sp)
 e46:	f4a6                	sd	s1,104(sp)
 e48:	f0ca                	sd	s2,96(sp)
 e4a:	ecce                	sd	s3,88(sp)
 e4c:	0100                	addi	s0,sp,128
 e4e:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
 e50:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
 e54:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
 e58:	00000517          	auipc	a0,0x0
 e5c:	14850513          	addi	a0,a0,328 # fa0 <schedule_wrr+0x160>
 e60:	00000097          	auipc	ra,0x0
 e64:	bec080e7          	jalr	-1044(ra) # a4c <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
 e68:	649c                	ld	a5,8(s1)
 e6a:	639c                	ld	a5,0(a5)
 e6c:	faf43c23          	sd	a5,-72(s0)
 e70:	fb843783          	ld	a5,-72(s0)
 e74:	fd878793          	addi	a5,a5,-40
 e78:	fcf43023          	sd	a5,-64(s0)
 e7c:	a049                	j	efe <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
 e7e:	fc043783          	ld	a5,-64(s0)
 e82:	5fdc                	lw	a5,60(a5)
 e84:	85be                	mv	a1,a5
 e86:	00000517          	auipc	a0,0x0
 e8a:	12a50513          	addi	a0,a0,298 # fb0 <schedule_wrr+0x170>
 e8e:	00000097          	auipc	ra,0x0
 e92:	bbe080e7          	jalr	-1090(ra) # a4c <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
 e96:	fc043783          	ld	a5,-64(s0)
 e9a:	4ff8                	lw	a4,92(a5)
 e9c:	fc043783          	ld	a5,-64(s0)
 ea0:	47fc                	lw	a5,76(a5)
 ea2:	40f707bb          	subw	a5,a4,a5
 ea6:	2781                	sext.w	a5,a5
 ea8:	85be                	mv	a1,a5
 eaa:	00000517          	auipc	a0,0x0
 eae:	11650513          	addi	a0,a0,278 # fc0 <schedule_wrr+0x180>
 eb2:	00000097          	auipc	ra,0x0
 eb6:	b9a080e7          	jalr	-1126(ra) # a4c <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
 eba:	fc843783          	ld	a5,-56(s0)
 ebe:	c38d                	beqz	a5,ee0 <schedule_wrr+0xa0>
 ec0:	fc043783          	ld	a5,-64(s0)
 ec4:	4fb8                	lw	a4,88(a5)
 ec6:	fc043783          	ld	a5,-64(s0)
 eca:	43fc                	lw	a5,68(a5)
 ecc:	00f71e63          	bne	a4,a5,ee8 <schedule_wrr+0xa8>
 ed0:	fc043783          	ld	a5,-64(s0)
 ed4:	5fd8                	lw	a4,60(a5)
 ed6:	fc843783          	ld	a5,-56(s0)
 eda:	5fdc                	lw	a5,60(a5)
 edc:	00f75663          	bge	a4,a5,ee8 <schedule_wrr+0xa8>
            current_thread = th;
 ee0:	fc043783          	ld	a5,-64(s0)
 ee4:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
 ee8:	fc043783          	ld	a5,-64(s0)
 eec:	779c                	ld	a5,40(a5)
 eee:	faf43423          	sd	a5,-88(s0)
 ef2:	fa843783          	ld	a5,-88(s0)
 ef6:	fd878793          	addi	a5,a5,-40
 efa:	fcf43023          	sd	a5,-64(s0)
 efe:	fc043783          	ld	a5,-64(s0)
 f02:	02878713          	addi	a4,a5,40
 f06:	649c                	ld	a5,8(s1)
 f08:	f6f71be3          	bne	a4,a5,e7e <schedule_wrr+0x3e>
    }
 ...
 f0c:	40d8                	lw	a4,4(s1)
 f0e:	fc843783          	ld	a5,-56(s0)
 f12:	47bc                	lw	a5,72(a5)
 f14:	02f707bb          	mulw	a5,a4,a5
 f18:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
 f1c:	fc843783          	ld	a5,-56(s0)
 f20:	4fbc                	lw	a5,88(a5)
 f22:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
 f26:	fc843783          	ld	a5,-56(s0)
 f2a:	c795                	beqz	a5,f56 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
 f2c:	fc843783          	ld	a5,-56(s0)
 f30:	02878793          	addi	a5,a5,40
 f34:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
 f38:	fb442603          	lw	a2,-76(s0)
 f3c:	fb042783          	lw	a5,-80(s0)
 f40:	0007869b          	sext.w	a3,a5
 f44:	0006071b          	sext.w	a4,a2
 f48:	00d75363          	bge	a4,a3,f4e <schedule_wrr+0x10e>
 f4c:	87b2                	mv	a5,a2
 f4e:	2781                	sext.w	a5,a5
 f50:	f8f42823          	sw	a5,-112(s0)
 f54:	a039                	j	f62 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
 f56:	649c                	ld	a5,8(s1)
 f58:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
 f5c:	4785                	li	a5,1
 f5e:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
 f62:	f8843783          	ld	a5,-120(s0)
 f66:	f8f43c23          	sd	a5,-104(s0)
 f6a:	f9043783          	ld	a5,-112(s0)
 f6e:	faf43023          	sd	a5,-96(s0)
 f72:	4701                	li	a4,0
 f74:	f9843703          	ld	a4,-104(s0)
 f78:	4781                	li	a5,0
 f7a:	fa043783          	ld	a5,-96(s0)
 f7e:	893a                	mv	s2,a4
 f80:	89be                	mv	s3,a5
 f82:	874a                	mv	a4,s2
 f84:	87ce                	mv	a5,s3
 ...
 f86:	853a                	mv	a0,a4
 f88:	85be                	mv	a1,a5
 f8a:	70e6                	ld	ra,120(sp)
 f8c:	7446                	ld	s0,112(sp)
 f8e:	74a6                	ld	s1,104(sp)
 f90:	7906                	ld	s2,96(sp)
 f92:	69e6                	ld	s3,88(sp)
 f94:	6109                	addi	sp,sp,128
 f96:	8082                	ret
