...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    if(i + 1 < argc){
      ...
      70:	fe458593          	addi	a1,a1,-28 # 1050 <schedule_wrr+0x158>
      74:	4505                	li	a0,1
      ...
      86:	fd658593          	addi	a1,a1,-42 # 1058 <schedule_wrr+0x160>
      8a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6b0:	9f468693          	addi	a3,a3,-1548 # 10a0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     78a:	91a70713          	addi	a4,a4,-1766 # 10a0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     94a:	71a78793          	addi	a5,a5,1818 # 1060 <schedule_wrr+0x168>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     af6:	5d678793          	addi	a5,a5,1494 # 10c8 <freep>
     afa:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bee:	4de78793          	addi	a5,a5,1246 # 10c8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c70:	45c78793          	addi	a5,a5,1116 # 10c8 <freep>
     c74:	639c                	ld	a5,0(a5)
}
     c76:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     ca2:	42a78793          	addi	a5,a5,1066 # 10c8 <freep>
     ca6:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     cb6:	40678793          	addi	a5,a5,1030 # 10b8 <base>
     cba:	fef43023          	sd	a5,-32(s0)
     cbe:	00000797          	auipc	a5,0x0
     cc2:	40a78793          	addi	a5,a5,1034 # 10c8 <freep>
     cc6:	fe043703          	ld	a4,-32(s0)
     cca:	e398                	sd	a4,0(a5)
     ccc:	00000797          	auipc	a5,0x0
     cd0:	3fc78793          	addi	a5,a5,1020 # 10c8 <freep>
     cd4:	6398                	ld	a4,0(a5)
     cd6:	00000797          	auipc	a5,0x0
     cda:	3e278793          	addi	a5,a5,994 # 10b8 <base>
     cde:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     ce0:	00000797          	auipc	a5,0x0
     ce4:	3d878793          	addi	a5,a5,984 # 10b8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d60:	36c78793          	addi	a5,a5,876 # 10c8 <freep>
    ...
    if(p == freep)
     ...
     d76:	35678793          	addi	a5,a5,854 # 10c8 <freep>
     d7a:	639c                	ld	a5,0(a5)
...
{
     ef8:	7119                	addi	sp,sp,-128
     efa:	fc86                	sd	ra,120(sp)
     efc:	f8a2                	sd	s0,112(sp)
     efe:	f4a6                	sd	s1,104(sp)
     f00:	f0ca                	sd	s2,96(sp)
     f02:	ecce                	sd	s3,88(sp)
     f04:	0100                	addi	s0,sp,128
     f06:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
     f08:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
     f0c:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
     f10:	00000517          	auipc	a0,0x0
     f14:	15850513          	addi	a0,a0,344 # 1068 <schedule_wrr+0x170>
     f18:	00000097          	auipc	ra,0x0
     f1c:	b76080e7          	jalr	-1162(ra) # a8e <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
     f20:	649c                	ld	a5,8(s1)
     f22:	639c                	ld	a5,0(a5)
     f24:	faf43c23          	sd	a5,-72(s0)
     f28:	fb843783          	ld	a5,-72(s0)
     f2c:	fd878793          	addi	a5,a5,-40
     f30:	fcf43023          	sd	a5,-64(s0)
     f34:	a049                	j	fb6 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
     f36:	fc043783          	ld	a5,-64(s0)
     f3a:	5fdc                	lw	a5,60(a5)
     f3c:	85be                	mv	a1,a5
     f3e:	00000517          	auipc	a0,0x0
     f42:	13a50513          	addi	a0,a0,314 # 1078 <schedule_wrr+0x180>
     f46:	00000097          	auipc	ra,0x0
     f4a:	b48080e7          	jalr	-1208(ra) # a8e <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
     f4e:	fc043783          	ld	a5,-64(s0)
     f52:	4ff8                	lw	a4,92(a5)
     f54:	fc043783          	ld	a5,-64(s0)
     f58:	47fc                	lw	a5,76(a5)
     f5a:	40f707bb          	subw	a5,a4,a5
     f5e:	2781                	sext.w	a5,a5
     f60:	85be                	mv	a1,a5
     f62:	00000517          	auipc	a0,0x0
     f66:	12650513          	addi	a0,a0,294 # 1088 <schedule_wrr+0x190>
     f6a:	00000097          	auipc	ra,0x0
     f6e:	b24080e7          	jalr	-1244(ra) # a8e <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
     f72:	fc843783          	ld	a5,-56(s0)
     f76:	c38d                	beqz	a5,f98 <schedule_wrr+0xa0>
     f78:	fc043783          	ld	a5,-64(s0)
     f7c:	4fb8                	lw	a4,88(a5)
     f7e:	fc043783          	ld	a5,-64(s0)
     f82:	43fc                	lw	a5,68(a5)
     f84:	00f71e63          	bne	a4,a5,fa0 <schedule_wrr+0xa8>
     f88:	fc043783          	ld	a5,-64(s0)
     f8c:	5fd8                	lw	a4,60(a5)
     f8e:	fc843783          	ld	a5,-56(s0)
     f92:	5fdc                	lw	a5,60(a5)
     f94:	00f75663          	bge	a4,a5,fa0 <schedule_wrr+0xa8>
            current_thread = th;
     f98:	fc043783          	ld	a5,-64(s0)
     f9c:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
     fa0:	fc043783          	ld	a5,-64(s0)
     fa4:	779c                	ld	a5,40(a5)
     fa6:	faf43423          	sd	a5,-88(s0)
     faa:	fa843783          	ld	a5,-88(s0)
     fae:	fd878793          	addi	a5,a5,-40
     fb2:	fcf43023          	sd	a5,-64(s0)
     fb6:	fc043783          	ld	a5,-64(s0)
     fba:	02878713          	addi	a4,a5,40
     fbe:	649c                	ld	a5,8(s1)
     fc0:	f6f71be3          	bne	a4,a5,f36 <schedule_wrr+0x3e>
    }
    ...
    int weighted_time = args.time_quantum * current_thread->weight;
     ...
     fcc:	02f707bb          	mulw	a5,a4,a5
     fd0:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
     fd4:	fc843783          	ld	a5,-56(s0)
     fd8:	4fbc                	lw	a5,88(a5)
     fda:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
     fde:	fc843783          	ld	a5,-56(s0)
     fe2:	c795                	beqz	a5,100e <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
     fe4:	fc843783          	ld	a5,-56(s0)
     fe8:	02878793          	addi	a5,a5,40
     fec:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
     ff0:	fb442603          	lw	a2,-76(s0)
     ff4:	fb042783          	lw	a5,-80(s0)
     ff8:	0007869b          	sext.w	a3,a5
     ffc:	0006071b          	sext.w	a4,a2
    1000:	00d75363          	bge	a4,a3,1006 <schedule_wrr+0x10e>
    1004:	87b2                	mv	a5,a2
    1006:	2781                	sext.w	a5,a5
    1008:	f8f42823          	sw	a5,-112(s0)
    100c:	a039                	j	101a <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    100e:	649c                	ld	a5,8(s1)
    1010:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    1014:	4785                	li	a5,1
    1016:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    101a:	f8843783          	ld	a5,-120(s0)
    101e:	f8f43c23          	sd	a5,-104(s0)
    1022:	f9043783          	ld	a5,-112(s0)
    1026:	faf43023          	sd	a5,-96(s0)
    102a:	4701                	li	a4,0
    102c:	f9843703          	ld	a4,-104(s0)
    1030:	4781                	li	a5,0
    1032:	fa043783          	ld	a5,-96(s0)
    1036:	893a                	mv	s2,a4
    1038:	89be                	mv	s3,a5
    103a:	874a                	mv	a4,s2
    103c:	87ce                	mv	a5,s3
    ...
    103e:	853a                	mv	a0,a4
    1040:	85be                	mv	a1,a5
    1042:	70e6                	ld	ra,120(sp)
    1044:	7446                	ld	s0,112(sp)
    1046:	74a6                	ld	s1,104(sp)
    1048:	7906                	ld	s2,96(sp)
    104a:	69e6                	ld	s3,88(sp)
