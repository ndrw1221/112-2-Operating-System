...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    if(m > 0){
      ...
      c6:	37e78793          	addi	a5,a5,894 # 1440 <buf>
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    fprintf(2, "usage: grep pattern [file ...]\n");
     ...
     168:	24c58593          	addi	a1,a1,588 # 13b0 <schedule_wrr+0x158>
     16c:	4509                	li	a0,2
  ...
  for(i = 2; i < argc; i++){
    ...
    if((fd = open(argv[i], 0)) < 0){
     ...
     1f6:	1de50513          	addi	a0,a0,478 # 13d0 <schedule_wrr+0x178>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     a10:	a1c68693          	addi	a3,a3,-1508 # 1428 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     aea:	94270713          	addi	a4,a4,-1726 # 1428 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     caa:	74278793          	addi	a5,a5,1858 # 13e8 <schedule_wrr+0x190>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     e56:	9fe78793          	addi	a5,a5,-1538 # 1850 <freep>
     e5a:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     f4e:	90678793          	addi	a5,a5,-1786 # 1850 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     fd0:	88478793          	addi	a5,a5,-1916 # 1850 <freep>
     fd4:	639c                	ld	a5,0(a5)
}
     fd6:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1002:	85278793          	addi	a5,a5,-1966 # 1850 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    10c0:	79478793          	addi	a5,a5,1940 # 1850 <freep>
    ...
    10d6:	77e78793          	addi	a5,a5,1918 # 1850 <freep>
...
{
    1258:	7119                	addi	sp,sp,-128
    125a:	fc86                	sd	ra,120(sp)
    125c:	f8a2                	sd	s0,112(sp)
    125e:	f4a6                	sd	s1,104(sp)
    1260:	f0ca                	sd	s2,96(sp)
    1262:	ecce                	sd	s3,88(sp)
    1264:	0100                	addi	s0,sp,128
    1266:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    1268:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    126c:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    1270:	00000517          	auipc	a0,0x0
    1274:	18050513          	addi	a0,a0,384 # 13f0 <schedule_wrr+0x198>
    1278:	00000097          	auipc	ra,0x0
    127c:	b76080e7          	jalr	-1162(ra) # dee <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    1280:	649c                	ld	a5,8(s1)
    1282:	639c                	ld	a5,0(a5)
    1284:	faf43c23          	sd	a5,-72(s0)
    1288:	fb843783          	ld	a5,-72(s0)
    128c:	fd878793          	addi	a5,a5,-40
    1290:	fcf43023          	sd	a5,-64(s0)
    1294:	a049                	j	1316 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    1296:	fc043783          	ld	a5,-64(s0)
    129a:	5fdc                	lw	a5,60(a5)
    129c:	85be                	mv	a1,a5
    129e:	00000517          	auipc	a0,0x0
    12a2:	16250513          	addi	a0,a0,354 # 1400 <schedule_wrr+0x1a8>
    12a6:	00000097          	auipc	ra,0x0
    12aa:	b48080e7          	jalr	-1208(ra) # dee <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    12ae:	fc043783          	ld	a5,-64(s0)
    12b2:	4ff8                	lw	a4,92(a5)
    12b4:	fc043783          	ld	a5,-64(s0)
    12b8:	47fc                	lw	a5,76(a5)
    12ba:	40f707bb          	subw	a5,a4,a5
    12be:	2781                	sext.w	a5,a5
    12c0:	85be                	mv	a1,a5
    12c2:	00000517          	auipc	a0,0x0
    12c6:	14e50513          	addi	a0,a0,334 # 1410 <schedule_wrr+0x1b8>
    12ca:	00000097          	auipc	ra,0x0
    12ce:	b24080e7          	jalr	-1244(ra) # dee <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    12d2:	fc843783          	ld	a5,-56(s0)
    12d6:	c38d                	beqz	a5,12f8 <schedule_wrr+0xa0>
    12d8:	fc043783          	ld	a5,-64(s0)
    12dc:	4fb8                	lw	a4,88(a5)
    12de:	fc043783          	ld	a5,-64(s0)
    12e2:	43fc                	lw	a5,68(a5)
    12e4:	00f71e63          	bne	a4,a5,1300 <schedule_wrr+0xa8>
    12e8:	fc043783          	ld	a5,-64(s0)
    12ec:	5fd8                	lw	a4,60(a5)
    12ee:	fc843783          	ld	a5,-56(s0)
    12f2:	5fdc                	lw	a5,60(a5)
    12f4:	00f75663          	bge	a4,a5,1300 <schedule_wrr+0xa8>
            current_thread = th;
    12f8:	fc043783          	ld	a5,-64(s0)
    12fc:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    1300:	fc043783          	ld	a5,-64(s0)
    1304:	779c                	ld	a5,40(a5)
    1306:	faf43423          	sd	a5,-88(s0)
    130a:	fa843783          	ld	a5,-88(s0)
    130e:	fd878793          	addi	a5,a5,-40
    1312:	fcf43023          	sd	a5,-64(s0)
    1316:	fc043783          	ld	a5,-64(s0)
    131a:	02878713          	addi	a4,a5,40
    131e:	649c                	ld	a5,8(s1)
    1320:	f6f71be3          	bne	a4,a5,1296 <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    1324:	40d8                	lw	a4,4(s1)
    1326:	fc843783          	ld	a5,-56(s0)
    132a:	47bc                	lw	a5,72(a5)
    132c:	02f707bb          	mulw	a5,a4,a5
    1330:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    1334:	fc843783          	ld	a5,-56(s0)
    1338:	4fbc                	lw	a5,88(a5)
    133a:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    133e:	fc843783          	ld	a5,-56(s0)
    1342:	c795                	beqz	a5,136e <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    1344:	fc843783          	ld	a5,-56(s0)
    1348:	02878793          	addi	a5,a5,40
    134c:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    1350:	fb442603          	lw	a2,-76(s0)
    1354:	fb042783          	lw	a5,-80(s0)
    1358:	0007869b          	sext.w	a3,a5
    135c:	0006071b          	sext.w	a4,a2
    1360:	00d75363          	bge	a4,a3,1366 <schedule_wrr+0x10e>
    1364:	87b2                	mv	a5,a2
    1366:	2781                	sext.w	a5,a5
    1368:	f8f42823          	sw	a5,-112(s0)
    136c:	a039                	j	137a <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    136e:	649c                	ld	a5,8(s1)
    1370:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    1374:	4785                	li	a5,1
    1376:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    137a:	f8843783          	ld	a5,-120(s0)
    137e:	f8f43c23          	sd	a5,-104(s0)
    1382:	f9043783          	ld	a5,-112(s0)
    1386:	faf43023          	sd	a5,-96(s0)
    138a:	4701                	li	a4,0
    138c:	f9843703          	ld	a4,-104(s0)
    1390:	4781                	li	a5,0
    1392:	fa043783          	ld	a5,-96(s0)
    1396:	893a                	mv	s2,a4
    1398:	89be                	mv	s3,a5
    139a:	874a                	mv	a4,s2
    139c:	87ce                	mv	a5,s3
    ...
    139e:	853a                	mv	a0,a4
    13a0:	85be                	mv	a1,a5
    13a2:	70e6                	ld	ra,120(sp)
    13a4:	7446                	ld	s0,112(sp)
    13a6:	74a6                	ld	s1,104(sp)
    13a8:	7906                	ld	s2,96(sp)
    13aa:	69e6                	ld	s3,88(sp)
    13ac:	6109                	addi	sp,sp,128
    13ae:	8082                	ret
