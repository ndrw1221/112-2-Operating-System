 ...
 */
    ...
    hi = x / 127773;
      ...
      26:	67fd                	lui	a5,0x1f
      28:	31d78793          	addi	a5,a5,797 # 1f31d <__global_pointer$+0x1c98d>
      2c:	02f747b3          	div	a5,a4,a5
      30:	fef43023          	sd	a5,-32(s0)
    lo = x % 127773;
      34:	fe843703          	ld	a4,-24(s0)
      38:	67fd                	lui	a5,0x1f
      3a:	31d78793          	addi	a5,a5,797 # 1f31d <__global_pointer$+0x1c98d>
      3e:	02f767b3          	rem	a5,a4,a5
      42:	fcf43c23          	sd	a5,-40(s0)
    x = 16807 * lo - 2836 * hi;
      46:	fd843703          	ld	a4,-40(s0)
      4a:	6791                	lui	a5,0x4
      4c:	1a778793          	addi	a5,a5,423 # 41a7 <__global_pointer$+0x1817>
      50:	02f70733          	mul	a4,a4,a5
      54:	fe043683          	ld	a3,-32(s0)
      58:	77fd                	lui	a5,0xfffff
      5a:	4ec78793          	addi	a5,a5,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffcb5c>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      b0:	0fc50513          	addi	a0,a0,252 # 21a8 <rand_next>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      f2:	d6a50513          	addi	a0,a0,-662 # 1e58 <schedule_wrr+0x15a>
      f6:	00001097          	auipc	ra,0x1
      fa:	2c0080e7          	jalr	704(ra) # 13b6 <mkdir>
  if(chdir("grindir") != 0){
      fe:	00002517          	auipc	a0,0x2
     102:	d5a50513          	addi	a0,a0,-678 # 1e58 <schedule_wrr+0x15a>
    ...
    printf("grind: chdir grindir failed\n");
     ...
     116:	d4e50513          	addi	a0,a0,-690 # 1e60 <schedule_wrr+0x162>
  ...
  chdir("/");
     ...
     130:	d5450513          	addi	a0,a0,-684 # 1e80 <schedule_wrr+0x182>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
     ...
     160:	d2c78793          	addi	a5,a5,-724 # 1e88 <schedule_wrr+0x18a>
     164:	a029                	j	16e <go+0xa6>
     166:	00002797          	auipc	a5,0x2
     16a:	d2a78793          	addi	a5,a5,-726 # 1e90 <schedule_wrr+0x192>
     16e:	4605                	li	a2,1
     170:	85be                	mv	a1,a5
     172:	4505                	li	a0,1
    ...
    if(what == 1){
     ...
     1a8:	cf450513          	addi	a0,a0,-780 # 1e98 <schedule_wrr+0x19a>
     ...
     1d8:	cd450513          	addi	a0,a0,-812 # 1ea8 <schedule_wrr+0x1aa>
     ...
     204:	c9850513          	addi	a0,a0,-872 # 1e98 <schedule_wrr+0x19a>
     ...
     224:	c3850513          	addi	a0,a0,-968 # 1e58 <schedule_wrr+0x15a>
     ...
     238:	c2c50513          	addi	a0,a0,-980 # 1e60 <schedule_wrr+0x162>
     ...
     252:	c7250513          	addi	a0,a0,-910 # 1ec0 <schedule_wrr+0x1c2>
     256:	00001097          	auipc	ra,0x1
     25a:	148080e7          	jalr	328(ra) # 139e <unlink>
      chdir("/");
     25e:	00002517          	auipc	a0,0x2
     262:	c2250513          	addi	a0,a0,-990 # 1e80 <schedule_wrr+0x182>
     ...
     294:	c3850513          	addi	a0,a0,-968 # 1ec8 <schedule_wrr+0x1ca>
     ...
     2cc:	c1050513          	addi	a0,a0,-1008 # 1ed8 <schedule_wrr+0x1da>
     ...
     2fa:	eba58593          	addi	a1,a1,-326 # 21b0 <buf.1242>
     2fe:	853e                	mv	a0,a5
     ...
     324:	e9058593          	addi	a1,a1,-368 # 21b0 <buf.1242>
     328:	853e                	mv	a0,a5
     ...
     376:	b8e50513          	addi	a0,a0,-1138 # 1f00 <schedule_wrr+0x202>
     ...
     396:	b7650513          	addi	a0,a0,-1162 # 1f08 <schedule_wrr+0x20a>
     39a:	00001097          	auipc	ra,0x1
     39e:	01c080e7          	jalr	28(ra) # 13b6 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     3a2:	20200593          	li	a1,514
     3a6:	00002517          	auipc	a0,0x2
     3aa:	b6a50513          	addi	a0,a0,-1174 # 1f10 <schedule_wrr+0x212>
     ...
     3c6:	b5e50513          	addi	a0,a0,-1186 # 1f20 <schedule_wrr+0x222>
     ...
     3e6:	b4650513          	addi	a0,a0,-1210 # 1f28 <schedule_wrr+0x22a>
     3ea:	00001097          	auipc	ra,0x1
     3ee:	fb4080e7          	jalr	-76(ra) # 139e <unlink>
      link("../grindir/./../a", "../b");
     3f2:	00002597          	auipc	a1,0x2
     3f6:	ace58593          	addi	a1,a1,-1330 # 1ec0 <schedule_wrr+0x1c2>
     3fa:	00002517          	auipc	a0,0x2
     3fe:	b3650513          	addi	a0,a0,-1226 # 1f30 <schedule_wrr+0x232>
     ...
     41e:	b2e50513          	addi	a0,a0,-1234 # 1f48 <schedule_wrr+0x24a>
     422:	00001097          	auipc	ra,0x1
     426:	f7c080e7          	jalr	-132(ra) # 139e <unlink>
      link(".././b", "/grindir/../a");
     42a:	00002597          	auipc	a1,0x2
     42e:	a9e58593          	addi	a1,a1,-1378 # 1ec8 <schedule_wrr+0x1ca>
     432:	00002517          	auipc	a0,0x2
     436:	b2650513          	addi	a0,a0,-1242 # 1f58 <schedule_wrr+0x25a>
     ...
     480:	ae450513          	addi	a0,a0,-1308 # 1f60 <schedule_wrr+0x262>
     ...
     4ee:	a7650513          	addi	a0,a0,-1418 # 1f60 <schedule_wrr+0x262>
     ...
     59c:	9e050513          	addi	a0,a0,-1568 # 1f78 <schedule_wrr+0x27a>
     ...
     5cc:	99850513          	addi	a0,a0,-1640 # 1f60 <schedule_wrr+0x262>
     ...
     5e6:	99e50513          	addi	a0,a0,-1634 # 1f80 <schedule_wrr+0x282>
     ...
     5fa:	99a50513          	addi	a0,a0,-1638 # 1f90 <schedule_wrr+0x292>
     ...
     67a:	8ea50513          	addi	a0,a0,-1814 # 1f60 <schedule_wrr+0x262>
     ...
     6c2:	8ea50513          	addi	a0,a0,-1814 # 1fa8 <schedule_wrr+0x2aa>
     ...
     708:	8bc58593          	addi	a1,a1,-1860 # 1fc0 <schedule_wrr+0x2c2>
     70c:	853e                	mv	a0,a5
     ...
     724:	8a850513          	addi	a0,a0,-1880 # 1fc8 <schedule_wrr+0x2ca>
     ...
     754:	89850513          	addi	a0,a0,-1896 # 1fe8 <schedule_wrr+0x2ea>
     ...
     778:	7ec50513          	addi	a0,a0,2028 # 1f60 <schedule_wrr+0x262>
     ...
     838:	78c50513          	addi	a0,a0,1932 # 1fc0 <schedule_wrr+0x2c2>
     ...
     85c:	70850513          	addi	a0,a0,1800 # 1f60 <schedule_wrr+0x262>
     ...
     890:	78450513          	addi	a0,a0,1924 # 2010 <schedule_wrr+0x312>
     ...
     8a4:	77050513          	addi	a0,a0,1904 # 2010 <schedule_wrr+0x312>
     ...
     8c4:	75850513          	addi	a0,a0,1880 # 2018 <schedule_wrr+0x31a>
     ...
     8e4:	6e058593          	addi	a1,a1,1760 # 1fc0 <schedule_wrr+0x2c2>
     8e8:	853e                	mv	a0,a5
     ...
     900:	73450513          	addi	a0,a0,1844 # 2030 <schedule_wrr+0x332>
     ...
     932:	71a50513          	addi	a0,a0,1818 # 2048 <schedule_wrr+0x34a>
     ...
     95e:	70650513          	addi	a0,a0,1798 # 2060 <schedule_wrr+0x362>
     ...
     98c:	70050513          	addi	a0,a0,1792 # 2088 <schedule_wrr+0x38a>
     ...
     9b4:	66050513          	addi	a0,a0,1632 # 2010 <schedule_wrr+0x312>
     ...
     9ea:	5c258593          	addi	a1,a1,1474 # 1fa8 <schedule_wrr+0x2aa>
     9ee:	4509                	li	a0,2
     ...
     a1a:	59258593          	addi	a1,a1,1426 # 1fa8 <schedule_wrr+0x2aa>
     a1e:	4509                	li	a0,2
     ...
     a98:	61c58593          	addi	a1,a1,1564 # 20b0 <schedule_wrr+0x3b2>
     a9c:	4509                	li	a0,2
     ...
     ac2:	60a78793          	addi	a5,a5,1546 # 20c8 <schedule_wrr+0x3ca>
     ac6:	f4f43823          	sd	a5,-176(s0)
     aca:	00001797          	auipc	a5,0x1
     ace:	60678793          	addi	a5,a5,1542 # 20d0 <schedule_wrr+0x3d2>
     ...
     ae4:	5f850513          	addi	a0,a0,1528 # 20d8 <schedule_wrr+0x3da>
     ae8:	00001097          	auipc	ra,0x1
     aec:	89e080e7          	jalr	-1890(ra) # 1386 <exec>
        fprintf(2, "grind: echo: not found\n");
     af0:	00001597          	auipc	a1,0x1
     af4:	5f858593          	addi	a1,a1,1528 # 20e8 <schedule_wrr+0x3ea>
     af8:	4509                	li	a0,2
     ...
     b1a:	44a58593          	addi	a1,a1,1098 # 1f60 <schedule_wrr+0x262>
     b1e:	4509                	li	a0,2
     ...
     b84:	53058593          	addi	a1,a1,1328 # 20b0 <schedule_wrr+0x3b2>
     b88:	4509                	li	a0,2
     ...
     bd0:	4e458593          	addi	a1,a1,1252 # 20b0 <schedule_wrr+0x3b2>
     bd4:	4509                	li	a0,2
     ...
     bfa:	50a78793          	addi	a5,a5,1290 # 2100 <schedule_wrr+0x402>
     ...
     c10:	4fc50513          	addi	a0,a0,1276 # 2108 <schedule_wrr+0x40a>
     c14:	00000097          	auipc	ra,0x0
     c18:	772080e7          	jalr	1906(ra) # 1386 <exec>
        fprintf(2, "grind: cat: not found\n");
     c1c:	00001597          	auipc	a1,0x1
     c20:	4f458593          	addi	a1,a1,1268 # 2110 <schedule_wrr+0x412>
     c24:	4509                	li	a0,2
     ...
     c46:	31e58593          	addi	a1,a1,798 # 1f60 <schedule_wrr+0x262>
     c4a:	4509                	li	a0,2
     ...
     cfc:	3d858593          	addi	a1,a1,984 # 20d0 <schedule_wrr+0x3d2>
     d00:	853e                	mv	a0,a5
     ...
     d24:	40850513          	addi	a0,a0,1032 # 2128 <schedule_wrr+0x42a>
...
iter()
{
  ...
  unlink("a");
     ...
     d46:	23650513          	addi	a0,a0,566 # 1f78 <schedule_wrr+0x27a>
     d4a:	00000097          	auipc	ra,0x0
     d4e:	654080e7          	jalr	1620(ra) # 139e <unlink>
  unlink("b");
     d52:	00001517          	auipc	a0,0x1
     d56:	1d650513          	addi	a0,a0,470 # 1f28 <schedule_wrr+0x22a>
  ...
  if(pid1 < 0){
    ...
    printf("grind: fork failed\n");
     ...
     d7e:	1e650513          	addi	a0,a0,486 # 1f60 <schedule_wrr+0x262>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     da0:	40c78793          	addi	a5,a5,1036 # 21a8 <rand_next>
     da4:	477d                	li	a4,31
     da6:	e398                	sd	a4,0(a5)
    go(0);
     da8:	4501                	li	a0,0
  ...
  if(pid2 < 0){
    ...
    printf("grind: fork failed\n");
     ...
     dd8:	18c50513          	addi	a0,a0,396 # 1f60 <schedule_wrr+0x262>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     ...
     dfa:	3b278793          	addi	a5,a5,946 # 21a8 <rand_next>
     dfe:	6709                	lui	a4,0x2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    14b6:	cde68693          	addi	a3,a3,-802 # 2190 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1590:	c0470713          	addi	a4,a4,-1020 # 2190 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1750:	a0478793          	addi	a5,a5,-1532 # 2150 <schedule_wrr+0x452>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    18fc:	cb078793          	addi	a5,a5,-848 # 25a8 <freep>
  ...
  freep = p;
    ...
    19f4:	bb878793          	addi	a5,a5,-1096 # 25a8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    1a76:	b3678793          	addi	a5,a5,-1226 # 25a8 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    1aa8:	b0478793          	addi	a5,a5,-1276 # 25a8 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1b66:	a4678793          	addi	a5,a5,-1466 # 25a8 <freep>
    ...
    1b7c:	a3078793          	addi	a5,a5,-1488 # 25a8 <freep>
...
{
    1cfe:	7119                	addi	sp,sp,-128
    1d00:	fc86                	sd	ra,120(sp)
    1d02:	f8a2                	sd	s0,112(sp)
    1d04:	f4a6                	sd	s1,104(sp)
    1d06:	f0ca                	sd	s2,96(sp)
    1d08:	ecce                	sd	s3,88(sp)
    1d0a:	0100                	addi	s0,sp,128
    1d0c:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    1d0e:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    1d12:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    1d16:	00000517          	auipc	a0,0x0
    1d1a:	44250513          	addi	a0,a0,1090 # 2158 <schedule_wrr+0x45a>
    1d1e:	00000097          	auipc	ra,0x0
    1d22:	b76080e7          	jalr	-1162(ra) # 1894 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    1d26:	649c                	ld	a5,8(s1)
    1d28:	639c                	ld	a5,0(a5)
    1d2a:	faf43c23          	sd	a5,-72(s0)
    1d2e:	fb843783          	ld	a5,-72(s0)
    1d32:	fd878793          	addi	a5,a5,-40
    1d36:	fcf43023          	sd	a5,-64(s0)
    1d3a:	a049                	j	1dbc <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    1d3c:	fc043783          	ld	a5,-64(s0)
    1d40:	5fdc                	lw	a5,60(a5)
    1d42:	85be                	mv	a1,a5
    1d44:	00000517          	auipc	a0,0x0
    1d48:	42450513          	addi	a0,a0,1060 # 2168 <schedule_wrr+0x46a>
    1d4c:	00000097          	auipc	ra,0x0
    1d50:	b48080e7          	jalr	-1208(ra) # 1894 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    1d54:	fc043783          	ld	a5,-64(s0)
    1d58:	4ff8                	lw	a4,92(a5)
    1d5a:	fc043783          	ld	a5,-64(s0)
    1d5e:	47fc                	lw	a5,76(a5)
    1d60:	40f707bb          	subw	a5,a4,a5
    1d64:	2781                	sext.w	a5,a5
    1d66:	85be                	mv	a1,a5
    1d68:	00000517          	auipc	a0,0x0
    1d6c:	41050513          	addi	a0,a0,1040 # 2178 <schedule_wrr+0x47a>
    1d70:	00000097          	auipc	ra,0x0
    1d74:	b24080e7          	jalr	-1244(ra) # 1894 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    1d78:	fc843783          	ld	a5,-56(s0)
    1d7c:	c38d                	beqz	a5,1d9e <schedule_wrr+0xa0>
    1d7e:	fc043783          	ld	a5,-64(s0)
    1d82:	4fb8                	lw	a4,88(a5)
    1d84:	fc043783          	ld	a5,-64(s0)
    1d88:	43fc                	lw	a5,68(a5)
    1d8a:	00f71e63          	bne	a4,a5,1da6 <schedule_wrr+0xa8>
    1d8e:	fc043783          	ld	a5,-64(s0)
    1d92:	5fd8                	lw	a4,60(a5)
    1d94:	fc843783          	ld	a5,-56(s0)
    1d98:	5fdc                	lw	a5,60(a5)
    1d9a:	00f75663          	bge	a4,a5,1da6 <schedule_wrr+0xa8>
            current_thread = th;
    ...
    1dc6:	f6f71be3          	bne	a4,a5,1d3c <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    1dca:	40d8                	lw	a4,4(s1)
    1dcc:	fc843783          	ld	a5,-56(s0)
    1dd0:	47bc                	lw	a5,72(a5)
    1dd2:	02f707bb          	mulw	a5,a4,a5
    1dd6:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    1dda:	fc843783          	ld	a5,-56(s0)
    1dde:	4fbc                	lw	a5,88(a5)
    1de0:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    1de4:	fc843783          	ld	a5,-56(s0)
    1de8:	c795                	beqz	a5,1e14 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    1dea:	fc843783          	ld	a5,-56(s0)
    1dee:	02878793          	addi	a5,a5,40
    1df2:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    1df6:	fb442603          	lw	a2,-76(s0)
    1dfa:	fb042783          	lw	a5,-80(s0)
    1dfe:	0007869b          	sext.w	a3,a5
    1e02:	0006071b          	sext.w	a4,a2
    1e06:	00d75363          	bge	a4,a3,1e0c <schedule_wrr+0x10e>
    1e0a:	87b2                	mv	a5,a2
    1e0c:	2781                	sext.w	a5,a5
    1e0e:	f8f42823          	sw	a5,-112(s0)
    1e12:	a039                	j	1e20 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    1e14:	649c                	ld	a5,8(s1)
    1e16:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    1e1a:	4785                	li	a5,1
    1e1c:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    1e20:	f8843783          	ld	a5,-120(s0)
    1e24:	f8f43c23          	sd	a5,-104(s0)
    1e28:	f9043783          	ld	a5,-112(s0)
    1e2c:	faf43023          	sd	a5,-96(s0)
    1e30:	4701                	li	a4,0
    1e32:	f9843703          	ld	a4,-104(s0)
    1e36:	4781                	li	a5,0
    ...
    1e44:	853a                	mv	a0,a4
    1e46:	85be                	mv	a1,a5
    1e48:	70e6                	ld	ra,120(sp)
    1e4a:	7446                	ld	s0,112(sp)
    1e4c:	74a6                	ld	s1,104(sp)
    1e4e:	7906                	ld	s2,96(sp)
    1e50:	69e6                	ld	s3,88(sp)
    1e52:	6109                	addi	sp,sp,128
    1e54:	8082                	ret
