...
copyin(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
      ...
      54:	e5850513          	addi	a0,a0,-424 # 7ea8 <schedule_wrr+0x47e>
    ...
    if(fd < 0){
      ...
      74:	e4050513          	addi	a0,a0,-448 # 7eb0 <schedule_wrr+0x486>
    ...
    if(n >= 0){
      ...
      be:	e0e50513          	addi	a0,a0,-498 # 7ec8 <schedule_wrr+0x49e>
    ...
    unlink("copyin1");
      ...
      e6:	dc650513          	addi	a0,a0,-570 # 7ea8 <schedule_wrr+0x47e>
    ...
    if(n > 0){
     ...
     122:	dda50513          	addi	a0,a0,-550 # 7ef8 <schedule_wrr+0x4ce>
    ...
    if(pipe(fds) < 0){
     ...
     150:	ddc50513          	addi	a0,a0,-548 # 7f28 <schedule_wrr+0x4fe>
    ...
    if(n > 0){
     ...
     19a:	da250513          	addi	a0,a0,-606 # 7f38 <schedule_wrr+0x50e>
...
copyout(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     22a:	d4250513          	addi	a0,a0,-702 # 7f68 <schedule_wrr+0x53e>
    ...
    if(fd < 0){
     ...
     24a:	d2a50513          	addi	a0,a0,-726 # 7f70 <schedule_wrr+0x546>
    ...
    if(n > 0){
     ...
     294:	cf850513          	addi	a0,a0,-776 # 7f88 <schedule_wrr+0x55e>
    ...
    if(pipe(fds) < 0){
     ...
     2d0:	c5c50513          	addi	a0,a0,-932 # 7f28 <schedule_wrr+0x4fe>
    ...
    n = write(fds[1], "x", 1);
     ...
     2f0:	ccc58593          	addi	a1,a1,-820 # 7fb8 <schedule_wrr+0x58e>
     2f4:	853e                	mv	a0,a5
    ...
    if(n != 1){
     ...
     316:	cae50513          	addi	a0,a0,-850 # 7fc0 <schedule_wrr+0x596>
    ...
    if(n > 0){
     ...
     360:	c7c50513          	addi	a0,a0,-900 # 7fd8 <schedule_wrr+0x5ae>
...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    if(fd >= 0){
     ...
     41a:	bf250513          	addi	a0,a0,-1038 # 8008 <schedule_wrr+0x5de>
...
copyinstr2(char *s)
{
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     4c8:	b6450513          	addi	a0,a0,-1180 # 8028 <schedule_wrr+0x5fe>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     514:	b3850513          	addi	a0,a0,-1224 # 8048 <schedule_wrr+0x61e>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     566:	b0650513          	addi	a0,a0,-1274 # 8068 <schedule_wrr+0x63e>
  ...
  char *args[] = { "xx", 0 };
     ...
     580:	b1478793          	addi	a5,a5,-1260 # 8090 <schedule_wrr+0x666>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     5c4:	ad850513          	addi	a0,a0,-1320 # 8098 <schedule_wrr+0x66e>
  ...
  if(pid < 0){
    ...
    printf("fork failed\n");
     ...
     5f6:	ac650513          	addi	a0,a0,-1338 # 80b8 <schedule_wrr+0x68e>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < PGSIZE; i++)
     ...
     61e:	45e70713          	addi	a4,a4,1118 # fa78 <big.1275>
    ...
    ret = exec("echo", args2);
     ...
     682:	a4a50513          	addi	a0,a0,-1462 # 80c8 <schedule_wrr+0x69e>
    ...
    if(ret != -1){
     ...
     6ac:	a2850513          	addi	a0,a0,-1496 # 80d0 <schedule_wrr+0x6a6>
  ...
  if(st != 747){
    ...
    printf("exec(echo, BIG) succeeded, should have failed\n");
     ...
     6f2:	a0a50513          	addi	a0,a0,-1526 # 80f8 <schedule_wrr+0x6ce>
...
copyinstr3(char *s)
{
  ...
  if(top % PGSIZE){
    ...
    printf("oops\n");
     ...
     788:	9c450513          	addi	a0,a0,-1596 # 8148 <schedule_wrr+0x71e>
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    printf("unlink(%s) returned %d, not -1\n", b, ret);
     ...
     7e2:	84a50513          	addi	a0,a0,-1974 # 8028 <schedule_wrr+0x5fe>
  ...
  if(fd != -1){
    ...
    printf("open(%s) returned %d, not -1\n", b, fd);
     ...
     82a:	82250513          	addi	a0,a0,-2014 # 8048 <schedule_wrr+0x61e>
  ...
  if(ret != -1){
    ...
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
     ...
     876:	7f650513          	addi	a0,a0,2038 # 8068 <schedule_wrr+0x63e>
  ...
  char *args[] = { "xx", 0 };
     ...
     890:	80478793          	addi	a5,a5,-2044 # 8090 <schedule_wrr+0x666>
  ...
  if(ret != -1){
    ...
    printf("exec(%s) returned %d, not -1\n", b, fd);
     ...
     8d0:	7cc50513          	addi	a0,a0,1996 # 8098 <schedule_wrr+0x66e>
...
rwsbrk()
{
  ...
  if(a == 0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) failed\n");
     ...
     916:	83e50513          	addi	a0,a0,-1986 # 8150 <schedule_wrr+0x726>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    printf("sbrk(rwsbrk) shrink failed\n");
     ...
     942:	82a50513          	addi	a0,a0,-2006 # 8168 <schedule_wrr+0x73e>
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
     ...
     960:	2a450513          	addi	a0,a0,676 # 7c00 <schedule_wrr+0x1d6>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     980:	80c50513          	addi	a0,a0,-2036 # 8188 <schedule_wrr+0x75e>
  ...
  if(n >= 0){
    ...
    printf("write(fd, %p, 1024) returned %d, not -1\n", a+4096, n);
     ...
     9d8:	7cc50513          	addi	a0,a0,1996 # 81a0 <schedule_wrr+0x776>
  ...
  unlink("rwsbrk");
     ...
     a00:	20450513          	addi	a0,a0,516 # 7c00 <schedule_wrr+0x1d6>
  ...
  fd = open("README", O_RDONLY);
     ...
     a12:	55a50513          	addi	a0,a0,1370 # 7f68 <schedule_wrr+0x53e>
  ...
  if(fd < 0){
    ...
    printf("open(rwsbrk) failed\n");
     ...
     a32:	75a50513          	addi	a0,a0,1882 # 8188 <schedule_wrr+0x75e>
  ...
  if(n >= 0){
    ...
    printf("read(fd, %p, 10) returned %d, not -1\n", a+4096, n);
     ...
     a88:	74c50513          	addi	a0,a0,1868 # 81d0 <schedule_wrr+0x7a6>
...
truncate1(char *s)
{
  ...
  write(fd1, "abcd", 4);
     ...
     af6:	71658593          	addi	a1,a1,1814 # 8208 <schedule_wrr+0x7de>
     afa:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     b18:	6e450513          	addi	a0,a0,1764 # 81f8 <schedule_wrr+0x7ce>
  ...
  if(n != 4){
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     b64:	6b050513          	addi	a0,a0,1712 # 8210 <schedule_wrr+0x7e6>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     b82:	67a50513          	addi	a0,a0,1658 # 81f8 <schedule_wrr+0x7ce>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     b9a:	66250513          	addi	a0,a0,1634 # 81f8 <schedule_wrr+0x7ce>
  ...
  if(n != 0){
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     bdc:	65850513          	addi	a0,a0,1624 # 8230 <schedule_wrr+0x806>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     bf6:	64e50513          	addi	a0,a0,1614 # 8240 <schedule_wrr+0x816>
  ...
  if(n != 0){
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     c3c:	62850513          	addi	a0,a0,1576 # 8260 <schedule_wrr+0x836>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     c56:	5ee50513          	addi	a0,a0,1518 # 8240 <schedule_wrr+0x816>
  ...
  write(fd1, "abcdef", 6);
     ...
     c76:	5fe58593          	addi	a1,a1,1534 # 8270 <schedule_wrr+0x846>
     c7a:	853e                	mv	a0,a5
  ...
  if(n != 6){
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     cbe:	5be50513          	addi	a0,a0,1470 # 8278 <schedule_wrr+0x84e>
  ...
  if(n != 2){
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     d0e:	58e50513          	addi	a0,a0,1422 # 8298 <schedule_wrr+0x86e>
  ...
  unlink("truncfile");
     ...
     d28:	4d450513          	addi	a0,a0,1236 # 81f8 <schedule_wrr+0x7ce>
...
truncate2(char *s)
{
  ...
  unlink("truncfile");
     ...
     d78:	48450513          	addi	a0,a0,1156 # 81f8 <schedule_wrr+0x7ce>
  ...
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     ...
     d8c:	47050513          	addi	a0,a0,1136 # 81f8 <schedule_wrr+0x7ce>
  ...
  write(fd1, "abcd", 4);
     ...
     da8:	46458593          	addi	a1,a1,1124 # 8208 <schedule_wrr+0x7de>
     dac:	853e                	mv	a0,a5
  ...
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     ...
     dbe:	43e50513          	addi	a0,a0,1086 # 81f8 <schedule_wrr+0x7ce>
  ...
  int n = write(fd1, "x", 1);
     ...
     dda:	1e258593          	addi	a1,a1,482 # 7fb8 <schedule_wrr+0x58e>
     dde:	853e                	mv	a0,a5
  ...
  if(n != -1){
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     e0a:	4b250513          	addi	a0,a0,1202 # 82b8 <schedule_wrr+0x88e>
  ...
  unlink("truncfile");
     ...
     e24:	3d850513          	addi	a0,a0,984 # 81f8 <schedule_wrr+0x7ce>
...
truncate3(char *s)
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
     ...
     e6a:	39250513          	addi	a0,a0,914 # 81f8 <schedule_wrr+0x7ce>
  ...
  if(pid < 0){
    ...
    printf("%s: fork failed\n", s);
     ...
     ea2:	44250513          	addi	a0,a0,1090 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid == 0){
    ...
    for(int i = 0; i < 100; i++){
     ...
     ece:	32e50513          	addi	a0,a0,814 # 81f8 <schedule_wrr+0x7ce>
     ...
     ef2:	40a50513          	addi	a0,a0,1034 # 82f8 <schedule_wrr+0x8ce>
     ...
     f12:	40258593          	addi	a1,a1,1026 # 8310 <schedule_wrr+0x8e6>
     f16:	853e                	mv	a0,a5
     ...
     f42:	3e250513          	addi	a0,a0,994 # 8320 <schedule_wrr+0x8f6>
     ...
     f6c:	29050513          	addi	a0,a0,656 # 81f8 <schedule_wrr+0x7ce>
  ...
  for(int i = 0; i < 150; i++){
    ...
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     fd6:	22650513          	addi	a0,a0,550 # 81f8 <schedule_wrr+0x7ce>
    ...
    if(fd < 0){
     ...
     ffa:	30250513          	addi	a0,a0,770 # 82f8 <schedule_wrr+0x8ce>
    ...
    101a:	32a58593          	addi	a1,a1,810 # 8340 <schedule_wrr+0x916>
    101e:	853e                	mv	a0,a5
    ...
    104a:	30250513          	addi	a0,a0,770 # 8348 <schedule_wrr+0x91e>
  ...
  unlink("truncfile");
    ...
    109a:	16250513          	addi	a0,a0,354 # 81f8 <schedule_wrr+0x7ce>
...
iputtest(char *s)
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    10c4:	2a850513          	addi	a0,a0,680 # 8368 <schedule_wrr+0x93e>
    ...
    10de:	29650513          	addi	a0,a0,662 # 8370 <schedule_wrr+0x946>
  ...
  if(chdir("iputdir") < 0){
    ...
    10f8:	27450513          	addi	a0,a0,628 # 8368 <schedule_wrr+0x93e>
    ...
    1112:	27a50513          	addi	a0,a0,634 # 8388 <schedule_wrr+0x95e>
  ...
  if(unlink("../iputdir") < 0){
    ...
    112c:	28050513          	addi	a0,a0,640 # 83a8 <schedule_wrr+0x97e>
    ...
    1146:	27650513          	addi	a0,a0,630 # 83b8 <schedule_wrr+0x98e>
  ...
  if(chdir("/") < 0){
    ...
    1160:	27c50513          	addi	a0,a0,636 # 83d8 <schedule_wrr+0x9ae>
    ...
    117a:	26a50513          	addi	a0,a0,618 # 83e0 <schedule_wrr+0x9b6>
...
exitiputtest(char *s)
{
  ...
  if(pid < 0){
    ...
    11c6:	11e50513          	addi	a0,a0,286 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid == 0){
    ...
    11e8:	18450513          	addi	a0,a0,388 # 8368 <schedule_wrr+0x93e>
    ...
    1202:	17250513          	addi	a0,a0,370 # 8370 <schedule_wrr+0x946>
    ...
    121c:	15050513          	addi	a0,a0,336 # 8368 <schedule_wrr+0x93e>
    ...
    1236:	1c650513          	addi	a0,a0,454 # 83f8 <schedule_wrr+0x9ce>
    ...
    1250:	15c50513          	addi	a0,a0,348 # 83a8 <schedule_wrr+0x97e>
    ...
    126a:	15250513          	addi	a0,a0,338 # 83b8 <schedule_wrr+0x98e>
...
openiputtest(char *s)
{
  ...
  if(mkdir("oidir") < 0){
    ...
    12b6:	15e50513          	addi	a0,a0,350 # 8410 <schedule_wrr+0x9e6>
    ...
    12d0:	14c50513          	addi	a0,a0,332 # 8418 <schedule_wrr+0x9ee>
  ...
  if(pid < 0){
    ...
    1306:	fde50513          	addi	a0,a0,-34 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid == 0){
    ...
    132a:	0ea50513          	addi	a0,a0,234 # 8410 <schedule_wrr+0x9e6>
    ...
    134e:	0e650513          	addi	a0,a0,230 # 8430 <schedule_wrr+0xa06>
  ...
  if(unlink("oidir") != 0){
    ...
    137c:	09850513          	addi	a0,a0,152 # 8410 <schedule_wrr+0x9e6>
    ...
    1394:	0c850513          	addi	a0,a0,200 # 8458 <schedule_wrr+0xa2e>
...
opentest(char *s)
{
  ...
  fd = open("echo", 0);
    ...
    13d8:	cf450513          	addi	a0,a0,-780 # 80c8 <schedule_wrr+0x69e>
  ...
  if(fd < 0){
    ...
    13fc:	07850513          	addi	a0,a0,120 # 8470 <schedule_wrr+0xa46>
  ...
  fd = open("doesnotexist", 0);
    ...
    1426:	06650513          	addi	a0,a0,102 # 8488 <schedule_wrr+0xa5e>
  ...
  if(fd >= 0){
    ...
    144a:	05250513          	addi	a0,a0,82 # 8498 <schedule_wrr+0xa6e>
...
writetest(char *s)
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    147e:	04650513          	addi	a0,a0,70 # 84c0 <schedule_wrr+0xa96>
  ...
  if(fd < 0){
    ...
    14a2:	02a50513          	addi	a0,a0,42 # 84c8 <schedule_wrr+0xa9e>
  ...
  for(i = 0; i < N; i++){
    ...
    14c8:	02458593          	addi	a1,a1,36 # 84e8 <schedule_wrr+0xabe>
    14cc:	853e                	mv	a0,a5
    ...
    14ee:	00e50513          	addi	a0,a0,14 # 84f8 <schedule_wrr+0xace>
    ...
    150e:	01658593          	addi	a1,a1,22 # 8520 <schedule_wrr+0xaf6>
    1512:	853e                	mv	a0,a5
  ...
  fd = open("small", O_RDONLY);
    ...
    1578:	f4c50513          	addi	a0,a0,-180 # 84c0 <schedule_wrr+0xa96>
  ...
  if(fd < 0){
    ...
    159c:	fc050513          	addi	a0,a0,-64 # 8558 <schedule_wrr+0xb2e>
  ...
  i = read(fd, buf, N*SZ*2);
    ...
    15be:	dae58593          	addi	a1,a1,-594 # a368 <buf>
    15c2:	853e                	mv	a0,a5
  ...
  if(i != N*SZ*2){
    ...
    15ea:	f9250513          	addi	a0,a0,-110 # 8578 <schedule_wrr+0xb4e>
  ...
  if(unlink("small") < 0){
    ...
    1612:	eb250513          	addi	a0,a0,-334 # 84c0 <schedule_wrr+0xa96>
    ...
    162c:	f6850513          	addi	a0,a0,-152 # 8590 <schedule_wrr+0xb66>
...
writebig(char *s)
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1660:	f5450513          	addi	a0,a0,-172 # 85b0 <schedule_wrr+0xb86>
  ...
  if(fd < 0){
    ...
    1684:	f3850513          	addi	a0,a0,-200 # 85b8 <schedule_wrr+0xb8e>
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	cc878793          	addi	a5,a5,-824 # a368 <buf>
    ...
    16ba:	cb258593          	addi	a1,a1,-846 # a368 <buf>
    16be:	853e                	mv	a0,a5
    ...
    16e2:	efa50513          	addi	a0,a0,-262 # 85d8 <schedule_wrr+0xbae>
  ...
  fd = open("big", O_RDONLY);
    ...
    1726:	e8e50513          	addi	a0,a0,-370 # 85b0 <schedule_wrr+0xb86>
  ...
  if(fd < 0){
    ...
    174a:	eba50513          	addi	a0,a0,-326 # 8600 <schedule_wrr+0xbd6>
  ...
  for(;;){
    ...
    1770:	bfc58593          	addi	a1,a1,-1028 # a368 <buf>
    1774:	853e                	mv	a0,a5
    ...
    17aa:	e7a50513          	addi	a0,a0,-390 # 8620 <schedule_wrr+0xbf6>
    ...
    17de:	e6e50513          	addi	a0,a0,-402 # 8648 <schedule_wrr+0xc1e>
    ...
    17f8:	b7478793          	addi	a5,a5,-1164 # a368 <buf>
    ...
    180c:	b6078793          	addi	a5,a5,-1184 # a368 <buf>
      printf("%s: read content of block %d is %d\n", s,
    ...
    1822:	e4250513          	addi	a0,a0,-446 # 8660 <schedule_wrr+0xc36>
  ...
  if(unlink("big") < 0){
    ...
    1858:	d5c50513          	addi	a0,a0,-676 # 85b0 <schedule_wrr+0xb86>
    ...
    1872:	e1a50513          	addi	a0,a0,-486 # 8688 <schedule_wrr+0xc5e>
...
void dirtest(char *s)
{
  ...
  if(mkdir("dir0") < 0){
    ...
    196e:	d3650513          	addi	a0,a0,-714 # 86a0 <schedule_wrr+0xc76>
    ...
    1988:	9ec50513          	addi	a0,a0,-1556 # 8370 <schedule_wrr+0x946>
  ...
  if(chdir("dir0") < 0){
    ...
    19a2:	d0250513          	addi	a0,a0,-766 # 86a0 <schedule_wrr+0xc76>
    ...
    19bc:	cf050513          	addi	a0,a0,-784 # 86a8 <schedule_wrr+0xc7e>
  ...
  if(chdir("..") < 0){
    ...
    19d6:	cee50513          	addi	a0,a0,-786 # 86c0 <schedule_wrr+0xc96>
    ...
    19f0:	cdc50513          	addi	a0,a0,-804 # 86c8 <schedule_wrr+0xc9e>
  ...
  if(unlink("dir0") < 0){
    ...
    1a0a:	c9a50513          	addi	a0,a0,-870 # 86a0 <schedule_wrr+0xc76>
    ...
    1a24:	cc050513          	addi	a0,a0,-832 # 86e0 <schedule_wrr+0xcb6>
...
exectest(char *s)
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1a54:	67878793          	addi	a5,a5,1656 # 80c8 <schedule_wrr+0x69e>
    1a58:	fcf43423          	sd	a5,-56(s0)
    1a5c:	00007797          	auipc	a5,0x7
    1a60:	c9c78793          	addi	a5,a5,-868 # 86f8 <schedule_wrr+0xcce>
  ...
  unlink("echo-ok");
    ...
    1a70:	c9450513          	addi	a0,a0,-876 # 8700 <schedule_wrr+0xcd6>
  ...
  if(pid < 0) {
    ...
    1a9c:	84850513          	addi	a0,a0,-1976 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid == 0) {
    ...
    1acc:	c3850513          	addi	a0,a0,-968 # 8700 <schedule_wrr+0xcd6>
    ...
    1af0:	c1c50513          	addi	a0,a0,-996 # 8708 <schedule_wrr+0xcde>
    ...
    1b1c:	c0850513          	addi	a0,a0,-1016 # 8720 <schedule_wrr+0xcf6>
    ...
    1b3c:	59050513          	addi	a0,a0,1424 # 80c8 <schedule_wrr+0x69e>
    ...
    1b56:	bde50513          	addi	a0,a0,-1058 # 8730 <schedule_wrr+0xd06>
  ...
  if (wait(&xstatus) != pid) {
    ...
    1b90:	bbc50513          	addi	a0,a0,-1092 # 8748 <schedule_wrr+0xd1e>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1bb6:	b4e50513          	addi	a0,a0,-1202 # 8700 <schedule_wrr+0xcd6>
  ...
  if(fd < 0) {
    ...
    1bd6:	00006517          	auipc	a0,0x6
    1bda:	72250513          	addi	a0,a0,1826 # 82f8 <schedule_wrr+0x8ce>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1c18:	96450513          	addi	a0,a0,-1692 # 8578 <schedule_wrr+0xb4e>
  ...
  unlink("echo-ok");
    ...
    1c32:	ad250513          	addi	a0,a0,-1326 # 8700 <schedule_wrr+0xcd6>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1c6c:	af850513          	addi	a0,a0,-1288 # 8760 <schedule_wrr+0xd36>
...
pipe1(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    1ca8:	ad450513          	addi	a0,a0,-1324 # 8778 <schedule_wrr+0xd4e>
  ...
  if(pid == 0){
    ...
    1d06:	66668693          	addi	a3,a3,1638 # a368 <buf>
    ...
    1d3a:	63258593          	addi	a1,a1,1586 # a368 <buf>
    1d3e:	853e                	mv	a0,a5
    ...
    1d5c:	a3850513          	addi	a0,a0,-1480 # 8790 <schedule_wrr+0xd66>
    ...
    1dc2:	5aa70713          	addi	a4,a4,1450 # a368 <buf>
    ...
    1df4:	9b850513          	addi	a0,a0,-1608 # 87a8 <schedule_wrr+0xd7e>
    ...
    1e56:	51658593          	addi	a1,a1,1302 # a368 <buf>
    1e5a:	853e                	mv	a0,a5
    ...
    1e90:	93450513          	addi	a0,a0,-1740 # 87c0 <schedule_wrr+0xd96>
    ...
    1ed8:	90c50513          	addi	a0,a0,-1780 # 87e0 <schedule_wrr+0xdb6>
...
preempt(char *s)
{
  ...
  if(pid1 < 0) {
    ...
    1f22:	8da50513          	addi	a0,a0,-1830 # 87f8 <schedule_wrr+0xdce>
  ...
  if(pid2 < 0) {
    ...
    1f62:	38250513          	addi	a0,a0,898 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid3 < 0) {
    ...
    1fb0:	33450513          	addi	a0,a0,820 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid3 == 0){
    ...
    1fe6:	fd658593          	addi	a1,a1,-42 # 7fb8 <schedule_wrr+0x58e>
    1fea:	853e                	mv	a0,a5
    ...
    2006:	80650513          	addi	a0,a0,-2042 # 8808 <schedule_wrr+0xdde>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    203a:	33258593          	addi	a1,a1,818 # a368 <buf>
    203e:	853e                	mv	a0,a5
    ...
    205a:	7ca50513          	addi	a0,a0,1994 # 8820 <schedule_wrr+0xdf6>
  ...
  printf("kill... ");
    2076:	00006517          	auipc	a0,0x6
    207a:	7c250513          	addi	a0,a0,1986 # 8838 <schedule_wrr+0xe0e>
  ...
  printf("wait... ");
    20b0:	00006517          	auipc	a0,0x6
    20b4:	79850513          	addi	a0,a0,1944 # 8848 <schedule_wrr+0xe1e>
...
exitwait(char *s)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    2118:	1cc50513          	addi	a0,a0,460 # 82e0 <schedule_wrr+0x8b6>
    ...
    2156:	00006517          	auipc	a0,0x6
    215a:	70250513          	addi	a0,a0,1794 # 8858 <schedule_wrr+0xe2e>
    ...
    2182:	00006517          	auipc	a0,0x6
    2186:	6ee50513          	addi	a0,a0,1774 # 8870 <schedule_wrr+0xe46>
...
reparent(char *s)
{
  ...
  for(int i = 0; i < 200; i++){
    ...
    2210:	0d450513          	addi	a0,a0,212 # 82e0 <schedule_wrr+0x8b6>
    ...
    224e:	60e50513          	addi	a0,a0,1550 # 8858 <schedule_wrr+0xe2e>
...
twochildren(char *s)
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    22f4:	ff050513          	addi	a0,a0,-16 # 82e0 <schedule_wrr+0x8b6>
    ...
    233c:	fa850513          	addi	a0,a0,-88 # 82e0 <schedule_wrr+0x8b6>
...
forkfork(char *s)
{
  ...
  for(int i = 0; i < N; i++){
    ...
    23d0:	42c50513          	addi	a0,a0,1068 # 87f8 <schedule_wrr+0xdce>
  ...
  for(int i = 0; i < N; i++){
    ...
    2490:	40450513          	addi	a0,a0,1028 # 8890 <schedule_wrr+0xe66>
...
forkforkfork(char *s)
{
  ...
  unlink("stopforking");
    ...
    24da:	3da50513          	addi	a0,a0,986 # 88b0 <schedule_wrr+0xe86>
  ...
  if(pid < 0){
    ...
    2506:	2f650513          	addi	a0,a0,758 # 87f8 <schedule_wrr+0xdce>
  ...
  if(pid == 0){
    ...
    252a:	38a50513          	addi	a0,a0,906 # 88b0 <schedule_wrr+0xe86>
    ...
    2566:	34e50513          	addi	a0,a0,846 # 88b0 <schedule_wrr+0xe86>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    2592:	32250513          	addi	a0,a0,802 # 88b0 <schedule_wrr+0xe86>
...
reparent2(char *s)
{
  ...
  for(int i = 0; i < 800; i++){
    ...
    25f6:	ac650513          	addi	a0,a0,-1338 # 80b8 <schedule_wrr+0x68e>
...
mem(char *s)
{
  ...
  if((pid = fork()) == 0){
    ...
    26f0:	1d450513          	addi	a0,a0,468 # 88c0 <schedule_wrr+0xe96>
...
sharedfd(char *s)
{
  ...
  if(fd < 0){
    ...
    2796:	14e50513          	addi	a0,a0,334 # 88e0 <schedule_wrr+0xeb6>
  ...
  for(i = 0; i < N; i++){
    ...
    280c:	10050513          	addi	a0,a0,256 # 8908 <schedule_wrr+0xede>
  ...
  fd = open("sharedfd", 0);
    ...
    2884:	4a050513          	addi	a0,a0,1184 # 7d20 <schedule_wrr+0x2f6>
  ...
  if(fd < 0){
    ...
    28a8:	08450513          	addi	a0,a0,132 # 8928 <schedule_wrr+0xefe>
  ...
  unlink("sharedfd");
    ...
    2964:	3c050513          	addi	a0,a0,960 # 7d20 <schedule_wrr+0x2f6>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    29a6:	fae50513          	addi	a0,a0,-82 # 8950 <schedule_wrr+0xf26>
...
fourfiles(char *s)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    29cc:	ff078793          	addi	a5,a5,-16 # 89b8 <schedule_wrr+0xf8e>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2a2e:	68e50513          	addi	a0,a0,1678 # 80b8 <schedule_wrr+0x68e>
    ...
    2a74:	ef850513          	addi	a0,a0,-264 # 8968 <schedule_wrr+0xf3e>
    ...
    2a9e:	8ce50513          	addi	a0,a0,-1842 # a368 <buf>
    ...
    2abc:	8b058593          	addi	a1,a1,-1872 # a368 <buf>
    2ac0:	853e                	mv	a0,a5
    ...
    2aea:	e9250513          	addi	a0,a0,-366 # 8978 <schedule_wrr+0xf4e>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    2bb2:	a0b9                	j	2c00 <fourfiles+0x244>
        if(buf[j] != '0'+i){
    2bb4:	00007717          	auipc	a4,0x7
    2bb8:	7b470713          	addi	a4,a4,1972 # a368 <buf>
    ...
    2be0:	db450513          	addi	a0,a0,-588 # 8990 <schedule_wrr+0xf66>
    ...
    2c24:	00007597          	auipc	a1,0x7
    2c28:	74458593          	addi	a1,a1,1860 # a368 <buf>
    2c2c:	853e                	mv	a0,a5
    ...
    2c70:	d3450513          	addi	a0,a0,-716 # 89a0 <schedule_wrr+0xf76>
...
createdelete(char *s)
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    2ce8:	3d450513          	addi	a0,a0,980 # 80b8 <schedule_wrr+0x68e>
    ...
    2d64:	9a850513          	addi	a0,a0,-1624 # 8708 <schedule_wrr+0xcde>
    ...
    2dd8:	68450513          	addi	a0,a0,1668 # 8458 <schedule_wrr+0xa2e>
  ...
  for(i = 0; i < N; i++){
    ...
    2ef0:	aec50513          	addi	a0,a0,-1300 # 89d8 <schedule_wrr+0xfae>
    ...
    2f36:	ace50513          	addi	a0,a0,-1330 # 8a00 <schedule_wrr+0xfd6>
...
unlinkread(char *s)
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3026:	cc650513          	addi	a0,a0,-826 # 7ce8 <schedule_wrr+0x2be>
  ...
  if(fd < 0){
    ...
    304a:	9e250513          	addi	a0,a0,-1566 # 8a28 <schedule_wrr+0xffe>
  ...
  write(fd, "hello", SZ);
    ...
    306a:	9e258593          	addi	a1,a1,-1566 # 8a48 <schedule_wrr+0x101e>
    306e:	853e                	mv	a0,a5
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    308c:	c6050513          	addi	a0,a0,-928 # 7ce8 <schedule_wrr+0x2be>
  ...
  if(fd < 0){
    ...
    30b0:	9a450513          	addi	a0,a0,-1628 # 8a50 <schedule_wrr+0x1026>
  ...
  if(unlink("unlinkread") != 0){
    ...
    30ca:	c2250513          	addi	a0,a0,-990 # 7ce8 <schedule_wrr+0x2be>
    ...
    30e2:	99250513          	addi	a0,a0,-1646 # 8a70 <schedule_wrr+0x1046>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    3100:	bec50513          	addi	a0,a0,-1044 # 7ce8 <schedule_wrr+0x2be>
  ...
  write(fd1, "yyy", 3);
    ...
    311c:	97858593          	addi	a1,a1,-1672 # 8a90 <schedule_wrr+0x1066>
    3120:	853e                	mv	a0,a5
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    3142:	22a58593          	addi	a1,a1,554 # a368 <buf>
    3146:	853e                	mv	a0,a5
    ...
    3162:	93a50513          	addi	a0,a0,-1734 # 8a98 <schedule_wrr+0x106e>
  ...
  if(buf[0] != 'h'){
    ...
    317c:	1f078793          	addi	a5,a5,496 # a368 <buf>
    ...
    3196:	92650513          	addi	a0,a0,-1754 # 8ab8 <schedule_wrr+0x108e>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    31b6:	1b658593          	addi	a1,a1,438 # a368 <buf>
    31ba:	853e                	mv	a0,a5
    ...
    31d6:	90650513          	addi	a0,a0,-1786 # 8ad8 <schedule_wrr+0x10ae>
  ...
  unlink("unlinkread");
    ...
    31fe:	aee50513          	addi	a0,a0,-1298 # 7ce8 <schedule_wrr+0x2be>
...
linktest(char *s)
{
  ...
  unlink("lf1");
    ...
    3224:	8d850513          	addi	a0,a0,-1832 # 8af8 <schedule_wrr+0x10ce>
    3228:	00004097          	auipc	ra,0x4
    322c:	ea2080e7          	jalr	-350(ra) # 70ca <unlink>
  unlink("lf2");
    3230:	00006517          	auipc	a0,0x6
    3234:	8d050513          	addi	a0,a0,-1840 # 8b00 <schedule_wrr+0x10d6>
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    3248:	8b450513          	addi	a0,a0,-1868 # 8af8 <schedule_wrr+0x10ce>
  ...
  if(fd < 0){
    ...
    326c:	8a050513          	addi	a0,a0,-1888 # 8b08 <schedule_wrr+0x10de>
  ...
  if(write(fd, "hello", SZ) != SZ){
    ...
    3286:	4615                	li	a2,5
    3288:	00005597          	auipc	a1,0x5
    328c:	7c058593          	addi	a1,a1,1984 # 8a48 <schedule_wrr+0x101e>
    3290:	853e                	mv	a0,a5
    ...
    32ac:	87850513          	addi	a0,a0,-1928 # 8b20 <schedule_wrr+0x10f6>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    32d4:	83058593          	addi	a1,a1,-2000 # 8b00 <schedule_wrr+0x10d6>
    32d8:	00006517          	auipc	a0,0x6
    32dc:	82050513          	addi	a0,a0,-2016 # 8af8 <schedule_wrr+0x10ce>
    ...
    32f6:	84650513          	addi	a0,a0,-1978 # 8b38 <schedule_wrr+0x110e>
  ...
  unlink("lf1");
    ...
    3310:	7ec50513          	addi	a0,a0,2028 # 8af8 <schedule_wrr+0x10ce>
    3314:	00004097          	auipc	ra,0x4
    3318:	db6080e7          	jalr	-586(ra) # 70ca <unlink>

  if(open("lf1", 0) >= 0){
    331c:	4581                	li	a1,0
    331e:	00005517          	auipc	a0,0x5
    3322:	7da50513          	addi	a0,a0,2010 # 8af8 <schedule_wrr+0x10ce>
    ...
    333c:	82050513          	addi	a0,a0,-2016 # 8b58 <schedule_wrr+0x112e>
  ...
  fd = open("lf2", 0);
    3352:	4581                	li	a1,0
    3354:	00005517          	auipc	a0,0x5
    3358:	7ac50513          	addi	a0,a0,1964 # 8b00 <schedule_wrr+0x10d6>
  ...
  if(fd < 0){
    ...
    337c:	81050513          	addi	a0,a0,-2032 # 8b88 <schedule_wrr+0x115e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
    ...
    339c:	fd058593          	addi	a1,a1,-48 # a368 <buf>
    33a0:	853e                	mv	a0,a5
    ...
    33b8:	00005517          	auipc	a0,0x5
    33bc:	7e850513          	addi	a0,a0,2024 # 8ba0 <schedule_wrr+0x1176>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    33e4:	72058593          	addi	a1,a1,1824 # 8b00 <schedule_wrr+0x10d6>
    33e8:	00005517          	auipc	a0,0x5
    33ec:	71850513          	addi	a0,a0,1816 # 8b00 <schedule_wrr+0x10d6>
    ...
    3406:	7b650513          	addi	a0,a0,1974 # 8bb8 <schedule_wrr+0x118e>
  ...
  unlink("lf2");
    ...
    3420:	6e450513          	addi	a0,a0,1764 # 8b00 <schedule_wrr+0x10d6>
    3424:	00004097          	auipc	ra,0x4
    3428:	ca6080e7          	jalr	-858(ra) # 70ca <unlink>
  if(link("lf2", "lf1") >= 0){
    342c:	00005597          	auipc	a1,0x5
    3430:	6cc58593          	addi	a1,a1,1740 # 8af8 <schedule_wrr+0x10ce>
    3434:	00005517          	auipc	a0,0x5
    3438:	6cc50513          	addi	a0,a0,1740 # 8b00 <schedule_wrr+0x10d6>
    ...
    344e:	00005517          	auipc	a0,0x5
    3452:	79250513          	addi	a0,a0,1938 # 8be0 <schedule_wrr+0x11b6>
  ...
  if(link(".", "lf1") >= 0){
    ...
    346c:	69058593          	addi	a1,a1,1680 # 8af8 <schedule_wrr+0x10ce>
    3470:	00005517          	auipc	a0,0x5
    3474:	79850513          	addi	a0,a0,1944 # 8c08 <schedule_wrr+0x11de>
    ...
    348a:	00005517          	auipc	a0,0x5
    348e:	78650513          	addi	a0,a0,1926 # 8c10 <schedule_wrr+0x11e6>
...
concreate(char *s)
{
  ...
  for(i = 0; i < N; i++){
    ...
    351c:	85be                	mv	a1,a5
    351e:	00005517          	auipc	a0,0x5
    3522:	71250513          	addi	a0,a0,1810 # 8c30 <schedule_wrr+0x1206>
    ...
    3556:	6de50513          	addi	a0,a0,1758 # 8c30 <schedule_wrr+0x1206>
    ...
    3590:	6ac50513          	addi	a0,a0,1708 # 8c38 <schedule_wrr+0x120e>
  ...
  fd = open(".", 0);
    ...
    3618:	5f450513          	addi	a0,a0,1524 # 8c08 <schedule_wrr+0x11de>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3682:	5da50513          	addi	a0,a0,1498 # 8c58 <schedule_wrr+0x122e>
    ...
    36b8:	5c450513          	addi	a0,a0,1476 # 8c78 <schedule_wrr+0x124e>
  ...
  if(n != N){
    ...
    372a:	57a50513          	addi	a0,a0,1402 # 8ca0 <schedule_wrr+0x1276>
  ...
  for(i = 0; i < N; i++){
    ...
    377a:	b6a50513          	addi	a0,a0,-1174 # 82e0 <schedule_wrr+0x8b6>
...
linkunlink(char *s)
{
  ...
  unlink("x");
    ...
    3912:	6aa50513          	addi	a0,a0,1706 # 7fb8 <schedule_wrr+0x58e>
  ...
  if(pid < 0){
    ...
    393e:	9a650513          	addi	a0,a0,-1626 # 82e0 <schedule_wrr+0x8b6>
  ...
  for(i = 0; i < 100; i++){
    ...
    39a4:	61850513          	addi	a0,a0,1560 # 7fb8 <schedule_wrr+0x58e>
    ...
    39d6:	5e658593          	addi	a1,a1,1510 # 7fb8 <schedule_wrr+0x58e>
    39da:	00005517          	auipc	a0,0x5
    39de:	2fe50513          	addi	a0,a0,766 # 8cd8 <schedule_wrr+0x12ae>
    ...
    39f0:	5cc50513          	addi	a0,a0,1484 # 7fb8 <schedule_wrr+0x58e>
...
bigdir(char *s)
{
  ...
  unlink("bd");
    ...
    3a4c:	29850513          	addi	a0,a0,664 # 8ce0 <schedule_wrr+0x12b6>
  ...
  fd = open("bd", O_CREATE);
    ...
    3a60:	28450513          	addi	a0,a0,644 # 8ce0 <schedule_wrr+0x12b6>
  ...
  if(fd < 0){
    ...
    3a84:	26850513          	addi	a0,a0,616 # 8ce8 <schedule_wrr+0x12be>
  ...
  for(i = 0; i < N; i++){
    ...
    3b10:	1d450513          	addi	a0,a0,468 # 8ce0 <schedule_wrr+0x12b6>
    ...
    3b2e:	1de50513          	addi	a0,a0,478 # 8d08 <schedule_wrr+0x12de>
  ...
  unlink("bd");
    ...
    3b62:	18250513          	addi	a0,a0,386 # 8ce0 <schedule_wrr+0x12b6>
  ...
  for(i = 0; i < N; i++){
    ...
    3be6:	14650513          	addi	a0,a0,326 # 8d28 <schedule_wrr+0x12fe>
...
subdir(char *s)
{
  ...
  unlink("ff");
    ...
    3c32:	11a50513          	addi	a0,a0,282 # 8d48 <schedule_wrr+0x131e>
    3c36:	00003097          	auipc	ra,0x3
    3c3a:	494080e7          	jalr	1172(ra) # 70ca <unlink>
  if(mkdir("dd") != 0){
    3c3e:	00005517          	auipc	a0,0x5
    3c42:	11250513          	addi	a0,a0,274 # 8d50 <schedule_wrr+0x1326>
    ...
    3c5a:	10250513          	addi	a0,a0,258 # 8d58 <schedule_wrr+0x132e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3c78:	0fc50513          	addi	a0,a0,252 # 8d70 <schedule_wrr+0x1346>
  ...
  if(fd < 0){
    ...
    3c9c:	0e050513          	addi	a0,a0,224 # 8d78 <schedule_wrr+0x134e>
  ...
  write(fd, "ff", 2);
    ...
    3cbc:	09058593          	addi	a1,a1,144 # 8d48 <schedule_wrr+0x131e>
    3cc0:	853e                	mv	a0,a5
  ...
  if(unlink("dd") >= 0){
    ...
    3cdc:	07850513          	addi	a0,a0,120 # 8d50 <schedule_wrr+0x1326>
    ...
    3cf6:	0a650513          	addi	a0,a0,166 # 8d98 <schedule_wrr+0x136e>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3d10:	0bc50513          	addi	a0,a0,188 # 8dc8 <schedule_wrr+0x139e>
    ...
    3d28:	0ac50513          	addi	a0,a0,172 # 8dd0 <schedule_wrr+0x13a6>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3d46:	0ae50513          	addi	a0,a0,174 # 8df0 <schedule_wrr+0x13c6>
  ...
  if(fd < 0){
    ...
    3d6a:	09a50513          	addi	a0,a0,154 # 8e00 <schedule_wrr+0x13d6>
  ...
  write(fd, "FF", 2);
    ...
    3d8a:	09a58593          	addi	a1,a1,154 # 8e20 <schedule_wrr+0x13f6>
    3d8e:	853e                	mv	a0,a5
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3dac:	08050513          	addi	a0,a0,128 # 8e28 <schedule_wrr+0x13fe>
  ...
  if(fd < 0){
    ...
    3dd0:	06c50513          	addi	a0,a0,108 # 8e38 <schedule_wrr+0x140e>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3df0:	57c58593          	addi	a1,a1,1404 # a368 <buf>
    3df4:	853e                	mv	a0,a5
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3e16:	55678793          	addi	a5,a5,1366 # a368 <buf>
    ...
    3e30:	02c50513          	addi	a0,a0,44 # 8e58 <schedule_wrr+0x142e>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3e58:	02458593          	addi	a1,a1,36 # 8e78 <schedule_wrr+0x144e>
    3e5c:	00005517          	auipc	a0,0x5
    3e60:	f9450513          	addi	a0,a0,-108 # 8df0 <schedule_wrr+0x13c6>
    ...
    3e78:	01450513          	addi	a0,a0,20 # 8e88 <schedule_wrr+0x145e>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3e92:	f6250513          	addi	a0,a0,-158 # 8df0 <schedule_wrr+0x13c6>
    ...
    3eaa:	00a50513          	addi	a0,a0,10 # 8eb0 <schedule_wrr+0x1486>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3ec6:	f2e50513          	addi	a0,a0,-210 # 8df0 <schedule_wrr+0x13c6>
    ...
    3ee0:	ff450513          	addi	a0,a0,-12 # 8ed0 <schedule_wrr+0x14a6>
  ...
  if(chdir("dd") != 0){
    ...
    3efa:	e5a50513          	addi	a0,a0,-422 # 8d50 <schedule_wrr+0x1326>
    ...
    3f12:	fea50513          	addi	a0,a0,-22 # 8ef8 <schedule_wrr+0x14ce>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3f2c:	fe850513          	addi	a0,a0,-24 # 8f10 <schedule_wrr+0x14e6>
    ...
    3f44:	fe050513          	addi	a0,a0,-32 # 8f20 <schedule_wrr+0x14f6>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3f5e:	fe650513          	addi	a0,a0,-26 # 8f40 <schedule_wrr+0x1516>
    ...
    3f76:	fde50513          	addi	a0,a0,-34 # 8f50 <schedule_wrr+0x1526>
  ...
  if(chdir("./..") != 0){
    ...
    3f90:	fe450513          	addi	a0,a0,-28 # 8f70 <schedule_wrr+0x1546>
    ...
    3fa8:	fd450513          	addi	a0,a0,-44 # 8f78 <schedule_wrr+0x154e>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3fc4:	eb850513          	addi	a0,a0,-328 # 8e78 <schedule_wrr+0x144e>
  ...
  if(fd < 0){
    ...
    3fe8:	fac50513          	addi	a0,a0,-84 # 8f90 <schedule_wrr+0x1566>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    4008:	36458593          	addi	a1,a1,868 # a368 <buf>
    400c:	853e                	mv	a0,a5
    ...
    4028:	f8c50513          	addi	a0,a0,-116 # 8fb0 <schedule_wrr+0x1586>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    4052:	da250513          	addi	a0,a0,-606 # 8df0 <schedule_wrr+0x13c6>
    ...
    406c:	f6850513          	addi	a0,a0,-152 # 8fd0 <schedule_wrr+0x15a6>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    408a:	f7a50513          	addi	a0,a0,-134 # 9000 <schedule_wrr+0x15d6>
    ...
    40a4:	f7050513          	addi	a0,a0,-144 # 9010 <schedule_wrr+0x15e6>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    40c2:	f7250513          	addi	a0,a0,-142 # 9030 <schedule_wrr+0x1606>
    ...
    40dc:	f6850513          	addi	a0,a0,-152 # 9040 <schedule_wrr+0x1616>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    40fa:	c5a50513          	addi	a0,a0,-934 # 8d50 <schedule_wrr+0x1326>
    ...
    4114:	f5050513          	addi	a0,a0,-176 # 9060 <schedule_wrr+0x1636>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    4130:	c2450513          	addi	a0,a0,-988 # 8d50 <schedule_wrr+0x1326>
    ...
    414a:	f3a50513          	addi	a0,a0,-198 # 9080 <schedule_wrr+0x1656>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    4166:	bee50513          	addi	a0,a0,-1042 # 8d50 <schedule_wrr+0x1326>
    ...
    4180:	f2450513          	addi	a0,a0,-220 # 90a0 <schedule_wrr+0x1676>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    419a:	f2a58593          	addi	a1,a1,-214 # 90c0 <schedule_wrr+0x1696>
    419e:	00005517          	auipc	a0,0x5
    41a2:	e6250513          	addi	a0,a0,-414 # 9000 <schedule_wrr+0x15d6>
    ...
    41ba:	f1a50513          	addi	a0,a0,-230 # 90d0 <schedule_wrr+0x16a6>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    41d4:	ef058593          	addi	a1,a1,-272 # 90c0 <schedule_wrr+0x1696>
    41d8:	00005517          	auipc	a0,0x5
    41dc:	e5850513          	addi	a0,a0,-424 # 9030 <schedule_wrr+0x1606>
    ...
    41f4:	f0850513          	addi	a0,a0,-248 # 90f8 <schedule_wrr+0x16ce>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    420e:	c6e58593          	addi	a1,a1,-914 # 8e78 <schedule_wrr+0x144e>
    4212:	00005517          	auipc	a0,0x5
    4216:	b5e50513          	addi	a0,a0,-1186 # 8d70 <schedule_wrr+0x1346>
    ...
    422e:	ef650513          	addi	a0,a0,-266 # 9120 <schedule_wrr+0x16f6>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    4248:	dbc50513          	addi	a0,a0,-580 # 9000 <schedule_wrr+0x15d6>
    ...
    4260:	eec50513          	addi	a0,a0,-276 # 9148 <schedule_wrr+0x171e>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    427a:	dba50513          	addi	a0,a0,-582 # 9030 <schedule_wrr+0x1606>
    ...
    4292:	eda50513          	addi	a0,a0,-294 # 9168 <schedule_wrr+0x173e>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    42ac:	bd050513          	addi	a0,a0,-1072 # 8e78 <schedule_wrr+0x144e>
    ...
    42c4:	ec850513          	addi	a0,a0,-312 # 9188 <schedule_wrr+0x175e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    42de:	d5650513          	addi	a0,a0,-682 # 9030 <schedule_wrr+0x1606>
    ...
    42f6:	ebe50513          	addi	a0,a0,-322 # 91b0 <schedule_wrr+0x1786>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    4310:	cf450513          	addi	a0,a0,-780 # 9000 <schedule_wrr+0x15d6>
    ...
    4328:	eac50513          	addi	a0,a0,-340 # 91d0 <schedule_wrr+0x17a6>
  ...
  if(chdir("dd/ff") == 0){
    ...
    4342:	a3250513          	addi	a0,a0,-1486 # 8d70 <schedule_wrr+0x1346>
    ...
    435a:	e9a50513          	addi	a0,a0,-358 # 91f0 <schedule_wrr+0x17c6>
  ...
  if(chdir("dd/xx") == 0){
    ...
    4374:	ea050513          	addi	a0,a0,-352 # 9210 <schedule_wrr+0x17e6>
    ...
    438c:	e9050513          	addi	a0,a0,-368 # 9218 <schedule_wrr+0x17ee>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    43a6:	ad650513          	addi	a0,a0,-1322 # 8e78 <schedule_wrr+0x144e>
    ...
    43be:	af650513          	addi	a0,a0,-1290 # 8eb0 <schedule_wrr+0x1486>
  ...
  if(unlink("dd/ff") != 0){
    ...
    43d8:	99c50513          	addi	a0,a0,-1636 # 8d70 <schedule_wrr+0x1346>
    ...
    43f0:	e4c50513          	addi	a0,a0,-436 # 9238 <schedule_wrr+0x180e>
  ...
  if(unlink("dd") == 0){
    ...
    440a:	94a50513          	addi	a0,a0,-1718 # 8d50 <schedule_wrr+0x1326>
    ...
    4422:	e3a50513          	addi	a0,a0,-454 # 9258 <schedule_wrr+0x182e>
  ...
  if(unlink("dd/dd") < 0){
    ...
    443c:	e4850513          	addi	a0,a0,-440 # 9280 <schedule_wrr+0x1856>
    ...
    4456:	e3650513          	addi	a0,a0,-458 # 9288 <schedule_wrr+0x185e>
  ...
  if(unlink("dd") < 0){
    ...
    4470:	8e450513          	addi	a0,a0,-1820 # 8d50 <schedule_wrr+0x1326>
    ...
    448a:	e2250513          	addi	a0,a0,-478 # 92a8 <schedule_wrr+0x187e>
...
bigwrite(char *s)
{
  ...
  unlink("bigwrite");
    ...
    44ba:	8a250513          	addi	a0,a0,-1886 # 7d58 <schedule_wrr+0x32e>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    44d8:	88450513          	addi	a0,a0,-1916 # 7d58 <schedule_wrr+0x32e>
    ...
    44fc:	dc850513          	addi	a0,a0,-568 # 92c0 <schedule_wrr+0x1896>
    ...
    4526:	e4658593          	addi	a1,a1,-442 # a368 <buf>
    452a:	853e                	mv	a0,a5
    ...
    455e:	d8650513          	addi	a0,a0,-634 # 92e0 <schedule_wrr+0x18b6>
    ...
    459e:	7be50513          	addi	a0,a0,1982 # 7d58 <schedule_wrr+0x32e>
...
manywrites(char *s)
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    460a:	ab250513          	addi	a0,a0,-1358 # 80b8 <schedule_wrr+0x68e>
    ...
    4694:	c6850513          	addi	a0,a0,-920 # 92f8 <schedule_wrr+0x18ce>
    ...
    46be:	cae58593          	addi	a1,a1,-850 # a368 <buf>
    46c2:	853e                	mv	a0,a5
    ...
    46f6:	bee50513          	addi	a0,a0,-1042 # 92e0 <schedule_wrr+0x18b6>
...
bigfile(char *s)
{
  ...
  if(fd < 0){
    ...
    4826:	afe50513          	addi	a0,a0,-1282 # 9320 <schedule_wrr+0x18f6>
  ...
  for(i = 0; i < N; i++){
    ...
    4850:	b1c50513          	addi	a0,a0,-1252 # a368 <buf>
    ...
    4868:	b0458593          	addi	a1,a1,-1276 # a368 <buf>
    486c:	853e                	mv	a0,a5
    ...
    488a:	aba50513          	addi	a0,a0,-1350 # 9340 <schedule_wrr+0x1916>
  ...
  fd = open("bigfile.dat", 0);
    ...
    48cc:	a4850513          	addi	a0,a0,-1464 # 9310 <schedule_wrr+0x18e6>
  ...
  if(fd < 0){
    ...
    48f0:	a7450513          	addi	a0,a0,-1420 # 9360 <schedule_wrr+0x1936>
  ...
  for(i = 0; ; i++){
    ...
    491a:	a5258593          	addi	a1,a1,-1454 # a368 <buf>
    491e:	853e                	mv	a0,a5
    ...
    4940:	a4450513          	addi	a0,a0,-1468 # 9380 <schedule_wrr+0x1956>
    ...
    4976:	a2e50513          	addi	a0,a0,-1490 # 93a0 <schedule_wrr+0x1976>
    ...
    4990:	9dc78793          	addi	a5,a5,-1572 # a368 <buf>
    ...
    49b6:	9b678793          	addi	a5,a5,-1610 # a368 <buf>
    ...
    49e0:	9dc50513          	addi	a0,a0,-1572 # 93b8 <schedule_wrr+0x198e>
  ...
  if(total != N*SZ){
    ...
    4a3a:	9a250513          	addi	a0,a0,-1630 # 93d8 <schedule_wrr+0x19ae>
  ...
  unlink("bigfile.dat");
    ...
    4a54:	8c050513          	addi	a0,a0,-1856 # 9310 <schedule_wrr+0x18e6>
...
fourteen(char *s)
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    4a7a:	98250513          	addi	a0,a0,-1662 # 93f8 <schedule_wrr+0x19ce>
    ...
    4a92:	97a50513          	addi	a0,a0,-1670 # 9408 <schedule_wrr+0x19de>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    4aac:	98850513          	addi	a0,a0,-1656 # 9430 <schedule_wrr+0x1a06>
    ...
    4ac4:	99050513          	addi	a0,a0,-1648 # 9450 <schedule_wrr+0x1a26>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    4ae2:	9aa50513          	addi	a0,a0,-1622 # 9488 <schedule_wrr+0x1a5e>
  ...
  if(fd < 0){
    ...
    4b06:	9b650513          	addi	a0,a0,-1610 # 94b8 <schedule_wrr+0x1a8e>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    4b30:	9d450513          	addi	a0,a0,-1580 # 9500 <schedule_wrr+0x1ad6>
  ...
  if(fd < 0){
    ...
    4b54:	9e050513          	addi	a0,a0,-1568 # 9530 <schedule_wrr+0x1b06>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    4b7c:	9f850513          	addi	a0,a0,-1544 # 9570 <schedule_wrr+0x1b46>
    ...
    4b94:	a0050513          	addi	a0,a0,-1536 # 9590 <schedule_wrr+0x1b66>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    4bae:	a1e50513          	addi	a0,a0,-1506 # 95c8 <schedule_wrr+0x1b9e>
    ...
    4bc6:	a2650513          	addi	a0,a0,-1498 # 95e8 <schedule_wrr+0x1bbe>
...
rmdot(char *s)
{
  ...
  if(mkdir("dots") != 0){
    ...
    4c56:	9ce50513          	addi	a0,a0,-1586 # 9620 <schedule_wrr+0x1bf6>
    ...
    4c6e:	9be50513          	addi	a0,a0,-1602 # 9628 <schedule_wrr+0x1bfe>
  ...
  if(chdir("dots") != 0){
    ...
    4c88:	99c50513          	addi	a0,a0,-1636 # 9620 <schedule_wrr+0x1bf6>
    ...
    4ca0:	9a450513          	addi	a0,a0,-1628 # 9640 <schedule_wrr+0x1c16>
  ...
  if(unlink(".") == 0){
    ...
    4cba:	f5250513          	addi	a0,a0,-174 # 8c08 <schedule_wrr+0x11de>
    ...
    4cd2:	98a50513          	addi	a0,a0,-1654 # 9658 <schedule_wrr+0x1c2e>
  ...
  if(unlink("..") == 0){
    ...
    4cec:	9d850513          	addi	a0,a0,-1576 # 86c0 <schedule_wrr+0xc96>
    ...
    4d04:	97050513          	addi	a0,a0,-1680 # 9670 <schedule_wrr+0x1c46>
  ...
  if(chdir("/") != 0){
    ...
    4d1e:	6be50513          	addi	a0,a0,1726 # 83d8 <schedule_wrr+0x9ae>
    ...
    4d36:	6ae50513          	addi	a0,a0,1710 # 83e0 <schedule_wrr+0x9b6>
  ...
  if(unlink("dots/.") == 0){
    ...
    4d50:	93c50513          	addi	a0,a0,-1732 # 9688 <schedule_wrr+0x1c5e>
    ...
    4d68:	92c50513          	addi	a0,a0,-1748 # 9690 <schedule_wrr+0x1c66>
  ...
  if(unlink("dots/..") == 0){
    ...
    4d82:	93250513          	addi	a0,a0,-1742 # 96b0 <schedule_wrr+0x1c86>
    ...
    4d9a:	92250513          	addi	a0,a0,-1758 # 96b8 <schedule_wrr+0x1c8e>
  ...
  if(unlink("dots") != 0){
    ...
    4db4:	87050513          	addi	a0,a0,-1936 # 9620 <schedule_wrr+0x1bf6>
    ...
    4dcc:	91050513          	addi	a0,a0,-1776 # 96d8 <schedule_wrr+0x1cae>
...
dirfile(char *s)
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4e00:	08450513          	addi	a0,a0,132 # 7e80 <schedule_wrr+0x456>
  ...
  if(fd < 0){
    ...
    4e24:	8d850513          	addi	a0,a0,-1832 # 96f8 <schedule_wrr+0x1cce>
  ...
  if(chdir("dirfile") == 0){
    ...
    4e4c:	03850513          	addi	a0,a0,56 # 7e80 <schedule_wrr+0x456>
    ...
    4e64:	8b850513          	addi	a0,a0,-1864 # 9718 <schedule_wrr+0x1cee>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4e80:	8bc50513          	addi	a0,a0,-1860 # 9738 <schedule_wrr+0x1d0e>
  ...
  if(fd >= 0){
    ...
    4ea4:	8a850513          	addi	a0,a0,-1880 # 9748 <schedule_wrr+0x1d1e>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4ec2:	87a50513          	addi	a0,a0,-1926 # 9738 <schedule_wrr+0x1d0e>
  ...
  if(fd >= 0){
    ...
    4ee6:	86650513          	addi	a0,a0,-1946 # 9748 <schedule_wrr+0x1d1e>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4f00:	83c50513          	addi	a0,a0,-1988 # 9738 <schedule_wrr+0x1d0e>
    ...
    4f18:	85c50513          	addi	a0,a0,-1956 # 9770 <schedule_wrr+0x1d46>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4f32:	80a50513          	addi	a0,a0,-2038 # 9738 <schedule_wrr+0x1d0e>
    ...
    4f4a:	85250513          	addi	a0,a0,-1966 # 9798 <schedule_wrr+0x1d6e>
  ...
  if(link("README", "dirfile/xx") == 0){
    4f60:	00004597          	auipc	a1,0x4
    4f64:	7d858593          	addi	a1,a1,2008 # 9738 <schedule_wrr+0x1d0e>
    4f68:	00003517          	auipc	a0,0x3
    4f6c:	00050513          	mv	a0,a0
    ...
    4f84:	84050513          	addi	a0,a0,-1984 # 97c0 <schedule_wrr+0x1d96>
  ...
  if(unlink("dirfile") != 0){
    ...
    4f9e:	ee650513          	addi	a0,a0,-282 # 7e80 <schedule_wrr+0x456>
    ...
    4fb6:	83650513          	addi	a0,a0,-1994 # 97e8 <schedule_wrr+0x1dbe>
  ...
  fd = open(".", O_RDWR);
    ...
    4fd2:	c3a50513          	addi	a0,a0,-966 # 8c08 <schedule_wrr+0x11de>
  ...
  if(fd >= 0){
    ...
    4ff6:	81650513          	addi	a0,a0,-2026 # 9808 <schedule_wrr+0x1dde>
  ...
  fd = open(".", 0);
    ...
    5012:	bfa50513          	addi	a0,a0,-1030 # 8c08 <schedule_wrr+0x11de>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    502e:	f8e58593          	addi	a1,a1,-114 # 7fb8 <schedule_wrr+0x58e>
    5032:	853e                	mv	a0,a5
    ...
    5046:	00004517          	auipc	a0,0x4
    504a:	7ea50513          	addi	a0,a0,2026 # 9830 <schedule_wrr+0x1e06>
...
iref(char *s)
{
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    if(mkdir("irefd") != 0){
    508a:	00004517          	auipc	a0,0x4
    508e:	7be50513          	addi	a0,a0,1982 # 9848 <schedule_wrr+0x1e1e>
    ...
    50a2:	00004517          	auipc	a0,0x4
    50a6:	7ae50513          	addi	a0,a0,1966 # 9850 <schedule_wrr+0x1e26>
    ...
    if(chdir("irefd") != 0){
    50bc:	00004517          	auipc	a0,0x4
    50c0:	78c50513          	addi	a0,a0,1932 # 9848 <schedule_wrr+0x1e1e>
    ...
    50d4:	00004517          	auipc	a0,0x4
    50d8:	79450513          	addi	a0,a0,1940 # 9868 <schedule_wrr+0x1e3e>
    ...
    50f2:	79250513          	addi	a0,a0,1938 # 9880 <schedule_wrr+0x1e56>
    50f6:	00002097          	auipc	ra,0x2
    50fa:	fec080e7          	jalr	-20(ra) # 70e2 <mkdir>
    link("README", "");
    50fe:	00004597          	auipc	a1,0x4
    5102:	78258593          	addi	a1,a1,1922 # 9880 <schedule_wrr+0x1e56>
    5106:	00003517          	auipc	a0,0x3
    510a:	e6250513          	addi	a0,a0,-414 # 7f68 <schedule_wrr+0x53e>
    510e:	00002097          	auipc	ra,0x2
    5112:	fcc080e7          	jalr	-52(ra) # 70da <link>
    fd = open("", O_CREATE);
    5116:	20000593          	li	a1,512
    511a:	00004517          	auipc	a0,0x4
    511e:	76650513          	addi	a0,a0,1894 # 9880 <schedule_wrr+0x1e56>
    ...
    5150:	f4450513          	addi	a0,a0,-188 # 8090 <schedule_wrr+0x666>
    ...
    517e:	f1650513          	addi	a0,a0,-234 # 8090 <schedule_wrr+0x666>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    51ae:	51650513          	addi	a0,a0,1302 # 86c0 <schedule_wrr+0xc96>
    51b2:	00002097          	auipc	ra,0x2
    51b6:	f38080e7          	jalr	-200(ra) # 70ea <chdir>
    unlink("irefd");
    51ba:	00004517          	auipc	a0,0x4
    51be:	68e50513          	addi	a0,a0,1678 # 9848 <schedule_wrr+0x1e1e>
  ...
  chdir("/");
    ...
    51e8:	1f450513          	addi	a0,a0,500 # 83d8 <schedule_wrr+0x9ae>
...
forktest(char *s)
{
  ...
  if (n == 0) {
    ...
    5268:	62450513          	addi	a0,a0,1572 # 9888 <schedule_wrr+0x1e5e>
  ...
  if(n == N){
    ...
    5296:	60e50513          	addi	a0,a0,1550 # 98a0 <schedule_wrr+0x1e76>
  ...
  for(; n > 0; n--){
    ...
    52c4:	60850513          	addi	a0,a0,1544 # 98c8 <schedule_wrr+0x1e9e>
  ...
  if(wait(0) != -1){
    ...
    530a:	5da50513          	addi	a0,a0,1498 # 98e0 <schedule_wrr+0x1eb6>
...
sbrkbasic(char *s)
{
  ...
  if(pid < 0){
    ...
    5352:	5aa50513          	addi	a0,a0,1450 # 98f8 <schedule_wrr+0x1ece>
  ...
  if(xstatus == 1){
    ...
    53f4:	52850513          	addi	a0,a0,1320 # 9918 <schedule_wrr+0x1eee>
  ...
  for(i = 0; i < 5000; i++){
    ...
    544a:	4f250513          	addi	a0,a0,1266 # 9938 <schedule_wrr+0x1f0e>
    ...
    *b = 1;
    ...
    5464:	4705                	li	a4,1
    5466:	00e78023          	sb	a4,0(a5) # 40000000 <__BSS_END__+0x3ffef468>
    a = b + 1;
  ...
  if(pid < 0){
    ...
    54b0:	4ac50513          	addi	a0,a0,1196 # 9958 <schedule_wrr+0x1f2e>
  ...
  if(c != a + 1){
    ...
    54f8:	48450513          	addi	a0,a0,1156 # 9978 <schedule_wrr+0x1f4e>
...
sbrkmuch(char *s)
{
  ...
  if (p != a) {
    ...
    559c:	40050513          	addi	a0,a0,1024 # 9998 <schedule_wrr+0x1f6e>
  ...
  *lastaddr = 99;
    ...
    55fe:	00e78023          	sb	a4,0(a5) # 6400000 <__BSS_END__+0x63ef468>
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    5630:	3b450513          	addi	a0,a0,948 # 99e0 <schedule_wrr+0x1fb6>
  ...
  if(c != a - PGSIZE){
    ...
    5674:	39050513          	addi	a0,a0,912 # 9a00 <schedule_wrr+0x1fd6>
  ...
  if(c != a || sbrk(0) != a + PGSIZE){
    ...
    56da:	36a50513          	addi	a0,a0,874 # 9a40 <schedule_wrr+0x2016>
  ...
  if(*lastaddr == 99){
    ...
    570a:	36a50513          	addi	a0,a0,874 # 9a70 <schedule_wrr+0x2046>
  ...
  if(c != a){
    ...
    576c:	34050513          	addi	a0,a0,832 # 9aa8 <schedule_wrr+0x207e>
...
kernmem(char *s)
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    57c2:	b2250513          	addi	a0,a0,-1246 # 82e0 <schedule_wrr+0x8b6>
    ...
    57f8:	2dc50513          	addi	a0,a0,732 # 9ad0 <schedule_wrr+0x20a6>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    5838:	35078793          	addi	a5,a5,848 # c350 <__global_pointer$+0x17f0>
    ...
    584c:	47f78793          	addi	a5,a5,1151 # 1003d47f <__BSS_END__+0x1002c8e7>
...
sbrkfail(char *s)
{
  ...
  if(pipe(fds) != 0){
    ...
    5886:	ef650513          	addi	a0,a0,-266 # 8778 <schedule_wrr+0xd4e>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    58fe:	6be58593          	addi	a1,a1,1726 # 7fb8 <schedule_wrr+0x58e>
    5902:	853e                	mv	a0,a5
  ...
  if(c == (char*)0xffffffffffffffffL){
    ...
    59da:	11a50513          	addi	a0,a0,282 # 9af0 <schedule_wrr+0x20c6>
  ...
  if(pid < 0){
    ...
    5a10:	8d450513          	addi	a0,a0,-1836 # 82e0 <schedule_wrr+0x8b6>
  ...
  if(pid == 0){
    ...
    5a96:	07e50513          	addi	a0,a0,126 # 9b10 <schedule_wrr+0x20e6>
...
sbrkarg(char *s)
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    5b08:	03c50513          	addi	a0,a0,60 # 9b40 <schedule_wrr+0x2116>
  ...
  unlink("sbrk");
    ...
    5b1e:	02650513          	addi	a0,a0,38 # 9b40 <schedule_wrr+0x2116>
  ...
  if(fd < 0)  {
    ...
    5b3c:	01050513          	addi	a0,a0,16 # 9b48 <schedule_wrr+0x211e>
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    5b7e:	fe650513          	addi	a0,a0,-26 # 9b60 <schedule_wrr+0x2136>
  ...
  if(pipe((int *) a) != 0){
    ...
    5bc8:	bb450513          	addi	a0,a0,-1100 # 8778 <schedule_wrr+0xd4e>
...
validatetest(char *s)
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    5c0c:	f7050513          	addi	a0,a0,-144 # 9b78 <schedule_wrr+0x214e>
    ...
    5c2a:	f6250513          	addi	a0,a0,-158 # 9b88 <schedule_wrr+0x215e>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    5c7e:	6ee70713          	addi	a4,a4,1774 # d368 <uninit>
    ...
    5c96:	f1650513          	addi	a0,a0,-234 # 9ba8 <schedule_wrr+0x217e>
...
bigargtest(char *s)
{
  ...
  unlink("bigarg-ok");
    ...
    5ce2:	ee250513          	addi	a0,a0,-286 # 9bc0 <schedule_wrr+0x2196>
  ...
  if(pid == 0){
    ...
    5d0e:	d7670713          	addi	a4,a4,-650 # 10a80 <args.1845>
    5d12:	fec42783          	lw	a5,-20(s0)
    5d16:	078e                	slli	a5,a5,0x3
    5d18:	97ba                	add	a5,a5,a4
    5d1a:	00004717          	auipc	a4,0x4
    5d1e:	eb670713          	addi	a4,a4,-330 # 9bd0 <schedule_wrr+0x21a6>
    ...
    5da4:	f1050513          	addi	a0,a0,-240 # 9cb0 <schedule_wrr+0x2286>
  ...
  fd = open("bigarg-ok", 0);
    ...
    5de2:	de250513          	addi	a0,a0,-542 # 9bc0 <schedule_wrr+0x2196>
  ...
  if(fd < 0){
    ...
    5e06:	ece50513          	addi	a0,a0,-306 # 9cd0 <schedule_wrr+0x22a6>
...
fsfull()
{
  ...
  printf("fsfull test\n");
    ...
    5e44:	eb050513          	addi	a0,a0,-336 # 9cf0 <schedule_wrr+0x22c6>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5ef6:	e0e50513          	addi	a0,a0,-498 # 9d00 <schedule_wrr+0x22d6>
    ...
    5f2e:	de650513          	addi	a0,a0,-538 # 9d10 <schedule_wrr+0x22e6>
    ...
    5f4c:	42058593          	addi	a1,a1,1056 # a368 <buf>
    5f50:	853e                	mv	a0,a5
    ...
    5f96:	d8e50513          	addi	a0,a0,-626 # 9d20 <schedule_wrr+0x22f6>
  ...
  printf("fsfull test finished\n");
    ...
    6086:	cae50513          	addi	a0,a0,-850 # 9d30 <schedule_wrr+0x2306>
...
void argptest(char *s)
{
  ...
  fd = open("init", O_RDONLY);
    ...
    60ae:	c9e50513          	addi	a0,a0,-866 # 9d48 <schedule_wrr+0x231e>
  ...
  if (fd < 0) {
    ...
    60d2:	22a50513          	addi	a0,a0,554 # 82f8 <schedule_wrr+0x8ce>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    612c:	23878793          	addi	a5,a5,568 # a360 <randstate>
    6130:	6398                	ld	a4,0(a5)
    6132:	001967b7          	lui	a5,0x196
    6136:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x185a75>
    613a:	02f70733          	mul	a4,a4,a5
    613e:	3c6ef7b7          	lui	a5,0x3c6ef
    6142:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6de7c7>
    6146:	973e                	add	a4,a4,a5
    6148:	00004797          	auipc	a5,0x4
    614c:	21878793          	addi	a5,a5,536 # a360 <randstate>
    6150:	e398                	sd	a4,0(a5)
  return randstate;
    6152:	00004797          	auipc	a5,0x4
    6156:	20e78793          	addi	a5,a5,526 # a360 <randstate>
...
stacktest(char *s)
{
  ...
  if(pid == 0) {
    ...
    61a6:	0007c783          	lbu	a5,0(a5) # fffffffffffff000 <__BSS_END__+0xfffffffffffee468>
    61aa:	2781                	sext.w	a5,a5
    61ac:	863e                	mv	a2,a5
    61ae:	fc843583          	ld	a1,-56(s0)
    61b2:	00004517          	auipc	a0,0x4
    61b6:	b9e50513          	addi	a0,a0,-1122 # 9d50 <schedule_wrr+0x2326>
    ...
    61de:	10650513          	addi	a0,a0,262 # 82e0 <schedule_wrr+0x8b6>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    623e:	0c678793          	addi	a5,a5,198 # a300 <schedule_wrr+0x28d6>
  ...
  pipe((int*)0xeaeb0b5b00002f5e);
    ...
    6254:	0b078793          	addi	a5,a5,176 # a300 <schedule_wrr+0x28d6>
...
sbrkbugs(char *s)
{
  ...
  if(pid < 0){
    ...
    6296:	e2650513          	addi	a0,a0,-474 # 80b8 <schedule_wrr+0x68e>
  ...
  if(pid < 0){
    ...
    6308:	db450513          	addi	a0,a0,-588 # 80b8 <schedule_wrr+0x68e>
  ...
  if(pid < 0){
    ...
    6380:	d3c50513          	addi	a0,a0,-708 # 80b8 <schedule_wrr+0x68e>
...
badwrite(char *s)
{
  ...
  unlink("junk");
    ...
    6404:	97850513          	addi	a0,a0,-1672 # 9d78 <schedule_wrr+0x234e>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    641e:	95e50513          	addi	a0,a0,-1698 # 9d78 <schedule_wrr+0x234e>
    ...
    643e:	94650513          	addi	a0,a0,-1722 # 9d80 <schedule_wrr+0x2356>
    ...
    647c:	90050513          	addi	a0,a0,-1792 # 9d78 <schedule_wrr+0x234e>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    64aa:	8d250513          	addi	a0,a0,-1838 # 9d78 <schedule_wrr+0x234e>
  ...
  if(fd < 0){
    ...
    64ca:	8ba50513          	addi	a0,a0,-1862 # 9d80 <schedule_wrr+0x2356>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    64ea:	ad258593          	addi	a1,a1,-1326 # 7fb8 <schedule_wrr+0x58e>
    64ee:	853e                	mv	a0,a5
    ...
    6506:	89650513          	addi	a0,a0,-1898 # 9d98 <schedule_wrr+0x236e>
  ...
  unlink("junk");
    ...
    652e:	84e50513          	addi	a0,a0,-1970 # 9d78 <schedule_wrr+0x234e>
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    656c:	b6050513          	addi	a0,a0,-1184 # 80c8 <schedule_wrr+0x69e>
  ...
  for(int i = 0; i < 50000; i++){
    ...
    658c:	34f78793          	addi	a5,a5,847 # c34f <__global_pointer$+0x17ef>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    65cc:	af050513          	addi	a0,a0,-1296 # 80b8 <schedule_wrr+0x68e>
    ...
    660e:	873e                	mv	a4,a5
    6610:	4785                	li	a5,1
    6612:	00f70023          	sb	a5,0(a4) # b000 <__global_pointer$+0x4a0>
      while(1){
    ...
    6652:	a7a78793          	addi	a5,a5,-1414 # 80c8 <schedule_wrr+0x69e>
    6656:	fcf43023          	sd	a5,-64(s0)
    665a:	00002797          	auipc	a5,0x2
    665e:	95e78793          	addi	a5,a5,-1698 # 7fb8 <schedule_wrr+0x58e>
    ...
    6674:	a5850513          	addi	a0,a0,-1448 # 80c8 <schedule_wrr+0x69e>
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    66d6:	6d650513          	addi	a0,a0,1750 # 9da8 <schedule_wrr+0x237e>
  ...
  if(pid < 0){
    ...
    6708:	6c450513          	addi	a0,a0,1732 # 9dc8 <schedule_wrr+0x239e>
  ...
  if(pid == 0){
    ...
    676a:	85258593          	addi	a1,a1,-1966 # 7fb8 <schedule_wrr+0x58e>
    676e:	853e                	mv	a0,a5
    ...
    6786:	66650513          	addi	a0,a0,1638 # 9de8 <schedule_wrr+0x23be>
  ...
  while(1){
    ...
    67e4:	62850513          	addi	a0,a0,1576 # 9e08 <schedule_wrr+0x23de>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    684e:	5de50513          	addi	a0,a0,1502 # 9e28 <schedule_wrr+0x23fe>
  ...
  if((pid = fork()) < 0) {
    ...
    6876:	5c650513          	addi	a0,a0,1478 # 9e38 <schedule_wrr+0x240e>
  ...
  if(pid == 0) {
    ...
    68c0:	59450513          	addi	a0,a0,1428 # 9e50 <schedule_wrr+0x2426>
    ...
    68d2:	58a50513          	addi	a0,a0,1418 # 9e58 <schedule_wrr+0x242e>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    6932:	53258593          	addi	a1,a1,1330 # 9e60 <schedule_wrr+0x2436>
    6936:	853e                	mv	a0,a5
    ...
    6966:	50658593          	addi	a1,a1,1286 # 9e68 <schedule_wrr+0x243e>
    696a:	853e                	mv	a0,a5
    ...
    69c2:	4b250513          	addi	a0,a0,1202 # 9e70 <schedule_wrr+0x2446>
  ...
  struct test {
    ...
    69dc:	57870713          	addi	a4,a4,1400 # 9f50 <schedule_wrr+0x2526>
  ...
  if(continuous){
    ...
    6a04:	49850513          	addi	a0,a0,1176 # 9e98 <schedule_wrr+0x246e>
    ...
    6a6e:	44e50513          	addi	a0,a0,1102 # 9eb8 <schedule_wrr+0x248e>
    ...
    6ac4:	41050513          	addi	a0,a0,1040 # 9ed0 <schedule_wrr+0x24a6>
  ...
  printf("usertests starting\n");
    ...
    6aec:	40850513          	addi	a0,a0,1032 # 9ef0 <schedule_wrr+0x24c6>
  ...
  if(fail){
    ...
    6b76:	34650513          	addi	a0,a0,838 # 9eb8 <schedule_wrr+0x248e>
    ...
    6bba:	35250513          	addi	a0,a0,850 # 9f08 <schedule_wrr+0x24de>
    ...
    6bd4:	36850513          	addi	a0,a0,872 # 9f38 <schedule_wrr+0x250e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    71e2:	16a68693          	addi	a3,a3,362 # a348 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    72bc:	09070713          	addi	a4,a4,144 # a348 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    747c:	e9078793          	addi	a5,a5,-368 # a308 <schedule_wrr+0x28de>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    7628:	56c78793          	addi	a5,a5,1388 # 10b90 <freep>
  ...
  freep = p;
    ...
    7720:	47478793          	addi	a5,a5,1140 # 10b90 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
    ...
    77a2:	3f278793          	addi	a5,a5,1010 # 10b90 <freep>
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    77d4:	3c078793          	addi	a5,a5,960 # 10b90 <freep>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    7892:	30278793          	addi	a5,a5,770 # 10b90 <freep>
    ...
    78a8:	2ec78793          	addi	a5,a5,748 # 10b90 <freep>
...
0000000000007966 <schedule_default>:
#define NULL 0
...
{
    7966:	715d                	addi	sp,sp,-80
    7968:	e4a2                	sd	s0,72(sp)
    796a:	e0a6                	sd	s1,64(sp)
    796c:	0880                	addi	s0,sp,80
    796e:	84aa                	mv	s1,a0
    struct thread *thread_with_smallest_id = NULL;
    7970:	fe043423          	sd	zero,-24(s0)
    struct thread *th = NULL;
    7974:	fe043023          	sd	zero,-32(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    7978:	649c                	ld	a5,8(s1)
    797a:	639c                	ld	a5,0(a5)
    797c:	fcf43c23          	sd	a5,-40(s0)
    7980:	fd843783          	ld	a5,-40(s0)
    7984:	fd878793          	addi	a5,a5,-40
    7988:	fef43023          	sd	a5,-32(s0)
    798c:	a81d                	j	79c2 <schedule_default+0x5c>
    {
        if (thread_with_smallest_id == NULL || th->ID < thread_with_smallest_id->ID)
    798e:	fe843783          	ld	a5,-24(s0)
    7992:	cb89                	beqz	a5,79a4 <schedule_default+0x3e>
    7994:	fe043783          	ld	a5,-32(s0)
    7998:	5fd8                	lw	a4,60(a5)
    799a:	fe843783          	ld	a5,-24(s0)
    799e:	5fdc                	lw	a5,60(a5)
    79a0:	00f75663          	bge	a4,a5,79ac <schedule_default+0x46>
            thread_with_smallest_id = th;
    79a4:	fe043783          	ld	a5,-32(s0)
    79a8:	fef43423          	sd	a5,-24(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    79ac:	fe043783          	ld	a5,-32(s0)
    79b0:	779c                	ld	a5,40(a5)
    79b2:	fcf43823          	sd	a5,-48(s0)
    79b6:	fd043783          	ld	a5,-48(s0)
    79ba:	fd878793          	addi	a5,a5,-40
    79be:	fef43023          	sd	a5,-32(s0)
    79c2:	fe043783          	ld	a5,-32(s0)
    79c6:	02878713          	addi	a4,a5,40
    79ca:	649c                	ld	a5,8(s1)
    79cc:	fcf711e3          	bne	a4,a5,798e <schedule_default+0x28>
    }

    struct threads_sched_result r;
    if (thread_with_smallest_id != NULL)
    79d0:	fe843783          	ld	a5,-24(s0)
    79d4:	cf89                	beqz	a5,79ee <schedule_default+0x88>
    {
        r.scheduled_thread_list_member = &thread_with_smallest_id->thread_list;
    79d6:	fe843783          	ld	a5,-24(s0)
    79da:	02878793          	addi	a5,a5,40
    79de:	faf43823          	sd	a5,-80(s0)
        r.allocated_time = thread_with_smallest_id->remaining_time;
    79e2:	fe843783          	ld	a5,-24(s0)
    79e6:	4fbc                	lw	a5,88(a5)
    79e8:	faf42c23          	sw	a5,-72(s0)
    79ec:	a039                	j	79fa <schedule_default+0x94>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    79ee:	649c                	ld	a5,8(s1)
    79f0:	faf43823          	sd	a5,-80(s0)
        r.allocated_time = 1;
    79f4:	4785                	li	a5,1
    79f6:	faf42c23          	sw	a5,-72(s0)
    }

    return r;
    79fa:	fb043783          	ld	a5,-80(s0)
    79fe:	fcf43023          	sd	a5,-64(s0)
    7a02:	fb843783          	ld	a5,-72(s0)
    7a06:	fcf43423          	sd	a5,-56(s0)
    7a0a:	4701                	li	a4,0
    7a0c:	fc043703          	ld	a4,-64(s0)
    7a10:	4781                	li	a5,0
    7a12:	fc843783          	ld	a5,-56(s0)
    7a16:	863a                	mv	a2,a4
    7a18:	86be                	mv	a3,a5
    7a1a:	8732                	mv	a4,a2
    7a1c:	87b6                	mv	a5,a3
    ...
    7a1e:	853a                	mv	a0,a4
    7a20:	85be                	mv	a1,a5
    7a22:	6426                	ld	s0,72(sp)
    7a24:	6486                	ld	s1,64(sp)
    7a26:	6161                	addi	sp,sp,80
    7a28:	8082                	ret

0000000000007a2a <schedule_wrr>:

/* MP3 Part 1 - Non-Real-Time Scheduling */
/* Weighted-Round-Robin Scheduling */
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    7a2a:	7119                	addi	sp,sp,-128
    7a2c:	fc86                	sd	ra,120(sp)
    7a2e:	f8a2                	sd	s0,112(sp)
    7a30:	f4a6                	sd	s1,104(sp)
    7a32:	f0ca                	sd	s2,96(sp)
    7a34:	ecce                	sd	s3,88(sp)
    7a36:	0100                	addi	s0,sp,128
    7a38:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
    7a3a:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
    7a3e:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
    7a42:	00003517          	auipc	a0,0x3
    7a46:	8ce50513          	addi	a0,a0,-1842 # a310 <schedule_wrr+0x28e6>
    7a4a:	00000097          	auipc	ra,0x0
    7a4e:	b76080e7          	jalr	-1162(ra) # 75c0 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
    7a52:	649c                	ld	a5,8(s1)
    7a54:	639c                	ld	a5,0(a5)
    7a56:	faf43c23          	sd	a5,-72(s0)
    7a5a:	fb843783          	ld	a5,-72(s0)
    7a5e:	fd878793          	addi	a5,a5,-40
    7a62:	fcf43023          	sd	a5,-64(s0)
    7a66:	a049                	j	7ae8 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
    7a68:	fc043783          	ld	a5,-64(s0)
    7a6c:	5fdc                	lw	a5,60(a5)
    7a6e:	85be                	mv	a1,a5
    7a70:	00003517          	auipc	a0,0x3
    7a74:	8b050513          	addi	a0,a0,-1872 # a320 <schedule_wrr+0x28f6>
    7a78:	00000097          	auipc	ra,0x0
    7a7c:	b48080e7          	jalr	-1208(ra) # 75c0 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
    7a80:	fc043783          	ld	a5,-64(s0)
    7a84:	4ff8                	lw	a4,92(a5)
    7a86:	fc043783          	ld	a5,-64(s0)
    7a8a:	47fc                	lw	a5,76(a5)
    7a8c:	40f707bb          	subw	a5,a4,a5
    7a90:	2781                	sext.w	a5,a5
    7a92:	85be                	mv	a1,a5
    7a94:	00003517          	auipc	a0,0x3
    7a98:	89c50513          	addi	a0,a0,-1892 # a330 <schedule_wrr+0x2906>
    7a9c:	00000097          	auipc	ra,0x0
    7aa0:	b24080e7          	jalr	-1244(ra) # 75c0 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
    7aa4:	fc843783          	ld	a5,-56(s0)
    7aa8:	c38d                	beqz	a5,7aca <schedule_wrr+0xa0>
    7aaa:	fc043783          	ld	a5,-64(s0)
    7aae:	4fb8                	lw	a4,88(a5)
    7ab0:	fc043783          	ld	a5,-64(s0)
    7ab4:	43fc                	lw	a5,68(a5)
    7ab6:	00f71e63          	bne	a4,a5,7ad2 <schedule_wrr+0xa8>
    7aba:	fc043783          	ld	a5,-64(s0)
    7abe:	5fd8                	lw	a4,60(a5)
    7ac0:	fc843783          	ld	a5,-56(s0)
    7ac4:	5fdc                	lw	a5,60(a5)
    7ac6:	00f75663          	bge	a4,a5,7ad2 <schedule_wrr+0xa8>
            current_thread = th;
    7aca:	fc043783          	ld	a5,-64(s0)
    7ace:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    7ad2:	fc043783          	ld	a5,-64(s0)
    7ad6:	779c                	ld	a5,40(a5)
    7ad8:	faf43423          	sd	a5,-88(s0)
    7adc:	fa843783          	ld	a5,-88(s0)
    7ae0:	fd878793          	addi	a5,a5,-40
    7ae4:	fcf43023          	sd	a5,-64(s0)
    7ae8:	fc043783          	ld	a5,-64(s0)
    7aec:	02878713          	addi	a4,a5,40
    7af0:	649c                	ld	a5,8(s1)
    7af2:	f6f71be3          	bne	a4,a5,7a68 <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    7af6:	40d8                	lw	a4,4(s1)
    7af8:	fc843783          	ld	a5,-56(s0)
    7afc:	47bc                	lw	a5,72(a5)
    7afe:	02f707bb          	mulw	a5,a4,a5
    7b02:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    7b06:	fc843783          	ld	a5,-56(s0)
    7b0a:	4fbc                	lw	a5,88(a5)
    7b0c:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    7b10:	fc843783          	ld	a5,-56(s0)
    7b14:	c795                	beqz	a5,7b40 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
    7b16:	fc843783          	ld	a5,-56(s0)
    7b1a:	02878793          	addi	a5,a5,40
    7b1e:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
    7b22:	fb442603          	lw	a2,-76(s0)
    7b26:	fb042783          	lw	a5,-80(s0)
    7b2a:	0007869b          	sext.w	a3,a5
    7b2e:	0006071b          	sext.w	a4,a2
    7b32:	00d75363          	bge	a4,a3,7b38 <schedule_wrr+0x10e>
    7b36:	87b2                	mv	a5,a2
    7b38:	2781                	sext.w	a5,a5
    7b3a:	f8f42823          	sw	a5,-112(s0)
    7b3e:	a039                	j	7b4c <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    7b40:	649c                	ld	a5,8(s1)
    7b42:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    7b46:	4785                	li	a5,1
    7b48:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    7b4c:	f8843783          	ld	a5,-120(s0)
    7b50:	f8f43c23          	sd	a5,-104(s0)
    7b54:	f9043783          	ld	a5,-112(s0)
    7b58:	faf43023          	sd	a5,-96(s0)
    7b5c:	4701                	li	a4,0
    7b5e:	f9843703          	ld	a4,-104(s0)
    7b62:	4781                	li	a5,0
    7b64:	fa043783          	ld	a5,-96(s0)
    7b68:	893a                	mv	s2,a4
    7b6a:	89be                	mv	s3,a5
    7b6c:	874a                	mv	a4,s2
    7b6e:	87ce                	mv	a5,s3
    ...
    7b70:	853a                	mv	a0,a4
    7b72:	85be                	mv	a1,a5
    7b74:	70e6                	ld	ra,120(sp)
    7b76:	7446                	ld	s0,112(sp)
    7b78:	74a6                	ld	s1,104(sp)
    7b7a:	7906                	ld	s2,96(sp)
    7b7c:	69e6                	ld	s3,88(sp)
    7b7e:	6109                	addi	sp,sp,128
    7b80:	8082                	ret
