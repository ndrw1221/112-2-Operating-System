...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
       ...
       e:	0b650513          	addi	a0,a0,182 # 10c0 <schedule_wrr+0x162>
    ...
    mknod("console", CONSOLE, 0);
      ...
      28:	09c50513          	addi	a0,a0,156 # 10c0 <schedule_wrr+0x162>
      2c:	00000097          	auipc	ra,0x0
      30:	5ca080e7          	jalr	1482(ra) # 5f6 <mknod>
    open("console", O_RDWR);
      34:	4589                	li	a1,2
      36:	00001517          	auipc	a0,0x1
      3a:	08a50513          	addi	a0,a0,138 # 10c0 <schedule_wrr+0x162>
  ...
  for(;;){
    printf("init: starting sh\n");
      ...
      5e:	06e50513          	addi	a0,a0,110 # 10c8 <schedule_wrr+0x16a>
    ...
    if(pid < 0){
      ...
      86:	05e50513          	addi	a0,a0,94 # 10e0 <schedule_wrr+0x182>
    ...
    if(pid == 0){
      ...
      a8:	0cc58593          	addi	a1,a1,204 # 1170 <argv>
      ac:	00001517          	auipc	a0,0x1
      b0:	00c50513          	addi	a0,a0,12 # 10b8 <schedule_wrr+0x15a>
      b4:	00000097          	auipc	ra,0x0
      b8:	532080e7          	jalr	1330(ra) # 5e6 <exec>
      printf("init: exec sh failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	03c50513          	addi	a0,a0,60 # 10f8 <schedule_wrr+0x19a>
    ...
    for(;;){
     ...
     104:	01050513          	addi	a0,a0,16 # 1110 <schedule_wrr+0x1b2>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     716:	a6e68693          	addi	a3,a3,-1426 # 1180 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     7f0:	99470713          	addi	a4,a4,-1644 # 1180 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     9b0:	78478793          	addi	a5,a5,1924 # 1130 <schedule_wrr+0x1d2>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     b5c:	65078793          	addi	a5,a5,1616 # 11a8 <freep>
     b60:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     c54:	55878793          	addi	a5,a5,1368 # 11a8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     cd6:	4d678793          	addi	a5,a5,1238 # 11a8 <freep>
     cda:	639c                	ld	a5,0(a5)
}
     cdc:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     d08:	4a478793          	addi	a5,a5,1188 # 11a8 <freep>
     d0c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     d1c:	48078793          	addi	a5,a5,1152 # 1198 <base>
     d20:	fef43023          	sd	a5,-32(s0)
     d24:	00000797          	auipc	a5,0x0
     d28:	48478793          	addi	a5,a5,1156 # 11a8 <freep>
     d2c:	fe043703          	ld	a4,-32(s0)
     d30:	e398                	sd	a4,0(a5)
     d32:	00000797          	auipc	a5,0x0
     d36:	47678793          	addi	a5,a5,1142 # 11a8 <freep>
     d3a:	6398                	ld	a4,0(a5)
     d3c:	00000797          	auipc	a5,0x0
     d40:	45c78793          	addi	a5,a5,1116 # 1198 <base>
     d44:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     d46:	00000797          	auipc	a5,0x0
     d4a:	45278793          	addi	a5,a5,1106 # 1198 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     dc6:	3e678793          	addi	a5,a5,998 # 11a8 <freep>
    ...
    if(p == freep)
     ...
     ddc:	3d078793          	addi	a5,a5,976 # 11a8 <freep>
     de0:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    struct thread *current_thread = NULL;
     f6e:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
     f72:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
     f76:	00000517          	auipc	a0,0x0
     f7a:	1c250513          	addi	a0,a0,450 # 1138 <schedule_wrr+0x1da>
     f7e:	00000097          	auipc	ra,0x0
     f82:	b76080e7          	jalr	-1162(ra) # af4 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
     f86:	649c                	ld	a5,8(s1)
     f88:	639c                	ld	a5,0(a5)
     f8a:	faf43c23          	sd	a5,-72(s0)
     f8e:	fb843783          	ld	a5,-72(s0)
     f92:	fd878793          	addi	a5,a5,-40
     f96:	fcf43023          	sd	a5,-64(s0)
     f9a:	a049                	j	101c <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
     f9c:	fc043783          	ld	a5,-64(s0)
     fa0:	5fdc                	lw	a5,60(a5)
     fa2:	85be                	mv	a1,a5
     fa4:	00000517          	auipc	a0,0x0
     fa8:	1a450513          	addi	a0,a0,420 # 1148 <schedule_wrr+0x1ea>
     fac:	00000097          	auipc	ra,0x0
     fb0:	b48080e7          	jalr	-1208(ra) # af4 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
     fb4:	fc043783          	ld	a5,-64(s0)
     fb8:	4ff8                	lw	a4,92(a5)
     fba:	fc043783          	ld	a5,-64(s0)
     fbe:	47fc                	lw	a5,76(a5)
     fc0:	40f707bb          	subw	a5,a4,a5
     fc4:	2781                	sext.w	a5,a5
     fc6:	85be                	mv	a1,a5
     fc8:	00000517          	auipc	a0,0x0
     fcc:	19050513          	addi	a0,a0,400 # 1158 <schedule_wrr+0x1fa>
     fd0:	00000097          	auipc	ra,0x0
     fd4:	b24080e7          	jalr	-1244(ra) # af4 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
     fd8:	fc843783          	ld	a5,-56(s0)
     fdc:	c38d                	beqz	a5,ffe <schedule_wrr+0xa0>
     fde:	fc043783          	ld	a5,-64(s0)
     fe2:	4fb8                	lw	a4,88(a5)
     fe4:	fc043783          	ld	a5,-64(s0)
     fe8:	43fc                	lw	a5,68(a5)
     fea:	00f71e63          	bne	a4,a5,1006 <schedule_wrr+0xa8>
     fee:	fc043783          	ld	a5,-64(s0)
     ff2:	5fd8                	lw	a4,60(a5)
     ff4:	fc843783          	ld	a5,-56(s0)
     ff8:	5fdc                	lw	a5,60(a5)
     ffa:	00f75663          	bge	a4,a5,1006 <schedule_wrr+0xa8>
            current_thread = th;
     ffe:	fc043783          	ld	a5,-64(s0)
    1002:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
    ...
    1026:	f6f71be3          	bne	a4,a5,f9c <schedule_wrr+0x3e>
    }

    struct threads_sched_result r;
    // TODO: implement the weighted round-robin scheduling algorithm
    int weighted_time = args.time_quantum * current_thread->weight;
    102a:	40d8                	lw	a4,4(s1)
    102c:	fc843783          	ld	a5,-56(s0)
    1030:	47bc                	lw	a5,72(a5)
    1032:	02f707bb          	mulw	a5,a4,a5
    1036:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
    103a:	fc843783          	ld	a5,-56(s0)
    103e:	4fbc                	lw	a5,88(a5)
    1040:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
    1044:	fc843783          	ld	a5,-56(s0)
    1048:	c795                	beqz	a5,1074 <schedule_wrr+0x116>
    {
    ...
    1056:	fb442603          	lw	a2,-76(s0)
    105a:	fb042783          	lw	a5,-80(s0)
    105e:	0007869b          	sext.w	a3,a5
    1062:	0006071b          	sext.w	a4,a2
    1066:	00d75363          	bge	a4,a3,106c <schedule_wrr+0x10e>
    106a:	87b2                	mv	a5,a2
    106c:	2781                	sext.w	a5,a5
    106e:	f8f42823          	sw	a5,-112(s0)
    1072:	a039                	j	1080 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    1074:	649c                	ld	a5,8(s1)
    1076:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    107a:	4785                	li	a5,1
    107c:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    1080:	f8843783          	ld	a5,-120(s0)
    1084:	f8f43c23          	sd	a5,-104(s0)
    1088:	f9043783          	ld	a5,-112(s0)
    108c:	faf43023          	sd	a5,-96(s0)
    1090:	4701                	li	a4,0
    1092:	f9843703          	ld	a4,-104(s0)
    1096:	4781                	li	a5,0
    ...
    10a4:	853a                	mv	a0,a4
    10a6:	85be                	mv	a1,a5
    10a8:	70e6                	ld	ra,120(sp)
    10aa:	7446                	ld	s0,112(sp)
    10ac:	74a6                	ld	s1,104(sp)
    10ae:	7906                	ld	s2,96(sp)
    10b0:	69e6                	ld	s3,88(sp)
    10b2:	6109                	addi	sp,sp,128
    10b4:	8082                	ret
