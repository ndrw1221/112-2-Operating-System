...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
    ...
    fprintf(2, "Usage: ln old new\n");
      ...
      24:	00858593          	addi	a1,a1,8 # 1028 <schedule_wrr+0x15a>
      28:	4509                	li	a0,2
  ...
  if(link(argv[1], argv[2]) < 0)
    ...
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
      ...
      76:	fce58593          	addi	a1,a1,-50 # 1040 <schedule_wrr+0x172>
      7a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     686:	a1668693          	addi	a3,a3,-1514 # 1098 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     760:	93c70713          	addi	a4,a4,-1732 # 1098 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     920:	73c78793          	addi	a5,a5,1852 # 1058 <schedule_wrr+0x18a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     acc:	5f878793          	addi	a5,a5,1528 # 10c0 <freep>
     ad0:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     bc4:	50078793          	addi	a5,a5,1280 # 10c0 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c46:	47e78793          	addi	a5,a5,1150 # 10c0 <freep>
     c4a:	639c                	ld	a5,0(a5)
}
     c4c:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c78:	44c78793          	addi	a5,a5,1100 # 10c0 <freep>
     c7c:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     c8c:	42878793          	addi	a5,a5,1064 # 10b0 <base>
     c90:	fef43023          	sd	a5,-32(s0)
     c94:	00000797          	auipc	a5,0x0
     c98:	42c78793          	addi	a5,a5,1068 # 10c0 <freep>
     c9c:	fe043703          	ld	a4,-32(s0)
     ca0:	e398                	sd	a4,0(a5)
     ca2:	00000797          	auipc	a5,0x0
     ca6:	41e78793          	addi	a5,a5,1054 # 10c0 <freep>
     caa:	6398                	ld	a4,0(a5)
     cac:	00000797          	auipc	a5,0x0
     cb0:	40478793          	addi	a5,a5,1028 # 10b0 <base>
     cb4:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cb6:	00000797          	auipc	a5,0x0
     cba:	3fa78793          	addi	a5,a5,1018 # 10b0 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d36:	38e78793          	addi	a5,a5,910 # 10c0 <freep>
    ...
    if(p == freep)
     ...
     d4c:	37878793          	addi	a5,a5,888 # 10c0 <freep>
     d50:	639c                	ld	a5,0(a5)
...
struct threads_sched_result schedule_wrr(struct threads_sched_args args)
{
    ...
    struct thread *current_thread = NULL;
     ede:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
     ee2:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
     ee6:	00000517          	auipc	a0,0x0
     eea:	17a50513          	addi	a0,a0,378 # 1060 <schedule_wrr+0x192>
     eee:	00000097          	auipc	ra,0x0
     ef2:	b76080e7          	jalr	-1162(ra) # a64 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
     ef6:	649c                	ld	a5,8(s1)
     ef8:	639c                	ld	a5,0(a5)
     efa:	faf43c23          	sd	a5,-72(s0)
     efe:	fb843783          	ld	a5,-72(s0)
     f02:	fd878793          	addi	a5,a5,-40
     f06:	fcf43023          	sd	a5,-64(s0)
     f0a:	a049                	j	f8c <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
     f0c:	fc043783          	ld	a5,-64(s0)
     f10:	5fdc                	lw	a5,60(a5)
     f12:	85be                	mv	a1,a5
     f14:	00000517          	auipc	a0,0x0
     f18:	15c50513          	addi	a0,a0,348 # 1070 <schedule_wrr+0x1a2>
     f1c:	00000097          	auipc	ra,0x0
     f20:	b48080e7          	jalr	-1208(ra) # a64 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
     f24:	fc043783          	ld	a5,-64(s0)
     f28:	4ff8                	lw	a4,92(a5)
     f2a:	fc043783          	ld	a5,-64(s0)
     f2e:	47fc                	lw	a5,76(a5)
     f30:	40f707bb          	subw	a5,a4,a5
     f34:	2781                	sext.w	a5,a5
     f36:	85be                	mv	a1,a5
     f38:	00000517          	auipc	a0,0x0
     f3c:	14850513          	addi	a0,a0,328 # 1080 <schedule_wrr+0x1b2>
     f40:	00000097          	auipc	ra,0x0
     f44:	b24080e7          	jalr	-1244(ra) # a64 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
     f48:	fc843783          	ld	a5,-56(s0)
     f4c:	c38d                	beqz	a5,f6e <schedule_wrr+0xa0>
     f4e:	fc043783          	ld	a5,-64(s0)
     f52:	4fb8                	lw	a4,88(a5)
     f54:	fc043783          	ld	a5,-64(s0)
     f58:	43fc                	lw	a5,68(a5)
     f5a:	00f71e63          	bne	a4,a5,f76 <schedule_wrr+0xa8>
     f5e:	fc043783          	ld	a5,-64(s0)
     f62:	5fd8                	lw	a4,60(a5)
     f64:	fc843783          	ld	a5,-56(s0)
     f68:	5fdc                	lw	a5,60(a5)
     f6a:	00f75663          	bge	a4,a5,f76 <schedule_wrr+0xa8>
            current_thread = th;
     f6e:	fc043783          	ld	a5,-64(s0)
     f72:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
     f76:	fc043783          	ld	a5,-64(s0)
     f7a:	779c                	ld	a5,40(a5)
     f7c:	faf43423          	sd	a5,-88(s0)
     f80:	fa843783          	ld	a5,-88(s0)
     f84:	fd878793          	addi	a5,a5,-40
     f88:	fcf43023          	sd	a5,-64(s0)
     f8c:	fc043783          	ld	a5,-64(s0)
     f90:	02878713          	addi	a4,a5,40
     f94:	649c                	ld	a5,8(s1)
     f96:	f6f71be3          	bne	a4,a5,f0c <schedule_wrr+0x3e>
    }
    ...
    int weighted_time = args.time_quantum * current_thread->weight;
     ...
     fa0:	47bc                	lw	a5,72(a5)
     fa2:	02f707bb          	mulw	a5,a4,a5
     fa6:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
     faa:	fc843783          	ld	a5,-56(s0)
     fae:	4fbc                	lw	a5,88(a5)
     fb0:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
     fb4:	fc843783          	ld	a5,-56(s0)
     fb8:	c795                	beqz	a5,fe4 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
     fba:	fc843783          	ld	a5,-56(s0)
     fbe:	02878793          	addi	a5,a5,40
     fc2:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
     fc6:	fb442603          	lw	a2,-76(s0)
     fca:	fb042783          	lw	a5,-80(s0)
     fce:	0007869b          	sext.w	a3,a5
     fd2:	0006071b          	sext.w	a4,a2
     fd6:	00d75363          	bge	a4,a3,fdc <schedule_wrr+0x10e>
     fda:	87b2                	mv	a5,a2
     fdc:	2781                	sext.w	a5,a5
     fde:	f8f42823          	sw	a5,-112(s0)
     fe2:	a039                	j	ff0 <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
     fe4:	649c                	ld	a5,8(s1)
     fe6:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
     fea:	4785                	li	a5,1
     fec:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
     ff0:	f8843783          	ld	a5,-120(s0)
     ff4:	f8f43c23          	sd	a5,-104(s0)
     ff8:	f9043783          	ld	a5,-112(s0)
     ffc:	faf43023          	sd	a5,-96(s0)
    1000:	4701                	li	a4,0
    1002:	f9843703          	ld	a4,-104(s0)
    1006:	4781                	li	a5,0
    1008:	fa043783          	ld	a5,-96(s0)
    100c:	893a                	mv	s2,a4
    100e:	89be                	mv	s3,a5
    1010:	874a                	mv	a4,s2
    1012:	87ce                	mv	a5,s3
    ...
    1014:	853a                	mv	a0,a4
    1016:	85be                	mv	a1,a5
    1018:	70e6                	ld	ra,120(sp)
    101a:	7446                	ld	s0,112(sp)
    101c:	74a6                	ld	s1,104(sp)
    101e:	7906                	ld	s2,96(sp)
    1020:	69e6                	ld	s3,88(sp)
