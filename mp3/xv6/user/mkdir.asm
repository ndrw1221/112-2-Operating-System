...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    fprintf(2, "Usage: mkdir files...\n");
      ...
      24:	02858593          	addi	a1,a1,40 # 1048 <schedule_wrr+0x15e>
      28:	4509                	li	a0,2
  ...
  for(i = 1; i < argc; i++){
    ...
    if(mkdir(argv[i]) < 0){
      ...
      76:	fee58593          	addi	a1,a1,-18 # 1060 <schedule_wrr+0x176>
      7a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     6a2:	a2268693          	addi	a3,a3,-1502 # 10c0 <digits>
...
printptr(int fd, uint64 x) {
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     77c:	94870713          	addi	a4,a4,-1720 # 10c0 <digits>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     93c:	74878793          	addi	a5,a5,1864 # 1080 <schedule_wrr+0x196>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
     ...
     ae8:	60478793          	addi	a5,a5,1540 # 10e8 <freep>
     aec:	639c                	ld	a5,0(a5)
  ...
  freep = p;
     ...
     be0:	50c78793          	addi	a5,a5,1292 # 10e8 <freep>
...
morecore(uint nu)
{
  ...
  return freep;
     ...
     c62:	48a78793          	addi	a5,a5,1162 # 10e8 <freep>
     c66:	639c                	ld	a5,0(a5)
}
     c68:	853e                	mv	a0,a5
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
     ...
     c94:	45878793          	addi	a5,a5,1112 # 10e8 <freep>
     c98:	639c                	ld	a5,0(a5)
    ...
    base.s.ptr = freep = prevp = &base;
     ...
     ca8:	43478793          	addi	a5,a5,1076 # 10d8 <base>
     cac:	fef43023          	sd	a5,-32(s0)
     cb0:	00000797          	auipc	a5,0x0
     cb4:	43878793          	addi	a5,a5,1080 # 10e8 <freep>
     cb8:	fe043703          	ld	a4,-32(s0)
     cbc:	e398                	sd	a4,0(a5)
     cbe:	00000797          	auipc	a5,0x0
     cc2:	42a78793          	addi	a5,a5,1066 # 10e8 <freep>
     cc6:	6398                	ld	a4,0(a5)
     cc8:	00000797          	auipc	a5,0x0
     ccc:	41078793          	addi	a5,a5,1040 # 10d8 <base>
     cd0:	e398                	sd	a4,0(a5)
    base.s.size = 0;
     cd2:	00000797          	auipc	a5,0x0
     cd6:	40678793          	addi	a5,a5,1030 # 10d8 <base>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p->s.size >= nunits){
     ...
     d52:	39a78793          	addi	a5,a5,922 # 10e8 <freep>
    ...
    if(p == freep)
     ...
     d68:	38478793          	addi	a5,a5,900 # 10e8 <freep>
     d6c:	639c                	ld	a5,0(a5)
...
{
     eea:	7119                	addi	sp,sp,-128
     eec:	fc86                	sd	ra,120(sp)
     eee:	f8a2                	sd	s0,112(sp)
     ef0:	f4a6                	sd	s1,104(sp)
     ef2:	f0ca                	sd	s2,96(sp)
     ef4:	ecce                	sd	s3,88(sp)
     ef6:	0100                	addi	s0,sp,128
     ef8:	84aa                	mv	s1,a0
    struct thread *current_thread = NULL;
     efa:	fc043423          	sd	zero,-56(s0)
    struct thread *th = NULL;
     efe:	fc043023          	sd	zero,-64(s0)
    printf("\nrun_queue: \n");
     f02:	00000517          	auipc	a0,0x0
     f06:	18650513          	addi	a0,a0,390 # 1088 <schedule_wrr+0x19e>
     f0a:	00000097          	auipc	ra,0x0
     f0e:	b76080e7          	jalr	-1162(ra) # a80 <printf>
    list_for_each_entry(th, args.run_queue, thread_list)
     f12:	649c                	ld	a5,8(s1)
     f14:	639c                	ld	a5,0(a5)
     f16:	faf43c23          	sd	a5,-72(s0)
     f1a:	fb843783          	ld	a5,-72(s0)
     f1e:	fd878793          	addi	a5,a5,-40
     f22:	fcf43023          	sd	a5,-64(s0)
     f26:	a049                	j	fa8 <schedule_wrr+0xbe>
    {
        printf("th->ID: %d; ", th->ID);
     f28:	fc043783          	ld	a5,-64(s0)
     f2c:	5fdc                	lw	a5,60(a5)
     f2e:	85be                	mv	a1,a5
     f30:	00000517          	auipc	a0,0x0
     f34:	16850513          	addi	a0,a0,360 # 1098 <schedule_wrr+0x1ae>
     f38:	00000097          	auipc	ra,0x0
     f3c:	b48080e7          	jalr	-1208(ra) # a80 <printf>
        printf("th->arrival_time: %d\n", th->current_deadline - th->deadline);
     f40:	fc043783          	ld	a5,-64(s0)
     f44:	4ff8                	lw	a4,92(a5)
     f46:	fc043783          	ld	a5,-64(s0)
     f4a:	47fc                	lw	a5,76(a5)
     f4c:	40f707bb          	subw	a5,a4,a5
     f50:	2781                	sext.w	a5,a5
     f52:	85be                	mv	a1,a5
     f54:	00000517          	auipc	a0,0x0
     f58:	15450513          	addi	a0,a0,340 # 10a8 <schedule_wrr+0x1be>
     f5c:	00000097          	auipc	ra,0x0
     f60:	b24080e7          	jalr	-1244(ra) # a80 <printf>
        if (current_thread == NULL || (th->remaining_time == th->processing_time && th->ID < current_thread->ID))
     f64:	fc843783          	ld	a5,-56(s0)
     f68:	c38d                	beqz	a5,f8a <schedule_wrr+0xa0>
     f6a:	fc043783          	ld	a5,-64(s0)
     f6e:	4fb8                	lw	a4,88(a5)
     f70:	fc043783          	ld	a5,-64(s0)
     f74:	43fc                	lw	a5,68(a5)
     f76:	00f71e63          	bne	a4,a5,f92 <schedule_wrr+0xa8>
     f7a:	fc043783          	ld	a5,-64(s0)
     f7e:	5fd8                	lw	a4,60(a5)
     f80:	fc843783          	ld	a5,-56(s0)
     f84:	5fdc                	lw	a5,60(a5)
     f86:	00f75663          	bge	a4,a5,f92 <schedule_wrr+0xa8>
            current_thread = th;
     f8a:	fc043783          	ld	a5,-64(s0)
     f8e:	fcf43423          	sd	a5,-56(s0)
    list_for_each_entry(th, args.run_queue, thread_list)
     f92:	fc043783          	ld	a5,-64(s0)
     f96:	779c                	ld	a5,40(a5)
     f98:	faf43423          	sd	a5,-88(s0)
     f9c:	fa843783          	ld	a5,-88(s0)
     fa0:	fd878793          	addi	a5,a5,-40
     fa4:	fcf43023          	sd	a5,-64(s0)
     fa8:	fc043783          	ld	a5,-64(s0)
     fac:	02878713          	addi	a4,a5,40
     fb0:	649c                	ld	a5,8(s1)
     fb2:	f6f71be3          	bne	a4,a5,f28 <schedule_wrr+0x3e>
    }
    ...
    int weighted_time = args.time_quantum * current_thread->weight;
     ...
     fbc:	47bc                	lw	a5,72(a5)
     fbe:	02f707bb          	mulw	a5,a4,a5
     fc2:	faf42a23          	sw	a5,-76(s0)
    int remaining_time = current_thread->remaining_time;
     fc6:	fc843783          	ld	a5,-56(s0)
     fca:	4fbc                	lw	a5,88(a5)
     fcc:	faf42823          	sw	a5,-80(s0)
    if (current_thread != NULL)
     fd0:	fc843783          	ld	a5,-56(s0)
     fd4:	c795                	beqz	a5,1000 <schedule_wrr+0x116>
    {
        r.scheduled_thread_list_member = &current_thread->thread_list;
     fd6:	fc843783          	ld	a5,-56(s0)
     fda:	02878793          	addi	a5,a5,40
     fde:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = min(weighted_time, remaining_time);
     fe2:	fb442603          	lw	a2,-76(s0)
     fe6:	fb042783          	lw	a5,-80(s0)
     fea:	0007869b          	sext.w	a3,a5
     fee:	0006071b          	sext.w	a4,a2
     ff2:	00d75363          	bge	a4,a3,ff8 <schedule_wrr+0x10e>
     ff6:	87b2                	mv	a5,a2
     ff8:	2781                	sext.w	a5,a5
     ffa:	f8f42823          	sw	a5,-112(s0)
     ffe:	a039                	j	100c <schedule_wrr+0x122>
    }
    else
    {
        r.scheduled_thread_list_member = args.run_queue;
    ...
    1002:	f8f43423          	sd	a5,-120(s0)
        r.allocated_time = 1;
    1006:	4785                	li	a5,1
    1008:	f8f42823          	sw	a5,-112(s0)
    }

    return r;
    100c:	f8843783          	ld	a5,-120(s0)
    1010:	f8f43c23          	sd	a5,-104(s0)
    1014:	f9043783          	ld	a5,-112(s0)
    1018:	faf43023          	sd	a5,-96(s0)
    101c:	4701                	li	a4,0
    101e:	f9843703          	ld	a4,-104(s0)
    1022:	4781                	li	a5,0
    ...
    1030:	853a                	mv	a0,a4
    1032:	85be                	mv	a1,a5
    1034:	70e6                	ld	ra,120(sp)
    1036:	7446                	ld	s0,112(sp)
    1038:	74a6                	ld	s1,104(sp)
    103a:	7906                	ld	s2,96(sp)
    103c:	69e6                	ld	s3,88(sp)
    103e:	6109                	addi	sp,sp,128
    1040:	8082                	ret
